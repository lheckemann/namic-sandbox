...
void vtkProstateNavGUI::Init()
{
  ...
  // Register all new MRML node classes
  {
    ...
    this->GetMRMLScene()->RegisterNodeClass( vtkSmartPointer< vtkMRMLTransPerinealProstateTemplateSNRNode >::New() );    
  }
...
void vtkProstateNavGUI::BuildGUIForConfigurationFrame ()
{
  ...
  this->RobotSelectorWidget->AddNodeClass("vtkMRMLTransPerinealProstateTemplateSNRNode", NULL, NULL, "Trans-perineal smart template");
