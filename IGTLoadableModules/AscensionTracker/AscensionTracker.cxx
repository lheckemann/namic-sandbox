...
transMsg->SetDeviceName("AcenscionTracker1");
    ...
    else
    {
      ...
      while(!exit_while)//loop <= 80)
      {
        ...
        else
        {
          ...
          matrix[0][3] = (float)unpack_coordinates[0]*POS_SCALE*25.4;
          matrix[1][3] = (float)unpack_coordinates[1]*POS_SCALE*25.4;
          matrix[2][3] = (float)unpack_coordinates[2]*POS_SCALE*25.4;
          matrix[3][3] = (float)1;
