/*==========================================================================
  ...
  Program:   3D Slicer
  Module:    $HeadURL: http://svn.na-mic.org/NAMICSandBox/trunk/IGTLoadableModules/MotionTracker/vtkMotionTrackerLogic.h $
  Date:      $Date: 2009-02-03 12:05:00 -0500 (Tue, 03 Feb 2009) $
  Version:   $Revision: 3633 $

==========================================================================*/

// .NAME vtkMotionTrackerLogic - slicer logic class for Locator module 
// .SECTION Description
// This class manages the logic associated with tracking device for
// IGT. 


#ifndef __vtkMotionTrackerLogic_h
#define __vtkMotionTrackerLogic_h
...
class VTK_MotionTracker_EXPORT vtkMotionTrackerLogic : public vtkSlicerModuleLogic 
{
 public:
  //BTX
  enum {  // Events
 ...
 public:
  ...
  static vtkMotionTrackerLogic *New();
  
  vtkTypeRevisionMacro(vtkMotionTrackerLogic,vtkObject);
...
// 6/9/2011 ayamada
  //void MRMLToOpenCV(vtkMRMLTimeSeriesBundleNode* bundleNode, int index);
 ...
 protected:
  ...
  vtkMotionTrackerLogic();
  ~vtkMotionTrackerLogic();

  void operator=(const vtkMotionTrackerLogic&);
  vtkMotionTrackerLogic(const vtkMotionTrackerLogic&);
