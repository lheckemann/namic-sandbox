...
//---------------------------------------------------------------------------
double vtkFourDAnalysisLogic::GetMeanIntensity(vtkImageData* image, IndexTableType& indexTable)
{
  double sum = 0.0;
...
double vtkFourDAnalysisLogic::GetSDIntensity(vtkImageData* image, double mean, IndexTableType& indexTable)
{
  double s = 0.0;
...
//---------------------------------------------------------------------------
void vtkFourDAnalysisLogic::GenerateIndexTable(vtkImageData* mask, int label, IndexTableType& indexTable)
{
  int maskDim[3];
...
//---------------------------------------------------------------------------
vtkDoubleArray* vtkFourDAnalysisLogic::GetIntensityCurve(const char* bundleID,
                                                     const char* maskID,
                                                     int label, int type)
{
  vtkMRML4DBundleNode* bundleNode 
...
//---------------------------------------------------------------------------
int vtkFourDAnalysisLogic::SaveIntensityCurve(const char* bundleID, const char* maskID, int label, const char* filename)
{
  ...
  if (!meanArray || !sdArray)
    {
    vtkErrorMacro ("vtkFourDAnalysisLogic: could not generate intensity curve. ");
    return 0;
    }
