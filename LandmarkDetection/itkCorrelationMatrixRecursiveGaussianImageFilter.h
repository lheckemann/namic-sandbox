/*=========================================================================
  ...
  Module:    $RCSfile: itkCorrelationMatrixRecursiveGaussianImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkCorrelationMatrixRecursiveGaussianImageFilter_h
#define __itkCorrelationMatrixRecursiveGaussianImageFilter_h
...
/** \class CorrelationMatrixRecursiveGaussianImageFilter
...
class ITK_EXPORT CorrelationMatrixRecursiveGaussianImageFilter :
    public InPlaceImageFilter< TInputImage, TOutputImage >
{
public:
  /** Standard class typedefs. */
  typedef CorrelationMatrixRecursiveGaussianImageFilter  Self;
...
protected:
  ...
  virtual ~CorrelationMatrixRecursiveGaussianImageFilter() {};
  void PrintSelf(std::ostream& os, Indent indent) const;

  /** Generate Data */
  void GenerateData( void );

  /** CorrelationMatrixRecursiveGaussianImageFilter needs all of the
   * input to produce an output. Therefore,
   * CorrelationMatrixRecursiveGaussianImageFilter needs to provide an
  ...
  /** CorrelationMatrixRecursiveGaussianImageFilter produces all of
   * the output.  Therefore, it needs to provide an implementation of
   * EnlargeOutputRequestedRegion(). */
  void EnlargeOutputRequestedRegion(DataObject *output);

private:
  CorrelationMatrixRecursiveGaussianImageFilter(const Self&); //purposely not implemented
...
#include "itkCorrelationMatrixRecursiveGaussianImageFilter.txx"
#endif
