...
namespace itk
{
/** \brief ScaleVersor3DTransform of a vector space (e.g. space coordinates)
 *
 * This transform applies a versor rotation and translation & scale
 * to the space
 *
 * \ingroup Transforms
 */
...
class ITK_EXPORT ScaleVersor3DTransform :
