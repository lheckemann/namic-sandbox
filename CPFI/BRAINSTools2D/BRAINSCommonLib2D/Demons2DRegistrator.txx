#ifndef __Demons2DRegistrator_txx
#define __Demons2DRegistrator_txx
...
void Demons2DRegistrator< TRealImage, TOutputImage,
...
template<
  ...
  class TOutputImage,
  class TFieldValue >
Demons2DRegistrator< TRealImage, TOutputImage, TFieldValue >::Demons2DRegistrator ()
{
...
template<
  ...
  class TOutputImage,
  class TFieldValue >
void Demons2DRegistrator< TRealImage, TOutputImage, TFieldValue >::Execute()
{
#if 1
...
template<
  ...
  class TOutputImage,
  class TFieldValue >
void Demons2DRegistrator< TRealImage, TOutputImage, TFieldValue >::StartNewLevel()
{
  if ( this->GetOutDebug() )
    {
    if ( !this->GetUseLogDomain() )
