#ifndef _GenericTransformImage2D_txx_
#define _GenericTransformImage2D_txx_
  ...
  const bool binaryFlag)
{
  ...
  if ( binaryFlag )
    ...
    typedef typename itk::Image< MaskPixelType,  GenericTransformImage2DNS::SpaceDimension > MaskImageType;
