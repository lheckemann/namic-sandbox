#ifndef _GenericTransformImage2D_H_
#define _GenericTransformImage2D_H_

#include "BRAINSCommonLib2DWin32Header.h"
...
namespace GenericTransformImage2DNS
{
...
typedef itk::BSplineDeformableTransform<
  CoordinateRepType,
  GenericTransformImage2DNS::SpaceDimension,
  GenericTransformImage2DNS::SplineOrder > BSplineTransformType;
...
/**
  ...
  * \endcode
  */
BRAINSCommonLib2D_EXPORT extern void WriteTransformToDisk(GenericTransformType const *const genericTransformToWrite,
...
/**
  ...
  * \endcode
  */
BRAINSCommonLib2D_EXPORT extern GenericTransformType::Pointer ReadTransformFromDisk(const std::string initialTransform);
...
/**
  ...
  * \endcode
  */
BRAINSCommonLib2D_EXPORT extern VersorRigid3DTransformType::Pointer ComputeRigidTransformFromGeneric(
...
/**
  ...
  *interface.
  */
BRAINSCommonLib2D_EXPORT extern int WriteBothTransformsToDisk(
  const GenericTransformType::ConstPointer genericTransformToWrite,
  const std::string & outputTransform,
...
/**
  ...
  *interface.
  */
BRAINSCommonLib2D_EXPORT extern int WriteStrippedRigidTransformToDisk(
  const GenericTransformType::ConstPointer genericTransformToWrite,
  const std::string & strippedOutputTransform);

BRAINSCommonLib2D_EXPORT extern void AddExtraTransformRegister(void);
}
...
typename OutputImageType::Pointer GenericTransformImage2D(
...
#  include "GenericTransformImage2D.txx"
#endif
