#ifndef __Demons2DPreprocessor_h
#define __Demons2DPreprocessor_h

#include "itkObject.h"

namespace itk
{
/** \class Demons2DPreprocessor
  *
...
class ITK_EXPORT Demons2DPreprocessor:public Object
{
public:

  /** Standard class typedefs. */
  typedef Demons2DPreprocessor         Self;
  typedef Object                     Superclass;
  typedef SmartPointer< Self >       Pointer;
  typedef SmartPointer< const Self > ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro(Demons2DPreprocessor, Object);
...
protected:
  Demons2DPreprocessor();
  ~Demons2DPreprocessor()
  {}
private:
  Demons2DPreprocessor(const Self &);      // purposely not implemented
...
#  include "Demons2DPreprocessor.txx"
#endif

#endif // _Demons2DPreprocessor_h
