/*=========================================================================
  ...
  Module:    $RCSfile: itkFinslerActiveContourLevelSetFunction.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkFinslerActiveContourLevelSetFunction_h_
#define __itkFinslerActiveContourLevelSetFunction_h_

#include "itkSegmentationLevelSetFunction.h"

namespace itk {

/** \class FinslerActiveContourLevelSetFunction
 *    
 * \brief This function is used in FinslerActiveContourLevelSetImageFilter to
 ...
 *
 * FinslerActiveContourLevelSetFunction is a subclass of the generic LevelSetFunction.
 ...
 * \sa FinslerActiveContourLevelSetImageFilter
 *
 * \ingroup FiniteDifferenceFunctions
 */
template <class TImageType, class TFeatureImageType = TImageType>
class ITK_EXPORT FinslerActiveContourLevelSetFunction
  : public SegmentationLevelSetFunction<TImageType, TFeatureImageType>
{
public:
  /** Standard class typedefs. */
  typedef FinslerActiveContourLevelSetFunction Self;
  ...
  itkTypeMacro( FinslerActiveContourLevelSetFunction, SegmentationLevelSetFunction );
...
protected:
  FinslerActiveContourLevelSetFunction()
  {
    this->SetAdvectionWeight( NumericTraits<ScalarValueType>::One );
    this->SetPropagationWeight( NumericTraits<ScalarValueType>::One );
    this->SetCurvatureWeight( NumericTraits<ScalarValueType>::One );
  ...
  virtual ~FinslerActiveContourLevelSetFunction() {}

  FinslerActiveContourLevelSetFunction(const Self&); //purposely not implemented
...
#include "itkFinslerActiveContourLevelSetFunction.txx"
#endif
