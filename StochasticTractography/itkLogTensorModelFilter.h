#ifndef __itkLogTensorModelFilter_h__
#define __itkLogTensorModelFilter_h__
...
class ITK_EXPORT LogTensorModelFilter :
  public ImageToImageFilter< TDWIVectorImage,
                    TTensorModelParamImage >{
public:
  /** Standard class typedefs. */
  typedef LogTensorModelFilter Self;
  ...
  itkTypeMacro(LogTensorModelFilter, ImageToImageFilter );
...
protected:
  ...
  virtual ~LogTensorModelFilter() {};
  
  //be sure to use itk's smart pointers with its factory constructed objects!
  //a segmentation fault will occur if you don't
  typename bValueContainerPointer m_bvalues;
  typename GradientDirectionContainerPointer m_gradients;
...
#include "itkLogTensorModelFilter.txx"
#endif
