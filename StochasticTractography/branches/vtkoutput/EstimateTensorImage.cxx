...
#include "EstimateTensorImageCLP.h"
...
int main(int argc, char* argv[]){
  ...
  //Run the filter
  stfilterPtr->GenerateTensorImageOutput();
  
  typedef itk::ImageFileWriter< STFilterType::OutputTensorImageType > TensorWriterType;
  TensorWriterType::Pointer tensorwriter = TensorWriterType::New();
  
  tensorwriter->SetInput( stfilterPtr->GetOutputTensorImage() );
  tensorwriter->SetFileName( tensorfilename.c_str() );
  tensorwriter->Update();
