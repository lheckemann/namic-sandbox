...
=========================================================================*/
#ifndef __JointEntropyFixedMultiImageMetric_h
#define __JointEntropyFixedMultiImageMetric_h
...
class ITK_EXPORT JointEntropyFixedMultiImageMetric :
    public ParzenWindowEntropyMultiImageMetric< TFixedImage>
{
public:

  /** Standard class typedefs. */
  typedef JointEntropyFixedMultiImageMetric  Self;
  ...
  itkTypeMacro(JointEntropyFixedMultiImageMetric, ParzenWindowEntropyMultiImageMetric);
...
protected:
  ...
  virtual ~JointEntropyFixedMultiImageMetric();
...
private:
  JointEntropyFixedMultiImageMetric(const Self&); //purposely not implemented
...
#include "JointEntropyFixedMultiImageMetric.cxx"
#endif
