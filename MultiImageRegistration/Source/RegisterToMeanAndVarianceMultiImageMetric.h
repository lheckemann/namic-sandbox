...
=========================================================================*/
#ifndef __RegisterToMeanAndVarianceMultiImageMetric_h
#define __RegisterToMeanAndVarianceMultiImageMetric_h
...
class ITK_EXPORT RegisterToMeanAndVarianceMultiImageMetric :
    public ParzenWindowEntropyMultiImageMetric< TFixedImage>
{
public:

  /** Standard class typedefs. */
  typedef RegisterToMeanAndVarianceMultiImageMetric  Self;
  ...
  itkTypeMacro(RegisterToMeanAndVarianceMultiImageMetric, ParzenWindowEntropyMultiImageMetric);
...
protected:
  ...
  virtual ~RegisterToMeanAndVarianceMultiImageMetric() {};
  ...
  double m_VarianceStandardDeviation;
private:
  RegisterToMeanAndVarianceMultiImageMetric(const Self&); //purposely not implemented
...
#include "RegisterToMeanAndVarianceMultiImageMetric.cxx"
#endif
