...
=========================================================================*/
#ifndef __RegisterToMeanHistogramMultiImageMetric_h
#define __RegisterToMeanHistogramMultiImageMetric_h
...
class ITK_EXPORT RegisterToMeanHistogramMultiImageMetric :
    public ParzenWindowEntropyMultiImageMetric< TFixedImage>
{
public:

  /** Standard class typedefs. */
  typedef RegisterToMeanHistogramMultiImageMetric  Self;
  ...
  itkTypeMacro(RegisterToMeanHistogramMultiImageMetric, ParzenWindowEntropyMultiImageMetric);
...
private:
  RegisterToMeanHistogramMultiImageMetric(const Self&); //purposely not implemented
...
#include "RegisterToMeanHistogramMultiImageMetric.cxx"
#endif
