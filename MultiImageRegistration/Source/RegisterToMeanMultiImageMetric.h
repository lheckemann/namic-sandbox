...
=========================================================================*/
#ifndef __RegisterToMeanMultiImageMetric_h
#define __RegisterToMeanMultiImageMetric_h
...
class ITK_EXPORT RegisterToMeanMultiImageMetric :
    public ParzenWindowEntropyMultiImageMetric< TFixedImage>
{
public:

  /** Standard class typedefs. */
  typedef RegisterToMeanMultiImageMetric  Self;
  ...
  itkTypeMacro(RegisterToMeanMultiImageMetric, ParzenWindowEntropyMultiImageMetric);
...
private:
  RegisterToMeanMultiImageMetric(const Self&); //purposely not implemented
...
#include "RegisterToMeanMultiImageMetric.cxx"
#endif
