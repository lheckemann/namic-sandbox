...
/*
  $Id: cmnTypeTraits.h,v 1.20 2006/06/23 18:01:53 ofri Exp $
...
template<>
class VaArgPromotion<unsigned short> {
public:
...
template<>
class VaArgPromotion<unsigned char> {
public:
    typedef unsigned int Type;
};
...
public:
    ...
    typedef typename VaArgPromotion<_elementType>::Type VaArgPromotion;
