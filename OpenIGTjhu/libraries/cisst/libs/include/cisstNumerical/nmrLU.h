...
/*
  $Id: nmrLU.h,v 1.8 2006/01/27 00:59:49 anton Exp $
...
public:
    ...
    */
    ...
    static inline
    MatrixSizeType MatrixPSize(const vctDynamicConstMatrixBase<_matrixOwnerTypeA, double> & A)
    {
        MatrixSizeType matrixSize(A.rows(), A.rows());
        return matrixSize;
    }
    ...
    */
    template <class _matrixOwnerTypeA>
    static inline
    MatrixSizeType MatrixLSize(const vctDynamicConstMatrixBase<_matrixOwnerTypeA, double> & A)
    {
        const size_type minmn = (A.rows() < A.cols()) ? A.rows() : A.cols();
        MatrixSizeType matrixSize(A.rows(), minmn);
        return matrixSize;
    }
    ...
    */
    template <class _matrixOwnerTypeA>
    static inline
    MatrixSizeType MatrixUSize(const vctDynamicConstMatrixBase<_matrixOwnerTypeA, double> & A)
    {
        const size_type minmn = (A.rows() < A.cols()) ? A.rows() : A.cols();
        MatrixSizeType matrixSize(minmn, A.cols());
        return matrixSize;
    }
