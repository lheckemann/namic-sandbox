...
#ifndef _ddiRMM1612_h
#define _ddiRMM1612_h
 ...
 */
class ddiRMM1612: public ddiDeviceInterface {
  ...
  typedef ddiCommandBase::ReturnType (ddiRMM1612::*_OperationPointerType)(cmnDataObject &);

  /*! Constructor. Prepares the maps. */
  ddiRMM1612(const char* deviceName = "RMM1612");
 ...
 protected:
  ...
  /*! Set all channels on the DAC  */
    DDI_DECLARE_COMMAND1_IN(SetOutputAll, ddiVecDouble16);
...
CMN_DECLARE_SERVICES_INSTANTIATION(ddiRMM1612);
