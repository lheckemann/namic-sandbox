...
#ifndef _ddiLoPoMoCo_h
#define _ddiLoPoMoCo_h
 ...
 */
class ddiLoPoMoCo: public ddiDeviceInterface {
  ...
  typedef ddiCommandBase::ReturnType (ddiLoPoMoCo::*_OperationPointerType)(cmnDataObject &);

  /*! Constructor. Prepares the maps. */
  ddiLoPoMoCo(const char* deviceName = "LoPoMoCo");
...
CMN_DECLARE_SERVICES_INSTANTIATION(ddiLoPoMoCo);
