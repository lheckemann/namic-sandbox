...
// $Id: ddiFourLoPoMoCo.h,v 1.6 2006/05/13 21:29:21 kapoor Exp $
                                                                                                                                                             
#ifndef _ddiFourLoPoMoCo_h
#define _ddiFourLoPoMoCo_h
...
class ddiFourLoPoMoCo: public ddiCompositeDevice
{
...
public:
    ...
    ddiFourLoPoMoCo(const char* deviceName = "FourLoPoMoCo",
        const char* component1Name = "LoPoMoCo1",
        const char* component2Name = "LoPoMoCo2",
        const char* component3Name = "LoPoMoCo3",
        const char* component4Name = "LoPoMoCo4",
...
CMN_DECLARE_SERVICES_INSTANTIATION(ddiFourLoPoMoCo);


#endif // CISST_HAS_LOPOMOCO


#endif // _ddiFourLoPoMoCo_h


// $Log: ddiFourLoPoMoCo.h,v $
