#pragma ident "@(#)Ttables.hh 1.2 10/31/96"

// This file defines the two tables that are used to construct a
// surface net from a 3D binary (voxel) data set in TNetExtractor.cc
// This is derived from the two files source/table{1,2}.dat, which were
// in turn made with mathematica.

const t1entry TNetExtractor::pt1[256] = {
{0,	1,	{0}},
{1,	1,	{1}},
{2,	1,	{2}},
{3,	1,	{3}},
...
const t2entry TNetExtractor::pt2[256] = {
{0,	1,	{-1},	{-1}},
