...
::InitializeRegistration()
{
  ...
  optimizerScales[9] = 1.0 / ( 10.0 * fixedImageSize[0] * fixedImageSpacing[0] );
  optimizerScales[10] = 1.0 / ( 10.0 * fixedImageSize[1] * fixedImageSpacing[1] );
  optimizerScales[11] = 1.0 / ( 10.0 * fixedImageSize[2] * fixedImageSpacing[2] );
...
const MultiModalityAffineRegistration::ParametersType &
MultiModalityAffineRegistration
::GetParameters() const
{
...
const MultiModalityAffineRegistration::TransformType *
MultiModalityAffineRegistration
::GetTransform() const
{
