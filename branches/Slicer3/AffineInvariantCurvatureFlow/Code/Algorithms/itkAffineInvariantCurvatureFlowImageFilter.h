/*=========================================================================
  ...
  Module:    $RCSfile: itkAffineInvariantCurvatureFlowImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkAffineInvariantCurvatureFlowImageFilter_h_
#define __itkAffineInvariantCurvatureFlowImageFilter_h_
...
/** \class AffineInvariantCurvatureFlowImageFilter
  * \brief Denoise an image using AffineInvariantCurvature driven flow.
  *
  * AffineInvariantCurvatureFlowImageFilter implements a AffineInvariantCurvature driven image denoising 
...
class ITK_EXPORT AffineInvariantCurvatureFlowImageFilter
  : public DenseFiniteDifferenceImageFilter<TInputImage, TOutputImage>
{
public:
  /** Standard class typedefs. */
  typedef AffineInvariantCurvatureFlowImageFilter Self;
  ...
  itkTypeMacro(AffineInvariantCurvatureFlowImageFilter,
  ...
  /** AffineInvariantCurvatureFlowFunction type. */
  typedef AffineInvariantCurvatureFlowFunction<OutputImageType>
  AffineInvariantCurvatureFlowFunctionType;
...
private:
  AffineInvariantCurvatureFlowImageFilter(const Self&); //purposely not implemented
...
#include "itkAffineInvariantCurvatureFlowImageFilter.txx"
#endif
