...
/* verbosity levels */
#ifndef __SVMPR_LOQO_h
#define __SVMPR_LOQO_h
...
class SVMPrLoqo: public LightProcessObject
{
public:

  typedef SVMPrLoqo Self;
  typedef LightProcessObject Superclass;
  typedef SmartPointer<Self> Pointer;
  typedef SmartPointer<const Self> ConstPointer;
  itkTypeMacro(SVMPrLoqo, LightProcessObject);
  itkNewMacro(Self) ;
