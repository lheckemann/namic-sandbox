...
#include "vtkTRProstateBiopsyDataStream.h"
...
vtkStandardNewMacro(vtkTRProstateBiopsyDataStream);
vtkCxxRevisionMacro(vtkTRProstateBiopsyDataStream, "$Revision: 1.0 $");

vtkTRProstateBiopsyDataStream::vtkTRProstateBiopsyDataStream()
{
...
void vtkTRProstateBiopsyDataStream::Init(const char *configFile)
{
  Superclass::Init(configFile);
}

void vtkTRProstateBiopsyDataStream::PrintSelf(ostream& os, vtkIndent indent)
{
}

void vtkTRProstateBiopsyDataStream::AddCallbacks()
{
...
void vtkTRProstateBiopsyDataStream::OnRecieveMessageFromRobot(vtkIGTMessageAttributeSet* attrSet, void* arg)
{
  ...
  vtkTRProstateBiopsyDataStream* ds = dynamic_cast<vtkTRProstateBiopsyDataStream*>(attrSet->GetOpenTrackerStream());
...
void vtkTRProstateBiopsyDataStream::OnRecieveMessageFromScanner(vtkIGTMessageAttributeSet* attrSet, void* arg)
{
  
}


std::string vtkTRProstateBiopsyDataStream::GetRobotStatus()
{
  std::string status;
...
vtkTransform* vtkTRProstateBiopsyDataStream::GetNeedleTransform()
{
...
std::string vtkTRProstateBiopsyDataStream::GetScanStatus()
{
  /*
  std::string status;
...
void vtkTRProstateBiopsyDataStream::SetRobotPosition(std::vector<float> pos, std::vector<float> ori)
{
...
void vtkTRProstateBiopsyDataStream::SetRobotCommand(std::string key, std::string value)
{
  vtkIGTMessageAttributeSet attr;
...
void vtkTRProstateBiopsyDataStream::SetScanPosition(std::vector<float> pos, std::vector<float> ori)
{
  
}


void vtkTRProstateBiopsyDataStream::SetScanCommand(std::string key, std::string value)
{
}


void vtkTRProstateBiopsyDataStream::Normalize(float *a)
{
    float d;
...
// a = b x c
void vtkTRProstateBiopsyDataStream::Cross(float *a, float *b, float *c)
{
    a[0] = b[1]*c[2] - c[1]*b[2];
    a[1] = c[0]*b[2] - b[0]*c[2];
    a[2] = b[0]*c[1] - c[0]*b[1];
