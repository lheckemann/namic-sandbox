...
//----------------------------------------------------------------------------
vtkStandardNewMacro(vtkIGTWizardFirstStep);
vtkCxxRevisionMacro(vtkIGTWizardFirstStep, "$Revision: 1.1 $");

//----------------------------------------------------------------------------
vtkIGTWizardFirstStep::vtkIGTWizardFirstStep()
{
...
//----------------------------------------------------------------------------
void vtkIGTWizardFirstStep::ShowUserInterface()
{
...
//----------------------------------------------------------------------------
void vtkIGTWizardFirstStep::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os,indent);
}

//----------------------------------------------------------------------------
void vtkIGTWizardFirstStep::ProcessGUIEvents( vtkObject *caller,
...
static void *thread_cvGetImageFromCamera(vtkMultiThreader::ThreadInfo *data)
{
  ...
  vtkIGTWizardFirstStep *self = (vtkIGTWizardFirstStep *)(data->UserData);
  int activeFlag = 1;
...
void vtkIGTWizardFirstStep::cvGetImageFromCamera(void)
{
...
//------------------------------------------------------------------------------
vtkMRMLModelNode* vtkIGTWizardFirstStep::SetVisibilityOfCaptureData(const char* nodeName, int v)
{
  #ifdef DEBUG_FLAG
...
//------------------------------------------------------------------------------
vtkMRMLModelNode* vtkIGTWizardFirstStep::initCapture(const char* nodeName, double r, double g, double b)
{
...
//---------------------------------------------------------------------------
int vtkIGTWizardFirstStep::StopCapture()
{
...
//---------------------------------------------------------------------------
vtkMRMLModelNode* vtkIGTWizardFirstStep::SetCloseOfCaptureData(const char* nodeName)
{
