/*=auto=========================================================================
  ...
  =========================================================================auto=*/
#ifndef __vtkMRMLTransPerinealProstateCryoTemplateNode_h
#define __vtkMRMLTransPerinealProstateCryoTemplateNode_h
...
class VTK_PROSTATENAV_EXPORT vtkMRMLTransPerinealProstateCryoTemplateNode : public vtkMRMLRobotNode
{
 public:
  ...
  static vtkMRMLTransPerinealProstateCryoTemplateNode *New();
  vtkTypeMacro(vtkMRMLTransPerinealProstateCryoTemplateNode,vtkMRMLRobotNode);

  void PrintSelf(ostream& os, vtkIndent indent);

  virtual vtkMRMLTransPerinealProstateCryoTemplateNode* CreateNodeInstance();
  ...
  {return "TransPerinealProstateCryoTemplate";};
  ...
  {return "SetUpTemplate ZFrameCalibration CryoTemplateTargeting PointVerification"; };
 ...
 protected:
  ...
  virtual ~vtkMRMLTransPerinealProstateCryoTemplateNode();
  vtkMRMLTransPerinealProstateCryoTemplateNode(const vtkMRMLTransPerinealProstateCryoTemplateNode&);
  void operator=(const vtkMRMLTransPerinealProstateCryoTemplateNode&);
