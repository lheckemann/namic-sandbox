...
#ifndef __vtkIGTWizardThirdStep_h
#define __vtkIGTWizardThirdStep_h
...
class VTK_IGTWIZARD_EXPORT vtkIGTWizardThirdStep :
  public vtkIGTWizardStepBase
{
public:
  static vtkIGTWizardThirdStep *New();
  vtkTypeRevisionMacro(vtkIGTWizardThirdStep,vtkIGTWizardStepBase);
...
private:
  vtkIGTWizardThirdStep(const vtkIGTWizardThirdStep&);
  void operator=(const vtkIGTWizardThirdStep&);
};
