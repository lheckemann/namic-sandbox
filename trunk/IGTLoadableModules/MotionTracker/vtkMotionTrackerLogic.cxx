/*==========================================================================
  ...
  Program:   3D Slicer
  Module:    $HeadURL: http://svn.na-mic.org/NAMICSandBox/trunk/IGTLoadableModules/MotionTracker/vtkMotionTrackerLogic.cxx $
...
vtkCxxRevisionMacro(vtkMotionTrackerLogic, "$Revision: 3633 $");
vtkStandardNewMacro(vtkMotionTrackerLogic);

//---------------------------------------------------------------------------
vtkMotionTrackerLogic::vtkMotionTrackerLogic()
{
  ...
  this->DataCallbackCommand->SetCallback(vtkMotionTrackerLogic::DataCallback);
...
//---------------------------------------------------------------------------
void vtkMotionTrackerLogic::PrintSelf(ostream& os, vtkIndent indent)
{
  this->vtkObject::PrintSelf(os, indent);
  os << indent << "vtkMotionTrackerLogic:             " << this->GetClassName() << "\n";

}

//----------------------------------------------------------------------------
void vtkMotionTrackerLogic::ProcessLogicEvents(vtkObject *vtkNotUsed(caller), 
                                            unsigned long event, 
                                            void *callData)
{
...
//---------------------------------------------------------------------------
void vtkMotionTrackerLogic::DataCallback(vtkObject *vtkNotUsed(caller), 
                                       unsigned long vtkNotUsed(eid),
                                       void *clientData, void *vtkNotUsed(callData))
{
  vtkMotionTrackerLogic *self = reinterpret_cast<vtkMotionTrackerLogic *>(clientData);
  vtkDebugWithObjectMacro(self, "In vtkMotionTrackerLogic DataCallback");
  self->UpdateAll();
}


//---------------------------------------------------------------------------
void vtkMotionTrackerLogic::UpdateAll()
{
}


//---------------------------------------------------------------------------
vtkMRMLTimeSeriesBundleNode* vtkMotionTrackerLogic::AddNewFourDBundleNode (  )
{
...
//---------------------------------------------------------------------------
int vtkMotionTrackerLogic::SortFilesFromDirToCreateFileList ( const char *path,
                                                           std::vector<ReaderType::FileNamesContainer>& fileNamesContainerList)
{
  ...
  this->InvokeEvent ( vtkMotionTrackerLogic::ProgressDialogEvent, &statusMessage);
  
  //--- Things to convert DICOM tags into
  //--- MotionTracker sorting parameters.
...
//---------------------------------------------------------------------------
int vtkMotionTrackerLogic::CreateFileListFromDir(const char* path,
                                             std::vector<ReaderType::FileNamesContainer>& fileNamesContainerList)
{
...
//---------------------------------------------------------------------------
void vtkMotionTrackerLogic::CreateFileListFromDir(const char* path,
                                               std::vector<ReaderType::FileNamesContainer>& fileNamesContainerList,
...
//---------------------------------------------------------------------------
vtkMRMLTimeSeriesBundleNode* vtkMotionTrackerLogic::LoadImagesByList(const char* bundleNodeName,
                                                                  std::vector<ReaderType::FileNamesContainer>& fileNamesContainerList)
{
  ...
  bundleNode->SetDescription("Created by MotionTracker");
...
//---------------------------------------------------------------------------
vtkMRMLTimeSeriesBundleNode* vtkMotionTrackerLogic::LoadImagesFromDir(const char* path, const char* bundleNodeName)
{
...
//---------------------------------------------------------------------------
int vtkMotionTrackerLogic::SaveImagesToDir(const char* path,
                                       const char* bundleID,
                                       const char* prefix,
                                       const char* suffix)
{
...
//---------------------------------------------------------------------------
vtkMRMLScalarVolumeNode* vtkMotionTrackerLogic::AddDisplayBufferNode(vtkMRMLTimeSeriesBundleNode* bundleNode, int index)
{
  vtkMRMLScene* scene = this->GetMRMLScene();
...
//---------------------------------------------------------------------------
void vtkMotionTrackerLogic::UpdateDisplayBufferNode(vtkMRMLTimeSeriesBundleNode* bundleNode, int index)
{
  if (!bundleNode)
    {
    return;
...
// 6/9/2011 ayamada
//sprintf(nodeName, "%s_DisplayOpenCV%d", bundleNode->GetName(), index);
sprintf(nodeName, "%s_Display%d", bundleNode->GetName(), index);
...
//---------------------------------------------------------------------------
int vtkMotionTrackerLogic::GenerateBundleFrames(vtkMRMLTimeSeriesBundleNode* inputBundleNode,
...
//---------------------------------------------------------------------------
int vtkMotionTrackerLogic::GetNumberOfFrames()
{
  return this->FrameNodeVector.size();
}

//---------------------------------------------------------------------------
const char* vtkMotionTrackerLogic::GetFrameNodeID(int index)
{
...
//---------------------------------------------------------------------------
const char* vtkMotionTrackerLogic::GetRegisteredFrameNodeID(int index)
{
