...
class CurveFittingGammaVariateRCBV_FixedDelay(CurveAnalysisBase):

    # ------------------------------
    # Constructor -- Set initial parameters
    def __init__(self):
        self.ParameterNameList  = ['Sp', 'alpha', 'beta']
        self.InitialParameter   = [200.0, 3.0,    1.0] 

        self.ConstantNameList   = ['Ta']
        self.Constant           = [60]
