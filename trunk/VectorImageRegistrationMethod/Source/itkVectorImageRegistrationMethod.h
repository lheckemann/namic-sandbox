/*=========================================================================
  ...
  Module:    $RCSfile: itkVectorImageRegistrationMethod.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkVectorImageRegistrationMethod_h
#define __itkVectorImageRegistrationMethod_h
...
/** \class VectorImageRegistrationMethod
...
class ITK_EXPORT VectorImageRegistrationMethod : public ProcessObject 
{
public:
  /** Standard class typedefs. */
  typedef VectorImageRegistrationMethod  Self;
  ...
  itkTypeMacro(VectorImageRegistrationMethod, ProcessObject);
  ...
  /**  Type of the metric. */
  typedef VectorImageToImageMetric< FixedImageType,
...
protected:
  VectorImageRegistrationMethod();
  virtual ~VectorImageRegistrationMethod() {};
...
private:
  VectorImageRegistrationMethod(const Self&); //purposely not implemented
...
#include "itkVectorImageRegistrationMethod.txx"
#endif
