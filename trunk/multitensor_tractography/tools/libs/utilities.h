...
// Relative anisotropy.
double l2ra(double l1, double l2, double l3) {
  return 0.5 * sqrt(2.0) * sqrt((l1 - l2) * (l1 - l2) +
                                (l1 - l3) * (l1 - l3) +
                                (l2 - l3) * (l2 - l3)) / (l1 + l2 + l3);
}

// Trace.
double trace(double l1, double l2, double l3) {
  static double one_over_three = 1.0 / 3.0;
  return one_over_three * (l1 + l2 + l3);
}
