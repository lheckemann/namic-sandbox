...
/*
  $Id: nmrMultiVariablePowerBasis.h,v 1.7 2006/07/10 15:31:53 ofri Exp $
...
class nmrMultiVariablePowerBasis::StandardPowerBasis : public nmrMultiVariablePowerBasis
{
public:
...
class nmrMultiVariablePowerBasis::BarycentricBasis : public nmrMultiVariablePowerBasis
{
protected:
