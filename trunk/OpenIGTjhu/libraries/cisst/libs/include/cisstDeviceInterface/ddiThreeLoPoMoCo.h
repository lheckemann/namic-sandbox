...
#ifndef _ddiThreeLoPoMoCo_h
#define _ddiThreeLoPoMoCo_h
...
class ddiThreeLoPoMoCo: public ddiCompositeDevice
{
...
public:
    ...
    ddiThreeLoPoMoCo(const char* deviceName = "ThreeLoPoMoCo",
...
CMN_DECLARE_SERVICES_INSTANTIATION(ddiThreeLoPoMoCo);
