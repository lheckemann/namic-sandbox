...
// ****************************************************************************
//
//  $Id: ddiATIDAQFT.h,v 1.4 2005/09/26 15:41:46 anton Exp $
//
...
#ifndef _ddiATIDAQFT_h
#define _ddiATIDAQFT_h
...
*/
class ddiATIDAQFT: public ddiDeviceInterface {
    CMN_DECLARE_SERVICES(ddiATIDAQFT, CMN_NO_DYNAMIC_CREATION);
