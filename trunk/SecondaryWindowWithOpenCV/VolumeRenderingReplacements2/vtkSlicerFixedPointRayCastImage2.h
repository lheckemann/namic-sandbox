/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerFixedPointRayCastImage2.h,v $
...
// .NAME vtkSlicerFixedPointRayCastImage2 - helper class for a ray cast image
// .SECTION Description
...
// vtkSlicerFixedPointVolumeRayCastMapper2 so that multiple mappers can share
...
#ifndef __vtkSlicerFixedPointRayCastImage2_h
#define __vtkSlicerFixedPointRayCastImage2_h
#include "vtkVolumeRenderingReplacements2.h"
#include "vtkObject.h"

class VTK_VOLUMERENDERINGREPLACEMENTS_EXPORT vtkSlicerFixedPointRayCastImage2 : public vtkObject
{
public:
  static vtkSlicerFixedPointRayCastImage2 *New();
  vtkTypeRevisionMacro(vtkSlicerFixedPointRayCastImage2,vtkObject);
...
protected:
  vtkSlicerFixedPointRayCastImage2();
  ~vtkSlicerFixedPointRayCastImage2();
...
private:
  vtkSlicerFixedPointRayCastImage2(const vtkSlicerFixedPointRayCastImage2&);  // Not implemented.
  void operator=(const vtkSlicerFixedPointRayCastImage2&);  // Not implemented.
};
