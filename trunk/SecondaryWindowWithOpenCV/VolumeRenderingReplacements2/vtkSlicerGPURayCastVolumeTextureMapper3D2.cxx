/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerGPURayCastVolumeTextureMapper3D2.h,v $
  ...
  Program:   vtkSlicerGPURayCastVolumeTextureMapper3D2
...
#include "vtkSlicerGPURayCastVolumeTextureMapper3D2.h"
...
vtkCxxRevisionMacro(vtkSlicerGPURayCastVolumeTextureMapper3D2, "$Revision: 1.2 $");
vtkStandardNewMacro(vtkSlicerGPURayCastVolumeTextureMapper3D2);
//#endif

vtkSlicerGPURayCastVolumeTextureMapper3D2::vtkSlicerGPURayCastVolumeTextureMapper3D2()
{
  this->Initialized          =  0;
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::ReleaseGraphicsResources(vtkWindow 
                                *renWin)
{
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::Render(vtkRenderer *ren, vtkVolume *vol)
{  
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::AdaptivePerformanceControl()
{
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::SetupRayCastParameters(vtkRenderer *pRen, vtkVolume *pVol)
{
  double bounds[6];
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::RenderGLSL( vtkRenderer *ren, vtkVolume *vol )
{
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::DeleteTextureIndex( GLuint *index )
{
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::CreateTextureIndex( GLuint *index )
{
  GLuint tempIndex=0;    
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::Setup3DTextureParameters( vtkVolumeProperty *property )
{
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::SetupTextures( vtkRenderer *vtkNotUsed(ren),
            vtkVolume *vol )
{
  //0, 1, 2, 3
  //7, 6, 5, 4
...
int  vtkSlicerGPURayCastVolumeTextureMapper3D2::IsRenderSupported(vtkVolumeProperty *property )
{
  if ( !this->Initialized )
    {
    this->Initialize();
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::Initialize()
{
  this->Initialized = 1;
...
int vtkSlicerGPURayCastVolumeTextureMapper3D2::IsTextureSizeSupported( int size[3] )
{
...
// Print the vtkSlicerGPURayCastVolumeTextureMapper3D2
void vtkSlicerGPURayCastVolumeTextureMapper3D2::PrintSelf(ostream& os, vtkIndent indent)
{
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::DrawVolumeBBox()
{       
    glBegin(GL_QUADS);      
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::InitializeRayCast()
{
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::LoadRayCastProgram()
{
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::LoadVertexShader()
{
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::LoadNoShadingFragmentShaderMIPFour()
{
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::LoadNoShadingFragmentShaderMINIPFour()
{
    std::ostringstream fp_oss;
    fp_oss <<
        "varying vec3 ViewDir;                                                                 \n"
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::LoadNoShadingFragmentShaderFour()
{
    std::ostringstream fp_oss;
    fp_oss <<
        "varying vec3 ViewDir;                                                                 \n"
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::LoadFragmentShaderFour()
{
    std::ostringstream fp_oss;
    fp_oss <<
        "varying vec3 ViewDir;                                                                 \n"
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::LoadNoShadingFragmentShaderMIPTwo()
{
    std::ostringstream fp_oss;
    fp_oss <<
        "varying vec3 ViewDir;                                                                 \n"
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::LoadNoShadingFragmentShaderMINIPTwo()
{
    std::ostringstream fp_oss;
    fp_oss <<
        "varying vec3 ViewDir;                                                                 \n"
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::LoadNoShadingFragmentShaderTwo()
{
    std::ostringstream fp_oss;
    fp_oss <<
        "varying vec3 ViewDir;                                                                 \n"
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::LoadFragmentShaderTwo()
{
    std::ostringstream fp_oss;
    fp_oss <<
        "varying vec3 ViewDir;                                                                 \n"
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::LoadNoShadingFragmentShaderMIP()
{
    std::ostringstream fp_oss;
    fp_oss <<
        "varying vec3 ViewDir;                                                                 \n"
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::LoadNoShadingFragmentShaderMINIP()
{
    std::ostringstream fp_oss;
    fp_oss <<
        "varying vec3 ViewDir;                                                                 \n"
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::LoadNoShadingFragmentShader()
{
    std::ostringstream fp_oss;
    fp_oss <<
        "varying vec3 ViewDir;                                                                 \n"
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::LoadFragmentShader()
{
    std::ostringstream fp_oss;
    fp_oss <<
        "varying vec3 ViewDir;                                                                 \n"
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::PrintGLErrorString()
{
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::PrintFragmentShaderInfoLog()
{
    GLint infoLogLen;
    vtkgl::GetShaderiv(RayCastFragmentShader, vtkgl::INFO_LOG_LENGTH, &infoLogLen);
    try
...
void vtkSlicerGPURayCastVolumeTextureMapper3D2::SetTechnique(int tech)
{
    this->Technique = tech;
    this->ReloadShaderFlag = 1;
}

void vtkSlicerGPURayCastVolumeTextureMapper3D2::SetInternalVolumeSize(int size)
{
