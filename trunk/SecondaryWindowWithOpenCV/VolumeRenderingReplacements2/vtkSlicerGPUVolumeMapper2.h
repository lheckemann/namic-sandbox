/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerGPUVolumeMapper2.h,v $
...
=========================================================================*/
// .NAME vtkSlicerGPUVolumeMapper2 - GPU volume render with 3D texture mapping (GLSL)

// .SECTION Description
// vtkSlicerGPUVolumeMapper2 renders two volume using 3D texture mapping in fragment shader. 
// This class is actually an abstract superclass - with all the actual
// work done by vtkSlicerGPURayCastVolumeMapper2. 
// 
...
#ifndef __vtkSlicerGPUVolumeMapper2_h
#define __vtkSlicerGPUVolumeMapper2_h
...
class vtkSlicerGPUVolumeMapper2;
typedef struct{
    float *dataPtr;
...
class VTK_VOLUMERENDERINGREPLACEMENTS_EXPORT vtkSlicerGPUVolumeMapper2 : public vtkVolumeMapper
{
public:
  vtkTypeRevisionMacro(vtkSlicerGPUVolumeMapper2,vtkVolumeMapper);
  void PrintSelf(ostream& os, vtkIndent indent);

  static vtkSlicerGPUVolumeMapper2 *New();
...
protected:
  ...
  friend VTK_THREAD_RETURN_TYPE vtkSlicerGPUVolumeMapper2ComputeGradients( void *arg );
  
private:
  vtkSlicerGPUVolumeMapper2(const vtkSlicerGPUVolumeMapper2&);  // Not implemented.
  void operator=(const vtkSlicerGPUVolumeMapper2&);  // Not implemented.
};
