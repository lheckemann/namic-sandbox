/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerVolumePropertyWidget2.cxx,v $
...
=========================================================================*/
#include "vtkSlicerVolumePropertyWidget2.h"
...
//----------------------------------------------------------------------------
//vtkCxxRevisionMacro(vtkSlicerVolumePropertyWidget2, "$Revision: 1.45 $");
vtkStandardNewMacro(vtkSlicerVolumePropertyWidget2);

//----------------------------------------------------------------------------
vtkSlicerVolumePropertyWidget2::vtkSlicerVolumePropertyWidget2()
{
  int i;
  ...
  this->MaterialPropertyPosition   = 
    vtkSlicerVolumePropertyWidget2::MaterialPropertyPositionTop;
  this->WholeRangeComputationMethod   = 
    vtkSlicerVolumePropertyWidget2::WholeRangeComputationMethodData;
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::CreateWidget()
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::Pack()
{
  if (!this->IsCreated())
    {
    return;
  ...
  */
  ...
  if (!this->MaterialPropertyVisibility)
    ...
    if (this->MaterialPropertyPosition == 
        vtkSlicerVolumePropertyWidget2::MaterialPropertyPositionTop ||
      this->MaterialPropertyPosition == 
        vtkSlicerVolumePropertyWidget2::MaterialPropertyPositionBottomFrame)
      {
      ...
      if (this->MaterialPropertyPosition == 
          vtkSlicerVolumePropertyWidget2::MaterialPropertyPositionScalarOpacityUserFrame)
        {
        tk_cmd << 
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::Update()
{
  // Update enable state
      ...
      if (has_scalar_range &&
        ...
        this->ScalarOpacityFunctionEditor->SetWholeParameterRange(
          scalar_range);
               ...
               (this->WholeRangeComputationMethod ==
        vtkSlicerVolumePropertyWidget2::WholeRangeComputationMethodFunctionPoints ||
                !has_scalar_range))
        {
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::UpdateEnableState()
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetVolumeProperty(
...
//----------------------------------------------------------------------------
int vtkSlicerVolumePropertyWidget2::GetIndependentComponents()
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetDataSet(
  vtkDataSet *arg)
{
  if (this->DataSet == arg)
    {
...
// ---------------------------------------------------------------------------
int vtkSlicerVolumePropertyWidget2::GetNumberOfComponents()
{
  if (this->DataSet)
    {
...
// ---------------------------------------------------------------------------
int vtkSlicerVolumePropertyWidget2::GetDataSetScalarRange(
...
// ---------------------------------------------------------------------------
int vtkSlicerVolumePropertyWidget2::GetDataSetAdjustedScalarRange(
  int comp, double range[2])
{
  if (this->DataSet)
    {
...
// ---------------------------------------------------------------------------
const char* vtkSlicerVolumePropertyWidget2::GetDataSetScalarName()
{
  if (this->DataSet)
    {
    vtkDataArray *scalars = this->DataSet->GetPointData()->GetScalars();
...
// ---------------------------------------------------------------------------
int vtkSlicerVolumePropertyWidget2::GetDataSetScalarOpacityUnitDistanceRangeAndResolution(
...
// ---------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetHistogramSet(vtkKWHistogramSet *arg)
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetEnableShadingForAllComponents(int arg)
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetComponentSelectionVisibility(int arg)
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetHSVColorSelectorVisibility(int arg)
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetInteractiveApplyButtonVisibility(int arg)
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetScalarOpacityUnitDistanceVisibility(int arg)
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetInterpolationTypeVisibility(int arg)
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetMaterialPropertyVisibility(int arg)
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetMaterialPropertyPosition(int arg)
{
  if (arg < vtkSlicerVolumePropertyWidget2::MaterialPropertyPositionTop)
    {
    arg = vtkSlicerVolumePropertyWidget2::MaterialPropertyPositionTop;
    }
  else if (arg > 
     vtkSlicerVolumePropertyWidget2::MaterialPropertyPositionScalarColorUserFrame)
    {
    arg = vtkSlicerVolumePropertyWidget2::MaterialPropertyPositionScalarColorUserFrame;
    }
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetMaterialPropertyPositionToTop()
{ 
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetMaterialPropertyPositionToBottomFrame()
{ 
  this->SetMaterialPropertyPosition(
    vtkSlicerVolumePropertyWidget2::MaterialPropertyPositionBottomFrame); 
};
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetMaterialPropertyPositionToScalarOpacityUserFrame()
{ 
  this->SetMaterialPropertyPosition(
    vtkSlicerVolumePropertyWidget2::MaterialPropertyPositionScalarOpacityUserFrame);
};
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetMaterialPropertyPositionToScalarColorUserFrame()
{ 
this->SetMaterialPropertyPosition(
  vtkSlicerVolumePropertyWidget2::MaterialPropertyPositionScalarColorUserFrame); 
};
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetWholeRangeComputationMethod(int arg)
{
  if (arg < vtkSlicerVolumePropertyWidget2::WholeRangeComputationMethodData)
    {
    arg = vtkSlicerVolumePropertyWidget2::WholeRangeComputationMethodData;
    }
  else if (arg > 
     vtkSlicerVolumePropertyWidget2::WholeRangeComputationMethodDataAndFunctionPoints)
    {
    arg = vtkSlicerVolumePropertyWidget2::WholeRangeComputationMethodDataAndFunctionPoints;
    }
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetWholeRangeComputationMethodToData()
{ 
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetWholeRangeComputationMethodToFunctionPoints()
{ 
  this->SetWholeRangeComputationMethod(
    vtkSlicerVolumePropertyWidget2::WholeRangeComputationMethodFunctionPoints); 
};
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetWholeRangeComputationMethodToDataAndFunctionPoints()
{ 
  this->SetWholeRangeComputationMethod(
    vtkSlicerVolumePropertyWidget2::WholeRangeComputationMethodDataAndFunctionPoints); 
};
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetGradientOpacityFunctionVisibility(int arg)
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetComponentWeightsVisibility(int arg)
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetSelectedComponent(int arg)
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetWindowLevel(float window, float level)
{
  if (this->ScalarOpacityFunctionEditor)
    {
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetInteractiveWindowLevel(
...
//----------------------------------------------------------------------------
int vtkSlicerVolumePropertyWidget2::IsInWindowLevelMode()
{
  int res = 0;
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetUseScalarColorFunctionInScalarOpacityEditor(int arg)
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::MergeScalarOpacityAndColorEditors()
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::InvokeObjectMethodCommand(const char *command)
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetVolumePropertyChangedCommand(
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::InvokeVolumePropertyChangedCommand()
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SetVolumePropertyChangingCommand(
  vtkObject *object, const char *method)
{
  this->SetObjectMethodCommand(
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::InvokeVolumePropertyChangingCommand()
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::SelectedComponentCallback(int n)
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::InterpolationTypeCallback(int type)
{
  if (this->VolumeProperty && 
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::EnableShadingCallback(int state)
{
  if (!this->VolumeProperty || 
      !this->EnableShadingForAllComponents)
    {
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::LockOpacityAndColorCallback(int state)
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::EnableGradientOpacityCallback(int val)
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::MaterialPropertyChangedCallback()
{
  this->InvokeVolumePropertyChangedCommand();
}

//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::MaterialPropertyChangingCallback()
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::InteractiveApplyCallback(int state)
{
  this->SetInteractiveApplyMode(state ? 1 : 0);
}

//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::ScalarOpacityFunctionChangedCallback()
{
  if (this->ScalarOpacityFunctionEditor &&
      this->ScalarOpacityFunctionEditor->GetWindowLevelMode())
    {
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::ScalarOpacityFunctionChangingCallback()
{
  if (this->ScalarOpacityFunctionEditor &&
      this->ScalarOpacityFunctionEditor->GetWindowLevelMode())
    {
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::DoubleClickOnScalarOpacityPointCallback(int id)
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::ScalarOpacityUnitDistanceChangedCallback(
  double value)
{
  if (!this->VolumeProperty)
    {
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::ScalarOpacityUnitDistanceChangingCallback(
  double value)
{
  if (!this->VolumeProperty)
    {
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::WindowLevelModeCallback(int mode)
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::RGBTransferFunctionChangedCallback()
{
  this->UpdateHSVColorSelectorFromScalarColorFunctionEditor();
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::RGBTransferFunctionChangingCallback()
{
  this->UpdateHSVColorSelectorFromScalarColorFunctionEditor();
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::RGBTransferFunctionSelectionChangedCallback()
{
  this->UpdateHSVColorSelectorFromScalarColorFunctionEditor();
}

//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::UpdateHSVColorSelectorFromScalarColorFunctionEditor()
{
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::GradientOpacityFunctionChangedCallback()
{
  this->InvokeVolumePropertyChangedCommand();
}

//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::GradientOpacityFunctionChangingCallback()
{
  if (this->InteractiveApplyMode)
    {
    this->InvokeVolumePropertyChangingCommand();
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::HSVColorSelectionChangedCallback(
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::HSVColorSelectionChangingCallback(
  double h, double s, double v)
{
  if (!this->ScalarColorFunctionEditor || 
      !this->ScalarColorFunctionEditor->HasFunction() || 
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::ComponentWeightChangedCallback(
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::ComponentWeightChangingCallback(
  int index, double value)
{
  this->VolumeProperty->SetComponentWeight(index, value);
...
//----------------------------------------------------------------------------
void vtkSlicerVolumePropertyWidget2::PrintSelf(ostream& os, vtkIndent indent)
{
