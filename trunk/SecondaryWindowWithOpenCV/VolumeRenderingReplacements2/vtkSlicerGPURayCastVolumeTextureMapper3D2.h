...
=========================================================================*/
// .NAME vtkSlicerGPURayCastVolumeTextureMapper3D2 - concrete implementation of 3D volume texture mapping

// .SECTION Description
// vtkSlicerGPURayCastVolumeTextureMapper3D2 renders a volume using ray casting on 3D texture.
// See vtkVolumeTextureMapper3D for full description.

// .SECTION see also
// vtkVolumeTextureMapper3D vtkVolumeMapper

#ifndef __vtkSlicerGPURayCastVolumeTextureMapper3D2_h
#define __vtkSlicerGPURayCastVolumeTextureMapper3D2_h
...
class VTK_VOLUMERENDERINGREPLACEMENTS_EXPORT vtkSlicerGPURayCastVolumeTextureMapper3D2 : public vtkSlicerGPUVolumeTextureMapper3D2
{
public:
  vtkTypeRevisionMacro(vtkSlicerGPURayCastVolumeTextureMapper3D2,vtkSlicerGPUVolumeTextureMapper3D2);
  void PrintSelf(ostream& os, vtkIndent indent);

  static vtkSlicerGPURayCastVolumeTextureMapper3D2 *New();
...
protected:
  vtkSlicerGPURayCastVolumeTextureMapper3D2();
  ~vtkSlicerGPURayCastVolumeTextureMapper3D2();
...
private:
  vtkSlicerGPURayCastVolumeTextureMapper3D2(const vtkSlicerGPURayCastVolumeTextureMapper3D2&);  // Not implemented.
  void operator=(const vtkSlicerGPURayCastVolumeTextureMapper3D2&);  // Not implemented.
