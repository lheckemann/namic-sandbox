/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerOpenGLRayCastImageDisplayHelper2.cxx,v $
...
#ifndef VTK_IMPLEMENT_MESA_CXX
vtkCxxRevisionMacro(vtkSlicerOpenGLRayCastImageDisplayHelper2, "$Revision: 1.4 $");
vtkStandardNewMacro(vtkSlicerOpenGLRayCastImageDisplayHelper2);
#endif

// Construct a new vtkSlicerOpenGLRayCastImageDisplayHelper2 with default values
vtkSlicerOpenGLRayCastImageDisplayHelper2::vtkSlicerOpenGLRayCastImageDisplayHelper2()
{
  this->PreviousImage = NULL;
}

// Destruct a vtkSlicerOpenGLRayCastImageDisplayHelper2 - clean up any memory used
vtkSlicerOpenGLRayCastImageDisplayHelper2::~vtkSlicerOpenGLRayCastImageDisplayHelper2()
{
}
...
//
void vtkSlicerOpenGLRayCastImageDisplayHelper2::RenderTexture( vtkVolume *vol, 
                                                        vtkRenderer *ren,
...
void vtkSlicerOpenGLRayCastImageDisplayHelper2::RenderTextureInternal( vtkVolume *vol, 
                                                                vtkRenderer *ren,
                                                                int imageMemorySize[2],
                                                                int imageViewportSize[2],
                                                                int imageInUseSize[2],
...
void vtkSlicerOpenGLRayCastImageDisplayHelper2::PrintSelf(ostream& os, vtkIndent indent)
{
