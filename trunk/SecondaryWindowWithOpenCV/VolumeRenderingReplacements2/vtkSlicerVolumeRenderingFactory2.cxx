/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerVolumeRenderingFactory2.cxx,v $
...
vtkCxxRevisionMacro(vtkSlicerVolumeRenderingFactory2, "$Revision: 1.7 $");
vtkStandardNewMacro(vtkSlicerVolumeRenderingFactory2);


vtkObject* vtkSlicerVolumeRenderingFactory2::CreateInstance(const char* vtkclassname )
{
  ...
  if (!strcmp("OpenGL",rl) || !strcmp("Win32OpenGL",rl) || !strcmp("CarbonOpenGL",rl) || !strcmp("CocoaOpenGL",rl))
    ...
    if(strcmp(vtkclassname, "vtkSlicerVolumeTextureMapper3D2") == 0)
      {
#if defined(VTK_USE_MANGLED_MESA)
      if ( vtkGraphicsFactory::GetUseMesaClasses() )
        {
...
#endif
      return vtkSlicerOpenGLVolumeTextureMapper3D2::New();
      }

        // 3D Volume Texture GPU RayCast Mapper
    if(strcmp(vtkclassname, "vtkSlicerGPURayCastVolumeTextureMapper3D2") == 0)
      {
#if defined(VTK_USE_MANGLED_MESA)
      if ( vtkGraphicsFactory::GetUseMesaClasses() )
        {
...
#endif
        return vtkSlicerGPURayCastVolumeTextureMapper3D2::New();
      }
      
    // Ray Cast Image Display Helper
    if(strcmp(vtkclassname, "vtkSlicerRayCastImageDisplayHelper2") == 0)
      {
#if defined(VTK_USE_MANGLED_MESA)
      if ( vtkGraphicsFactory::GetUseMesaClasses() )
        {
...
#endif
      return vtkSlicerOpenGLRayCastImageDisplayHelper2::New();
      }
    }
#endif
...
//----------------------------------------------------------------------------
void vtkSlicerVolumeRenderingFactory2::PrintSelf(ostream& os, vtkIndent indent)
{
