...
Module:    $RCSfile: vtkSlicerFixedPointVolumeRayCastMapper2.cxx,v $
...
=========================================================================*/
#include "vtkSlicerFixedPointVolumeRayCastMapper2.h"
...
#include "vtkSlicerFixedPointVolumeRayCastCompositeGOHelper2.h"
#include "vtkSlicerFixedPointVolumeRayCastCompositeGOShadeHelper2.h"
#include "vtkSlicerFixedPointVolumeRayCastCompositeHelper2.h"
#include "vtkSlicerFixedPointVolumeRayCastCompositeShadeHelper2.h"
#include "vtkSlicerFixedPointVolumeRayCastMIPHelper2.h"
#include "vtkMath.h"
...
#include "vtkSlicerFixedPointRayCastImage2.h"

#include <math.h>

vtkCxxRevisionMacro(vtkSlicerFixedPointVolumeRayCastMapper2, "$Revision: 1.20.4.1 $");
vtkStandardNewMacro(vtkSlicerFixedPointVolumeRayCastMapper2); 
vtkCxxSetObjectMacro(vtkSlicerFixedPointVolumeRayCastMapper2, RayCastImage, vtkSlicerFixedPointRayCastImage2);
...
template <class T>
void vtkSlicerFixedPointVolumeRayCastMapper2FillInMinMaxVolume( T *dataPtr, unsigned short *minMaxVolume,
...
template <class T>
void vtkSlicerFixedPointVolumeRayCastMapper2ComputeGradients( T *dataPtr,
                                                            int dim[3], 
                                                            double spacing[3],
                                                            int components,
                                                            int independent,
                                                            ...
                                                            vtkSlicerFixedPointVolumeRayCastMapper2 *me )
{
    int                 x, y, z, c;
    int                 x_start, x_limit;
    int                 y_start, y_limit;
...
// Construct a new vtkSlicerFixedPointVolumeRayCastMapper2 with default values
vtkSlicerFixedPointVolumeRayCastMapper2::vtkSlicerFixedPointVolumeRayCastMapper2()
{
    ...
    this->RayCastImage           = vtkSlicerFixedPointRayCastImage2::New();
    ...
    this->ImageDisplayHelper  = vtkSlicerRayCastImageDisplayHelper2::New();
...
// Destruct a vtkSlicerFixedPointVolumeRayCastMapper2 - clean up any memory used
vtkSlicerFixedPointVolumeRayCastMapper2::~vtkSlicerFixedPointVolumeRayCastMapper2()
{
...
float vtkSlicerFixedPointVolumeRayCastMapper2::ComputeRequiredImageSampleDistance( float desiredTime,
                                                                                 vtkRenderer *ren )
{
...
float vtkSlicerFixedPointVolumeRayCastMapper2::RetrieveRenderTime( vtkRenderer *ren, 
                                                                 vtkVolume   *vol )
{
    int i;
...
void vtkSlicerFixedPointVolumeRayCastMapper2::StoreRenderTime( vtkRenderer *ren, 
                                                             vtkVolume   *vol, 
                                                             float       time )
{
    int i;
...
void vtkSlicerFixedPointVolumeRayCastMapper2::SetNumberOfThreads( int num )
{
    this->Threader->SetNumberOfThreads( num );
}

int vtkSlicerFixedPointVolumeRayCastMapper2::GetNumberOfThreads()
{
    if (this->Threader)
    {
...
void vtkSlicerFixedPointVolumeRayCastMapper2::FillInMaxGradientMagnitudes( int fullDim[3],
                                                                         int smallDim[4] )
{
    int i, j, k, c;
    int sx1, sx2, sy1, sy2, sz1, sz2;
...
void vtkSlicerFixedPointVolumeRayCastMapper2::UpdateMinMaxVolume( vtkVolume *vol )
{
    int i, j, k, c;
    ...
    if ( needToUpdate&0x02 )
    {
            ...
            this->MinMaxVolumeSize[3] != targetSize[3] )
        {
            ...
            {
                vtkTemplateMacro( 
                    vtkSlicerFixedPointVolumeRayCastMapper2FillInMinMaxVolume(
...
void vtkSlicerFixedPointVolumeRayCastMapper2::UpdateCroppingRegions()
{
...
int vtkSlicerFixedPointVolumeRayCastMapper2::PerImageInitialization( vtkRenderer *ren, 
                                                                   vtkVolume *vol,
                                                                   int multiRender,
...
void vtkSlicerFixedPointVolumeRayCastMapper2::PerVolumeInitialization( vtkRenderer *ren, vtkVolume *vol )
{
...
void vtkSlicerFixedPointVolumeRayCastMapper2::PerSubVolumeInitialization( vtkRenderer *ren, vtkVolume *vol, int multiRender )
{
    this->UpdateCroppingRegions();
...
void vtkSlicerFixedPointVolumeRayCastMapper2::RenderSubVolume()
{
...
void vtkSlicerFixedPointVolumeRayCastMapper2::DisplayRenderedImage( vtkRenderer *ren,
                                                                  vtkVolume   *vol )
{ 
    float depth;
...
void vtkSlicerFixedPointVolumeRayCastMapper2::AbortRender()
{
    // Restore values
...
void vtkSlicerFixedPointVolumeRayCastMapper2::CaptureZBuffer( vtkRenderer *ren )
{
...
void vtkSlicerFixedPointVolumeRayCastMapper2::Render( vtkRenderer *ren, vtkVolume *vol )
{
...
VTK_THREAD_RETURN_TYPE SlicerFixedPointVolumeRayCastMapper_CastRays( void *arg )
{
    ...
    vtkSlicerFixedPointVolumeRayCastMapper2 *me = (vtkSlicerFixedPointVolumeRayCastMapper2 *)(((vtkMultiThreader::ThreadInfo *)arg)->UserData);
    ...
    if ( me->GetBlendMode() == vtkVolumeMapper::MAXIMUM_INTENSITY_BLEND )
      ...
      if  (me->GetMIPHelper() == NULL)
        {
        me->MIPHelper = vtkSlicerFixedPointVolumeRayCastMIPHelper2::New();
        }        
        ...
        if ( me->GetShadingRequired() == 0 )
          ...
          if ( me->GetGradientOpacityRequired() == 0 )
            ...
            if (me->GetCompositeHelper() == NULL)
              {
              me->CompositeHelper = vtkSlicerFixedPointVolumeRayCastCompositeHelper2::New();
              }
            ...
            if (me->GetCompositeGOHelper() == NULL)
              {
              me->CompositeGOHelper = vtkSlicerFixedPointVolumeRayCastCompositeGOHelper2::New();
              }
          ...
          if ( me->GetGradientOpacityRequired() == 0 )
            ...
            if (me->GetCompositeShadeHelper() == NULL)
              {
              me->CompositeShadeHelper = vtkSlicerFixedPointVolumeRayCastCompositeShadeHelper2::New();
              }
            ...
            if (me->GetCompositeGOShadeHelper() == NULL)
              {
              me->CompositeGOShadeHelper = vtkSlicerFixedPointVolumeRayCastCompositeGOShadeHelper2::New();
              }
...
void vtkSlicerFixedPointVolumeRayCastMapper2::ComputeRayInfo( int x, int y, unsigned int pos[3],
                                                            unsigned int dir[3],
...
void vtkSlicerFixedPointVolumeRayCastMapper2::InitializeRayInfo( vtkVolume   *vol )
{
    if ( !vol )
    {
        return;
...
int vtkSlicerFixedPointVolumeRayCastMapper2::ComputeRowBounds(vtkRenderer *ren,
                                                             int imageFlag,
                                                             int rowBoundsFlag,
                                                             int inputExtent[6] )
{
...
void vtkSlicerFixedPointVolumeRayCastMapper2::ComputeMatrices( double inputOrigin[3],
                                                             double inputSpacing[3],
                                                             int inputExtent[6],
                                                             vtkRenderer *ren,
                                                             vtkVolume *vol )
...
int vtkSlicerFixedPointVolumeRayCastMapper2::ClipRayAgainstClippingPlanes( float rayStart[3],
                                                                         float rayEnd[3],
...
int vtkSlicerFixedPointVolumeRayCastMapper2::ClipRayAgainstVolume( float rayStart[3],
                                                                 float rayEnd[3],
                                                                 float rayDirection[3],
                                                                 double bounds[6] )
{
...
void vtkSlicerFixedPointVolumeRayCastMapper2::ComputeGradients( vtkVolume *vol )
{
    vtkImageData *input = this->GetInput();
    ...
    {
        vtkTemplateMacro( 
            vtkSlicerFixedPointVolumeRayCastMapper2ComputeGradients(
...
int vtkSlicerFixedPointVolumeRayCastMapper2::UpdateShadingTable( vtkRenderer *ren,
                                                               vtkVolume *vol )
{
...
int vtkSlicerFixedPointVolumeRayCastMapper2::UpdateGradients( vtkVolume *vol )
{
    int needToUpdate = 0;
...
int vtkSlicerFixedPointVolumeRayCastMapper2::UpdateColorTable( vtkVolume *vol )
{
    int needToUpdate = 0;
...
int vtkSlicerFixedPointVolumeRayCastMapper2::ShouldUseNearestNeighborInterpolation( vtkVolume *vol )
{
...
// Print method for vtkSlicerFixedPointVolumeRayCastMapper2
void vtkSlicerFixedPointVolumeRayCastMapper2::PrintSelf(ostream& os, vtkIndent indent)
{
