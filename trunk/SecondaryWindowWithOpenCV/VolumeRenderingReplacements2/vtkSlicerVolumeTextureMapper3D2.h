/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerVolumeTextureMapper3D2.h,v $
...
=========================================================================*/
// .NAME vtkSlicerVolumeTextureMapper3D2 - volume render with 3D texture mapping

// .SECTION Description
// vtkSlicerVolumeTextureMapper3D2 renders a volume using 3D texture mapping. 
// This class is actually an abstract superclass - with all the actual
// work done by vtkSlicerOpenGLVolumeTextureMapper3D2. 
// 
...
// method. You should create a vtkSlicerVolumeTextureMapper3D2, assign its
...
#ifndef __vtkSlicerVolumeTextureMapper3D2_h
#define __vtkSlicerVolumeTextureMapper3D2_h
...
class VTK_VOLUMERENDERINGREPLACEMENTS_EXPORT vtkSlicerVolumeTextureMapper3D2 : public vtkVolumeMapper
{
public:
  vtkTypeRevisionMacro(vtkSlicerVolumeTextureMapper3D2,vtkVolumeMapper);
  void PrintSelf(ostream& os, vtkIndent indent);

  static vtkSlicerVolumeTextureMapper3D2 *New();
...
//ETX
  ...
  vtkSetClampMacro( PreferredRenderMethod, int, 
                    vtkSlicerVolumeTextureMapper3D2::FRAGMENT_PROGRAM_METHOD,
                    vtkSlicerVolumeTextureMapper3D2::NVIDIA_METHOD );
  void SetPreferredMethodToFragmentProgram() 
    { this->SetPreferredRenderMethod( vtkSlicerVolumeTextureMapper3D2::FRAGMENT_PROGRAM_METHOD ); }
  void SetPreferredMethodToNVidia() 
    { this->SetPreferredRenderMethod( vtkSlicerVolumeTextureMapper3D2::NVIDIA_METHOD ); }
  
      

protected:
  vtkSlicerVolumeTextureMapper3D2();
  ~vtkSlicerVolumeTextureMapper3D2();
...
private:
  vtkSlicerVolumeTextureMapper3D2(const vtkSlicerVolumeTextureMapper3D2&);  // Not implemented.
  void operator=(const vtkSlicerVolumeTextureMapper3D2&);  // Not implemented.
};
