/*=========================================================================
  ...
  Language:  C++
  Date:      $Date: 2009-09-10 12:37:19 -0400 (Thu, 10 Sep 2009) $
...
#include "DiscardDirectionCosinesCLP.h"
...
template<class T> int DoIt( int argc, char * argv[], T )
{
  ...
  dir = reader1->GetOutput()->GetDirection();
  spacing = reader1->GetOutput()->GetSpacing();
  std::cout << "Old direction: " << dir << std::endl;
  dir.SetIdentity();
  ...
  change->SetOutputDirection(dir);
  change->ChangeSpacingOn();
  change->SetOutputSpacing(spacing);
  change->Update();

  dir = change->GetOutput()->GetDirection();

  typename ImageType::Pointer outputImage = change->GetOutput();
  dir = outputImage->GetDirection();
  ...
  std::cout << "Output origin is: " << outputImage->GetOrigin() <<
  std::endl;
