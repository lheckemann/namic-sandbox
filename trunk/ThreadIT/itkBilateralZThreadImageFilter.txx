/*=========================================================================
  ...
  Module:    $RCSfile: itkBilateralZThreadImageFilter.txx,v $
  Language:  C++
...
=========================================================================*/
#ifndef _itkBilateralZThreadImageFilter_txx
#define _itkBilateralZThreadImageFilter_txx
...
inline int BilateralZFloor(double x)
{
...
::GenerateData()
{
  ...
  try
    ...
    for ( int i = 0; i < 20; i++ )
      ...
      s->threadId = i;
      s->Filter = this;
      this->SplitRequestedRegion(s->threadId, 20, splitRegion);
    ...
    while ( ! b_iter.IsAtEnd() )
      ...
      for (i=0, k_it = m_GaussianKernel.Begin(); k_it < kernelEnd;
        ...
        if (rangeDistance < rangeDistanceThreshold)
          ...
          rangeGaussian = m_RangeGaussianTable[BilateralZFloor(tableArg)];
