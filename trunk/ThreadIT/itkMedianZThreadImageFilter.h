/*=========================================================================
  ...
  Module:    $RCSfile: itkMedianZThreadImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkMedianZThreadImageFilter_h
#define __itkMedianZThreadImageFilter_h
...
namespace itk
{
/** \class MedianZThreadImageFilter
...
class ITK_EXPORT MedianZThreadImageFilter :
    public ImageToImageFilter< TInputImage, TOutputImage >
{
 public:
  ...
  typedef MedianZThreadImageFilter Self;
  ...
  itkTypeMacro(MedianZThreadImageFilter, ImageToImageFilter);
  ...
  /** MedianZThreadImageFilter needs a larger input requested region than
   * the output requested region.  As such, MedianZThreadImageFilter needs
  ...
  itkSetMacro(NumberOfPieces,int);
  itkGetMacro(NumberOfPieces,int);
 ...
 protected:
  ...
  virtual ~MedianZThreadImageFilter() {}
  void PrintSelf(std::ostream& os, Indent indent) const;

  /** MedianZThreadImageFilter can be implemented as a multithreaded filter.
  ...
  void ThreadedGenerateData(const OutputImageRegionType& outputRegionForThread,
                            int threadId );
private:
  MedianZThreadImageFilter(const Self&); //purposely not implemented
...
#include "itkMedianZThreadImageFilter.txx"
#endif
