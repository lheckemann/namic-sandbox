...
public:
  ...
  itkTypeMacro(BilateralZThreadImageFilter, ImageToImageFilter);
 ...
 protected:
  ...
  virtual ~BilateralZThreadImageFilter() {}
  ...
  /** BilateralZThreadImageFilter needs a larger input requested region than
   * the output requested region (larger by the size of the domain
   * Gaussian kernel).  As such, BilateralZThreadImageFilter needs to provide
...
#include "itkBilateralZThreadImageFilter.txx"
#endif
