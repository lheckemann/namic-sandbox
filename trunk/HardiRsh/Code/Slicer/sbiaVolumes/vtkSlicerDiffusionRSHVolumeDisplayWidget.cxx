...
//---------------------------------------------------------------------------
vtkStandardNewMacro (vtkSlicerDiffusionRSHVolumeDisplayWidget );
vtkCxxRevisionMacro ( vtkSlicerDiffusionRSHVolumeDisplayWidget, "$Revision: 1.0 $");


//---------------------------------------------------------------------------
vtkSlicerDiffusionRSHVolumeDisplayWidget::vtkSlicerDiffusionRSHVolumeDisplayWidget ( )
{
...
//---------------------------------------------------------------------------
void vtkSlicerDiffusionRSHVolumeDisplayWidget::PrintSelf ( ostream& os, vtkIndent indent )
{
    this->vtkObject::PrintSelf ( os, indent );

    os << indent << "vtkSlicerDiffusionRSHVolumeDisplayWidget: " << this->GetClassName ( ) << "\n";
    // print widgets?
}

//---------------------------------------------------------------------------
void vtkSlicerDiffusionRSHVolumeDisplayWidget::ProcessWidgetEvents ( vtkObject *caller,
                                                         unsigned long event, void *callData )
{
  ...
  if (scalarMenu == this->ScalarModeMenu->GetWidget()->GetWidget()->GetMenu() && 
    ...
    vtkMRMLDiffusionRSHVolumeDisplayNode *displayNode = vtkMRMLDiffusionRSHVolumeDisplayNode::SafeDownCast(this->GetVolumeDisplayNode());
    if (volumeNode != NULL && displayNode != NULL)
      ...
      this->RSHMathematics->SetInput(volumeNode->GetImageData());
      this->RSHMathematics->SetOperation(displayNode->GetScalarInvariant());
      this->RSHMathematics->Update();
      
      vtkImageData* image = this->RSHMathematics->GetOutput();
    ...
    if (displayNode==NULL)
      {
        ...
        if (volumeNode == NULL)
          ...
          {
          displayNode = vtkMRMLDiffusionRSHVolumeDisplayNode::New ();
...
//---------------------------------------------------------------------------
void vtkSlicerDiffusionRSHVolumeDisplayWidget::ProcessMRMLEvents ( vtkObject *caller,
                                              unsigned long event, void *callData )
{
if (this->UpdatingMRML || this->UpdatingWidget)
    {
  ...
  vtkMRMLDiffusionRSHVolumeNode *volumeNode = vtkMRMLDiffusionRSHVolumeNode::SafeDownCast(caller);
  if (volumeNode == curVolumeNode && 
    ...
    this->GlyphDisplayWidget->SetDiffusionRSHVolumeNode(volumeNode);
...
//---------------------------------------------------------------------------
void vtkSlicerDiffusionRSHVolumeDisplayWidget::UpdateWidgetFromMRML ()
{ 
  ...
  vtkMRMLDiffusionRSHVolumeNode *volumeNode = vtkMRMLDiffusionRSHVolumeNode::SafeDownCast(this->GetVolumeNode());
...
void vtkSlicerDiffusionRSHVolumeDisplayWidget::AddWidgetObservers ( )
{  
...
//---------------------------------------------------------------------------
void vtkSlicerDiffusionRSHVolumeDisplayWidget::RemoveWidgetObservers ( ) 
{
...
//---------------------------------------------------------------------------
void vtkSlicerDiffusionRSHVolumeDisplayWidget::CreateWidget ( )
{
  ...
  vtkMRMLDiffusionRSHVolumeDisplayNode *displayNode = vtkMRMLDiffusionRSHVolumeDisplayNode::SafeDownCast(this->GetVolumeDisplayNode());
  vtkMRMLDiffusionRSHDisplayPropertiesNode *propNode = NULL;
  ...
  if (displayNode != NULL)
    ...
    if (propNode == NULL)
      ...
      propNode = vtkMRMLDiffusionRSHDisplayPropertiesNode::New();
      }
    ...
    this->GlyphDisplayWidget = vtkSlicerDiffusionRSHVolumeGlyphDisplayWidget::New();
    ...
    vtkMRMLDiffusionRSHVolumeNode *dtvolumeNode = vtkMRMLDiffusionRSHVolumeNode::SafeDownCast(this->GetVolumeNode());
    if (dtvolumeNode != NULL)
      {
      this->GlyphDisplayWidget->SetDiffusionRSHVolumeNode(dtvolumeNode);
      }
    ...
    if (displayNode != NULL)
      {
       ...
       if (displayNode != vtkMRMLDiffusionRSHVolumeDisplayNode::SafeDownCast(this->GetVolumeDisplayNode()) )
        {
        displayNode->Delete();
        }
      }
