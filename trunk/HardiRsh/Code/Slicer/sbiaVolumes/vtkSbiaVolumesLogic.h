/*=auto=========================================================================
  ...
  Program:   3D Slicer
  Module:    $RCSfile: vtkSbiaVolumesLogic.h,v $
  Date:      $Date: 2006/01/08 04:48:05 $
  Version:   $Revision: 1.45 $

=========================================================================auto=*/

// .NAME vtkSbiaVolumesLogic - slicer logic class for volumes manipulation
// .SECTION Description
// This class manages the logic associated with reading, saving,
// and changing propertied of the volumes


#ifndef __vtkSbiaVolumesLogic_h
#define __vtkSbiaVolumesLogic_h
...
class VTK_VOLUMES_EXPORT vtkSbiaVolumesLogic : public vtkSlicerModuleLogic 
{
  public:
  
  // The Usual vtk class functions
  static vtkSbiaVolumesLogic *New();
  vtkTypeRevisionMacro(vtkSbiaVolumesLogic,vtkObject);
...
protected:
  vtkSbiaVolumesLogic();
  virtual ~vtkSbiaVolumesLogic();
  vtkSbiaVolumesLogic(const vtkSbiaVolumesLogic&);
  void operator=(const vtkSbiaVolumesLogic&);
