...
int vtkMRMLDiffusionRSHVolumeNodeTest1(int , char * [] )
{
  vtkSmartPointer< vtkMRMLDiffusionRSHVolumeNode > node1 = vtkSmartPointer< vtkMRMLDiffusionRSHVolumeNode >::New();

  EXERCISE_BASIC_OBJECT_METHODS( node1 );

  node1->UpdateReferences();

  vtkSmartPointer< vtkMRMLDiffusionRSHVolumeNode > node2 = vtkSmartPointer< vtkMRMLDiffusionRSHVolumeNode >::New();
