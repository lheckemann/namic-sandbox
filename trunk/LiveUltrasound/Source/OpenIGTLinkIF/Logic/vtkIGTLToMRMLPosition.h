/*==========================================================================
  ...
  Program:   3D Slicer
  Module:    $HeadURL: http://svn.slicer.org/Slicer4/trunk/Modules/OpenIGTLinkIF/vtkIGTLToMRMLPosition.h $
...
class VTK_SLICER_OPENIGTLINKIF_MODULE_LOGIC_EXPORT vtkIGTLToMRMLPosition : public vtkIGTLToMRMLBase
{
 public:
