...
########################################
    ...
    set PetFlowImageId [b2 load image $pathToRegressionDir/SGI/pet_images/worsley-test/TEST/images/pckja10cn01_416.imf data-type= float-single]
...
#return $MODULE_FAILURE
    ...
    set PetCountImageId [b2 load image $pathToRegressionDir/SGI/pet_images/worsley-test/TEST/images/pckja10cn01_416.ima data-type= float-single]
...
#return $MODULE_FAILURE
    ...
    set TalairachId [b2 load talairach-parameters $pathToRegressionDir/SGI/pet_images/worsley-test/TEST/images/10_ACPC/talairach_parameters]
...
#return $MODULE_FAILURE
    ...
    set PetFlowXfrmId [b2 load transform $pathToRegressionDir/SGI/pet_images/worsley-test/TEST/images/pckja10cn01_416.imf.air]
...
#return $MODULE_FAILURE
    ...
    set PetCountXfrmId [b2 load transform $pathToRegressionDir/SGI/pet_images/worsley-test/TEST/images/pckja10cn01_416.ima.air]
...
#return $MODULE_FAILURE
    ...
    b2 set transform $PetFlowXfrmId image $PetFlowImageId
    b2 set transform $PetCountXfrmId image $PetCountImageId
    ...
    set TestMaskId [b2 threshold image $TestImageId 5000]
...
#    set expect 1183.043855
    ...
    set saveResult [b2 save image $results_dir/$experiment_dir/test_IMA.raw pic/raw $TestImageId data-type= signed-16bit plane= Axial]
    ...
    set saveResult [b2 save image $results_dir/$experiment_dir/test_PET_IMA.raw pic/raw $TestImageId data-type= signed-16bit plane= Axial]
    ReportTestStatus $LogFile  [ expr {$saveResult != -1 } ] $ModuleName $SubTestDes


    set SubTestDes "OLD COUNT B2 RESAMPLE Worsley-PET test - Load Resampled Worsley Image - (No-label)"
    set newWorsleyId [b2 load image $results_dir/$experiment_dir/test_IMA.raw data-type= float-single]
    ReportTestStatus $LogFile  [ expr {$TestImageId != -1 } ] $ModuleName $SubTestDes

    set SubTestDes "OLD COUNT B2 RESAMPLE Worsley-PET test - Loaded (No-label) Mask Generation"
    set TestNewMaskId [b2 threshold image $newWorsleyId 5000]
    ...
    set diffMask [ b2 xor masks $TestNewMaskId $TestMaskId]
    ...
    set newWorsleyId [b2 load image $pathToRegressionDir/SGI/pet_images/worsley-test/TEST/images/WORS_ANON00022_PET_HF_18_IMA_1.raw data-type= float-single]
    ReportTestStatus $LogFile  [ expr {$TestImageId != -1 } ] $ModuleName $SubTestDes
    ...
    set oldWorsleyId [b2 load image $pathToRegressionDir/SGI/pet_images/worsley-test/TEST/images/WORS_ANON00022_HF_18_IMA_1.raw data-type= float-single]
    ...
    set TestNewMaskId [b2 threshold image $oldWorsleyId 5000]
    ReportTestStatus $LogFile  [ expr {$TestNewMaskId != -1 } ] $ModuleName $SubTestDes
    ...
    b2 destroy mask $diffMask
    b2 destroy mask $TestNewMaskId
    b2 destroy image $oldWorsleyId

    b2 destroy mask $TestMaskId
...
#    set expect 1454.959468
    ...
    set saveResult [b2 save image $results_dir/$experiment_dir/test_IMF.raw pic/raw $TestImageId data-type= signed-16bit plane= Axial]
    ReportTestStatus $LogFile  [ expr {$saveResult != -1 } ] $ModuleName $SubTestDes

    set SubTestDes "OLD FLOW B2 RESAMPLE Worsley-PET test - Save Resampled Worsley Image (PET-Label)"
    set saveResult [b2 save image $results_dir/$experiment_dir/test_PET_IMF.raw pic/raw $TestImageId data-type= signed-16bit plane= Axial]
    ReportTestStatus $LogFile  [ expr {$saveResult != -1 } ] $ModuleName $SubTestDes


    set SubTestDes "OLD FLOW B2 RESAMPLE Worsley-PET test - Load Resampled Worsley Image - (No-label)"
    set newWorsleyId [b2 load image $results_dir/$experiment_dir/test_IMF.raw data-type= float-single]
    ReportTestStatus $LogFile  [ expr {$TestImageId != -1 } ] $ModuleName $SubTestDes
    ...
    set newWorsleyId [b2 load image $results_dir/$experiment_dir/test_PET_IMF.raw data-type= float-single]
    ReportTestStatus $LogFile  [ expr {$TestImageId != -1 } ] $ModuleName $SubTestDes

    set SubTestDes "OLD FLOW B2 RESAMPLE Worsley-PET test - Loaded(labeled) Mask Generation"
    set TestNewMaskId [b2 threshold image $newWorsleyId 15.0]
    ReportTestStatus $LogFile  [ expr {$TestNewMaskId != -1 } ] $ModuleName $SubTestDes
    ...
    set newWorsleyId [b2 load image $pathToRegressionDir/SGI/pet_images/worsley-test/TEST/images/WORS_ANON00022_PET_HF_18_IMF_1.raw data-type= float-single]
    ReportTestStatus $LogFile  [ expr {$TestImageId != -1 } ] $ModuleName $SubTestDes
    ...
    set oldWorsleyId [b2 load image $pathToRegressionDir/SGI/pet_images/worsley-test/TEST/images/WORS_ANON00022_HF_18_IMF_1.raw data-type= float-single]
    ReportTestStatus $LogFile  [ expr {$oldWorsleyId != -1 } ] $ModuleName $SubTestDes
    ...
    set TestMaskId [b2 threshold image $TestImageId 500]
    ReportTestStatus $LogFile  [ expr {$TestImageId != -1 } ] $ModuleName $SubTestDes
...
#    set expect 1336.234851
    ...
    set TestMaskId [b2 threshold image $TestImageId 35]
    ReportTestStatus $LogFile  [ expr {$TestImageId != -1 } ] $ModuleName $SubTestDes
...
#    set expect 977.951612
    ...
    b2 destroy image $PetFlowImageId
    b2 destroy image $PetCountImageId
    b2 destroy transform $PetFlowXfrmId
    b2 destroy transform $PetCountXfrmId
    b2 destroy talairach-parameters $TalairachId
