...
########################################
    ...
    set errorTest [b2 load GTSurface]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

    set SubTestDes "arguement number test"
    set errorTest [b2 load GTSurface $pathToRegressionDir/SGI/MR/4x-B1/TEST/10_ACPC/ANON013_l_dec35.surf junk= ]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

    set SubTestDes "optional arguement test"
    set errorTest [b2 load GTSurface $pathToRegressionDir/SGI/MR/4x-B1/TEST/10_ACPC/ANON013_l_dec35.surf junk= test]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

    set SubTestDes "invalid file test"
    set errorTest [b2 load GTSurface /invalid_directory_name/ANON013_l_dec35.surf]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes
...
if {0==1} {
    ...
    set TestSurfaceId [b2 load GTSurface $pathToRegressionDir/SGI/MR/4x-B1/TEST/10_ACPC/ANON013_l_dec35.surf]
    ...
    set TestSurfaceId [b2 load GTSurface $pathToRegressionDir/SGI/MR/B2-Surf/TEST/05_ACPC/ANON0021_130_l_dec35.srf]
    if { [ ReportTestStatus $LogFile  [ expr {$TestSurfaceId != -1 } ] $ModuleName $SubTestDes] } {
        # Run Tests Here on the Data
        ReportTestStatus $LogFile  [ expr { [ b2 destroy GTSurface $TestSurfaceId ] != -1 } ] $ModuleName "Destroying GTSurface $TestSurfaceId"
    }
    ...
    set TestSurfaceId [b2 load GTSurface $pathToRegressionDir/SGI/MR/B2-Surf/TEST/05_ACPC/ANON0021_130_l_dec35.srf filter= brains2]
    if { [ ReportTestStatus $LogFile  [ expr {$TestSurfaceId != -1 } ] $ModuleName $SubTestDes] } {
        # Run Tests Here on the Data
        ReportTestStatus $LogFile  [ expr { [ b2 destroy GTSurface $TestSurfaceId ] != -1 } ] $ModuleName "Destroying GTSurface $TestSurfaceId"
    }
    ...
    ############################### BRAINS2 Surface Filter ######################################
    set SubTestDes "GTS Surface with Filter Load test"
    set TestSurfaceId [b2 load GTSurface $pathToRegressionDir/SGI/MR/Surface-Gen/TEST/10_ACPC/ANON0008_l_dec.gts filter= GTS]
    if { [ ReportTestStatus $LogFile  [ expr {$TestSurfaceId != -1 } ] $ModuleName $SubTestDes] } {
        # Run Tests Here on the Data
        ReportTestStatus $LogFile  [ expr { [ b2 destroy GTSurface $TestSurfaceId ] != -1 } ] $ModuleName "Destroying GTSurface $TestSurfaceId"
    }
