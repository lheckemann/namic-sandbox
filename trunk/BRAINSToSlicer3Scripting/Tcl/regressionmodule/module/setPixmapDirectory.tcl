...
# \brief    This module tests the brains2 command "b2 set pixmap-directory"
...
# Test Performed
# -----------------------------------------------------------------------
# Tests the brains2 command "b2 set pixmap-directory"
#
# To Do
#------------------------------------------------------------------------
# Nothing
...
proc setPixmapDirectory {pathToRegressionDir dateString} {
    ...
    set ModuleDescription "Test the b2 set pixmap-directory command";
...
# First Test for invalid arguements
        ...
        set errorTest [b2 set pixmap-directory];
        ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes;

        set SubTestDes "Set Pixmap Directory Test";
        set TestResult [b2 set pixmap-directory $OUTPUT_DIR ];
