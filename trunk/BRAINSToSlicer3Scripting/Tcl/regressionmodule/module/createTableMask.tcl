...
# Test Performed
# -----------------------------------------------------------------------
# Test the b2 create table-mask command
#
# To Do
#------------------------------------------------------------------------
# Nothing
...
proc createTableMask {pathToRegressionDir dateString} {
    ...
    set ModuleDescription "Test the b2 create table-mask"
...
########################################
    ...
    set errorTest [b2 create table-mask]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

    set SubTestDes "arguement number test (2)"
    set errorTest [b2 create table-mask 2 ]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

    set SubTestDes "arguement number test (3)"
    set errorTest [b2 create table-mask 2 3]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

    set SubTestDes "optional arguement test"
    set errorTest [b2 create table-mask 2 3 {{0 0} {1 1}} junk=]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

    set SubTestDes "invalid otional arguement test"
    set errorTest [b2 create table-mask 2 3 {{0 0} {1 1}} junk= test]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes
    ...
    set TestTableId [b2 create table-mask 2 3 {{0 0} {1 1}} ]
    ...
    set TestTableId [b2 create table-mask 10 1 {{0 0} {1 0} {9 0}} ]
    set MaskTableId [b2 create table-mask 10 1 {{0 0} {9 0}} ]

    # First Test for invalid arguements
    set SubTestDes "B2 CREATE EVENT-TABLE required arguement test (1)"
    set errorTest [b2 create event-table]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

    set SubTestDes "B2 CREATE EVENT-TABLE arguement number test (2)"
    set errorTest [b2 create event-table $TestTableId ]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

    set SubTestDes "B2 CREATE EVENT-TABLE optional arguement test"
    set errorTest [b2 create event-table $TestTableId $MaskTableId junk=]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

    set SubTestDes "B2 CREATE EVENT-TABLE invalid optional arguement test"
    set errorTest [b2 create event-table $TestTableId $MaskTableId junk= test]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

    set tableData [b2 get table data $TestTableId]
    puts $tableData

    set tableData [b2 get table data $MaskTableId]
    puts $tableData

    set SubTestDes "B2 CREATE EVENT-TABLE test"
    set eventTableId [b2 create event-table $TestTableId $MaskTableId ]
    if { [ ReportTestStatus $LogFile  [ expr {$eventTableId != -1 } ] $ModuleName $SubTestDes] } {
        set tableData [b2 get table data $eventTableId]
        puts $tableData
        for {set i 0} {$i < [llength $tableData]} {incr i} {
           for {set j 0} {$j < [llength [lindex $tableData $i]]} {incr j} {
    ...
    ReportTestStatus $LogFile  [ expr { [ b2 destroy table $TestTableId ] != -1 } ] $ModuleName "Destroying table $TestTableId"
    ReportTestStatus $LogFile  [ expr { [ b2 destroy table $MaskTableId ] != -1 } ] $ModuleName "Destroying table $MaskTableId"
    ReportTestStatus $LogFile  [ expr { [ b2 destroy table $eventTableId   ] != -1 } ] $ModuleName "Destroying table $eventTableId  "
