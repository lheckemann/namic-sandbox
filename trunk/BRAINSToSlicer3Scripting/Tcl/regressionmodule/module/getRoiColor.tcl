...
# \brief    This module tests the b2 get roi color command
...
# Test Performed
# -----------------------------------------------------------------------
# Test the b2 get roi color command
#
# To Do
#------------------------------------------------------------------------
...
proc getRoiColor {pathToRegressionDir dateString} {
    ...
    set ModuleDescription "Test the b2 get roi color command"
...
########################################
    ...
    set TestRoiID [b2 load roi $pathToRegressionDir/SGI/MR/4x-B1/TEST/10_ACPC/user/96tricia_rcaud.zroi]
    ...
    set errorTest [b2 get roi color]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

    set SubTestDes "argument number test"
    set errorTest [b2 get roi color $TestRoiID junk= ]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

    set SubTestDes "optional argument test"
    set errorTest [b2 get roi color $TestRoiID junk= test]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

    set SubTestDes "invalid roi test"
    set errorTest [b2 get roi color -1]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes


    set SubTestDes "Get roi color test"
    set errorTest [b2 get roi color $TestRoiID]
