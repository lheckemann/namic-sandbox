...
# \brief    This module tests the "b2 threshold image"
...
proc thresholdImage {pathToRegressionDir dateString} {
    ...
    set ModuleDescription "Test the b2 threshold image command"
...
########################################
    ...
    set errorTest [b2 threshold image]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

    set SubTestDes "required arguement test (2)"
    set errorTest [b2 threshold image $ImageId]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

    set SubTestDes "arguement number test"
    set errorTest [b2 threshold image $ImageId 100 junk= ]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

    set SubTestDes "optional arguement test"
    set errorTest [b2 threshold image $ImageId 100 junk= test]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

    set SubTestDes "invalid image test"
    set errorTest [b2 threshold image 65536 100]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes


    ############################ BRAINS2 Threshold Image ########################################
    set SubTestDes "B2 THRESHOLD IMAGE test - >=50"
    set TestMaskId [b2 threshold image $ImageId 50]
    ...
    set SubTestDes "B2 THRESHOLD IMAGE test - >50"
    set TestMaskId [b2 threshold image $ImageId 50 UseOpenInterval= True]
    ReportTestStatus $LogFile  [ expr {$TestMaskId != -1 } ] $ModuleName $SubTestDes
    ...
    set TestMaskId [b2 threshold image $ImageId 100]
    ReportTestStatus $LogFile  [ expr {$TestMaskId != -1 } ] $ModuleName $SubTestDes
    ...
    set TestMaskId [b2 threshold image $ImageId 50 UpperThreshold= 100 UseOpenInterval= True]
    ReportTestStatus $LogFile  [ expr {$TestMaskId != -1 } ] $ModuleName $SubTestDes
    ...
    set TestMaskId [b2 threshold image $ImageId 150]
    ReportTestStatus $LogFile  [ expr {$TestMaskId != -1 } ] $ModuleName $SubTestDes
    ...
    set TestMaskId [b2 threshold image $ImageId 50 UpperThreshold= 150]
    ReportTestStatus $LogFile  [ expr {$TestMaskId != -1 } ] $ModuleName $SubTestDes
    ...
    set b2cmd [format "b2 subtract from constant 50.0 {%s} data-type= float-single" $ImageId ]
    ...
    set TestMaskId [b2 threshold image $TestImageId 50 absolute-value= True]
    ReportTestStatus $LogFile  [ expr {$TestMaskId != -1 } ] $ModuleName $SubTestDes
