...
int main( int argc, char *argv[] )
{
  ...
  optimizer->SetLearningRate( 2e-3 );
  ...
  std::cout << " final parameters 1 = " << finalParameters[1]  << std::endl;
  ...
  transformArray[1]->SetParameters( currentParameters2 );
  //bsplineTransformHigh[1]->SetBulkTransform( transformArray[1] );
  resample2->SetTransform( transformArray[0] );
