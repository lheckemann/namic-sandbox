...
=========================================================================*/
#ifndef __JointEntropyKNNFixedMultiImageMetric_h
#define __JointEntropyKNNFixedMultiImageMetric_h
...
class ITK_EXPORT JointEntropyKNNFixedMultiImageMetric :
    public JointEntropyKNNMultiImageMetric< TFixedImage>
{
public:

  /** Standard class typedefs. */
  typedef JointEntropyKNNFixedMultiImageMetric  Self;
  typedef JointEntropyKNNMultiImageMetric< TFixedImage > Superclass;
  ...
  itkTypeMacro(JointEntropyKNNFixedMultiImageMetric, JointEntropyKNNMultiImageMetric);
...
protected:
  ...
  virtual ~JointEntropyKNNFixedMultiImageMetric();
  ...
  mutable std::vector< std::vector< Array<double> > > probMatrix;
  mutable std::vector< double > marginalProb;
private:
  JointEntropyKNNFixedMultiImageMetric(const Self&); //purposely not implemented
...
#include "JointEntropyKNNFixedMultiImageMetric.cxx"
#endif
