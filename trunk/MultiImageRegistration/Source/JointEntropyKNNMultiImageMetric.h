...
=========================================================================*/
#ifndef __JointEntropyKNNMultiImageMetric_h
#define __JointEntropyKNNMultiImageMetric_h
...
class ITK_EXPORT JointEntropyKNNMultiImageMetric :
    public ParzenWindowEntropyMultiImageMetric< TFixedImage>
{
public:

  /** Standard class typedefs. */
  typedef JointEntropyKNNMultiImageMetric  Self;
  ...
  itkTypeMacro(JointEntropyKNNMultiImageMetric, ParzenWindowEntropyMultiImageMetric);
...
protected:
  ...
  virtual ~JointEntropyKNNMultiImageMetric();
...
#include "JointEntropyKNNMultiImageMetric.cxx"
#endif
