...
=========================================================================*/
#ifndef __FixedTemplateVarianceMultiImageMetric_h
#define __FixedTemplateVarianceMultiImageMetric_h
...
namespace itk
{
/** \class FixedTemplateVarianceMultiImageMetric
...
class ITK_EXPORT FixedTemplateVarianceMultiImageMetric :
    public UnivariateEntropyMultiImageMetric< TImage>
{
public:

  /** Standard class typedefs. */
  typedef FixedTemplateVarianceMultiImageMetric                    Self;
  ...
  itkTypeMacro(FixedTemplateVarianceMultiImageMetric, UnivariateEntropyMultiImageMetric);
  ...
  /** Set/Get the index of the fixed template. */
  itkSetMacro( FixedTemplateIndex, unsigned int);
  itkGetMacro( FixedTemplateIndex, unsigned int);
...
protected:
  ...
  virtual ~FixedTemplateVarianceMultiImageMetric() {};
...
private:
  FixedTemplateVarianceMultiImageMetric(const Self&); //purposely not implemented
  void operator=(const Self&); //purposely not implemented
  
  unsigned int m_FixedTemplateIndex;
...
#include "FixedTemplateVarianceMultiImageMetric.txx"
#endif
