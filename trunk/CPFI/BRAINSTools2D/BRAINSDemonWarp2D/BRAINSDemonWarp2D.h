#ifndef _BRAINSDemonWarp2D_h
#define _BRAINSDemonWarp2D_h

#include <string>
#include "Demons2DPreprocessor.h"
#include "Demons2DRegistrator.h"
...
template< typename TImage,
          ...
          >
class BRAINSDemonWarp2D:public ApplicationBase<
    ValidationInputParser< TImage >,
    Demons2DPreprocessor< TImage, TRealImage >,
    Demons2DRegistrator< TRealImage, TOutputImage,
...
public:
  ...
  typedef BRAINSDemonWarp2D Self;
  typedef ApplicationBase< ValidationInputParser< TImage >,
                           Demons2DPreprocessor< TImage, TRealImage >,
                           Demons2DRegistrator< TRealImage, TRealImage,
                                              ITK_TYPENAME TRealImage::PixelType >
                           > Superclass;
  ...
  typedef Vector< FieldValueType, 2 > FieldPixelType;
  typedef Image< FieldPixelType, 2 >  TDeformationField;

  /** Run-time type information (and related methods). */
  itkTypeMacro (BRAINSDemonWarp2D, ApplicationBase);
