#ifndef __BRAINSDemonWarp2DTemplates_h
#define __BRAINSDemonWarp2DTemplates_h
...
#include "BRAINSDemonWarp2DCommonLibWin32Header.h"
#include "GenericTransformImage2D.h"
#include "VBRAINSDemonWarp2D.h"
#include "BRAINSDemonWarp2D.h"
...
BRAINSDemonWarp2DCommonLib_EXPORT extern DebugImageViewerClient DebugImageDisplaySender;
#endif
...
BRAINSDemonWarp2DCommonLib_EXPORT extern void PrintDataTypeStrings(void);

BRAINSDemonWarp2DCommonLib_EXPORT extern int CompareNoCase(const std::string & s, const std::string & s2);

BRAINSDemonWarp2DCommonLib_EXPORT extern int BRAINSResamplePrimary(int argc, char *argv[]);
BRAINSDemonWarp2DCommonLib_EXPORT extern void ProcessOutputType_uchar(struct BRAINSDemonWarp2DAppParameters & command);

BRAINSDemonWarp2DCommonLib_EXPORT extern void ProcessOutputType_short(struct BRAINSDemonWarp2DAppParameters & command);

BRAINSDemonWarp2DCommonLib_EXPORT extern void ProcessOutputType_ushort(struct BRAINSDemonWarp2DAppParameters & command);

BRAINSDemonWarp2DCommonLib_EXPORT extern void ProcessOutputType_int(struct BRAINSDemonWarp2DAppParameters & command);

BRAINSDemonWarp2DCommonLib_EXPORT extern void ProcessOutputType_uint(struct BRAINSDemonWarp2DAppParameters & command);

BRAINSDemonWarp2DCommonLib_EXPORT extern void ProcessOutputType_float(struct BRAINSDemonWarp2DAppParameters & command);

BRAINSDemonWarp2DCommonLib_EXPORT extern void ProcessOutputType_double(struct BRAINSDemonWarp2DAppParameters & command);

BRAINSDemonWarp2DCommonLib_EXPORT extern void VectorProcessOutputType_uchar(struct BRAINSDemonWarp2DAppParameters & command);

BRAINSDemonWarp2DCommonLib_EXPORT extern void VectorProcessOutputType_short(struct BRAINSDemonWarp2DAppParameters & command);

BRAINSDemonWarp2DCommonLib_EXPORT extern void VectorProcessOutputType_ushort(
  struct BRAINSDemonWarp2DAppParameters & command);

BRAINSDemonWarp2DCommonLib_EXPORT extern void VectorProcessOutputType_int(struct BRAINSDemonWarp2DAppParameters & command);

BRAINSDemonWarp2DCommonLib_EXPORT extern void VectorProcessOutputType_uint(struct BRAINSDemonWarp2DAppParameters & command);

BRAINSDemonWarp2DCommonLib_EXPORT extern void VectorProcessOutputType_float(struct BRAINSDemonWarp2DAppParameters & command);

BRAINSDemonWarp2DCommonLib_EXPORT extern void VectorProcessOutputType_double(
  struct BRAINSDemonWarp2DAppParameters & command);

struct BRAINSDemonWarp2DAppParameters {
  ...
  itk::Index< 2 > checkerboardPatternSubdivisions;
  ...
  itk::Index< 2 > seedForBOBF;
  itk::Index< 2 > neighborhoodForBOBF;
  itk::Size< 2 > medianFilterSize;
  /*/Not yet implemented
  ...
  /** ShrinkFactors type. */
  typedef itk::FixedArray< unsigned int, 2 > ShrinkFactorsType;
...
void ThirionFunction(const struct BRAINSDemonWarp2DAppParameters & command)
{
  const int dims = 2;
  ...
  typedef itk::SpatialObject< GenericTransformImage2DNS::SpaceDimension > SpatialObjectType;
  ...
  typedef typename itk::BRAINSDemonWarp2D
  < ImageType,
    TRealImage,
    OutputImageType
  > AppType;
  ...
  typename CommandIterationUpdate< float, 2 >::Pointer observer;
  if ( command.outputDebug )
    {
    observer = CommandIterationUpdate< float, 2 >::New();
    }
...
// parameters.
template< class InPixelType, class OutPixelType >
void ProcessAppType(const struct BRAINSDemonWarp2DAppParameters & command)
{
...
void
ProcessOutputType(struct BRAINSDemonWarp2DAppParameters & command)
{
...
template< class InPixelType, class OutPixelType >
void VectorThirionFunction(const struct BRAINSDemonWarp2DAppParameters & command)
{
  const int dims = 2;
  ...
  typedef typename itk::VBRAINSDemonWarp2D
  < ImageType,
    TRealImage,
    OutputImageType
  > AppType;
    ...
    if ( command.vectorMovingVolume.size() == 1 )
      ...
      if ( command.outputDebug )
        ...
        typename VCommandIterationUpdate< float,
                                          2 >::Pointer observer =
          VCommandIterationUpdate< float, 2 >::New();
...
// parameters.
template< class InPixelType, class OutPixelType >
void VectorProcessAppType(const struct BRAINSDemonWarp2DAppParameters & command)
{
...
template< class PixelType >
void
VectorProcssOutputType(struct BRAINSDemonWarp2DAppParameters & command)
{
  if ( command.outputPixelType != "" )
    {
    // process the string for the data type
...
template< class PixelType >
void
VectorProcessOutputType(struct BRAINSDemonWarp2DAppParameters & command)
{
  if ( command.outputPixelType != "" )
    {
    // process the string for the data type
...
#endif // __BRAINSDemonWarp2DTemplates_h
