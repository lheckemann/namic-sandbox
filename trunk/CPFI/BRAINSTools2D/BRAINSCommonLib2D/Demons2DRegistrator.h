#ifndef __Demons2DRegistrator_h
#define __Demons2DRegistrator_h
...
template<
  ...
  >
class Demons2DRegistrator:public Object
{
public:

  /** Standard class typedefs. */
  typedef Demons2DRegistrator          Self;
  typedef Object                     Superclass;
  typedef SmartPointer< Self >       Pointer;
  typedef SmartPointer< const Self > ConstPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro(Demons2DRegistrator, Object);
...
protected:
  ...
  ~Demons2DRegistrator();
private:
  Demons2DRegistrator(const Self &);                // purposely not implemented
...
#  include "Demons2DRegistrator.txx"
#endif
