#ifndef  __BRAINSFit2DHelper_h
#define  __BRAINSFit2DHelper_h
...
#include "BRAINSFit2DBSpline.h"
#include "BRAINSFit2DUtils.h"
...
BRAINSCommonLib2D_EXPORT extern void
...
class BRAINSCommonLib2D_EXPORT BRAINSFit2DHelper:public Object
{
public:
  /** Standard class typedefs. */
  typedef BRAINSFit2DHelper            Self;
  typedef ProcessObject              Superclass;
  typedef SmartPointer< Self >       Pointer;
  typedef SmartPointer< const Self > ConstPointer;

  typedef float                         PixelType;
  typedef itk::Image< PixelType, 2 >    FixedVolumeType;
  typedef FixedVolumeType::ConstPointer FixedImageConstPointer;
  typedef FixedVolumeType::Pointer      FixedImagePointer;

  typedef itk::Image< PixelType, 2 >     MovingVolumeType;
  ...
  itkTypeMacro(BRAINSFit2DHelper, ProcessObject);
...
private:
  ...
  BRAINSFit2DHelper(const Self &); // purposely not implemented
...
SetupRegistration()
{
  ...
  typedef typename itk::BRAINSFit2DHelperTemplate<FixedImageType,MovingImageType> HelperType;
  ...
  typename HelperType::Pointer
    myHelper = BRAINSFit2DHelperTemplate<FixedImageType,MovingImageType>::New();
...
RunRegistration()
{
  typedef typename TLocalCostMetric::FixedImageType FixedImageType;
  typedef typename TLocalCostMetric::MovingImageType MovingImageType;
  typedef typename itk::BRAINSFit2DHelperTemplate<FixedImageType,MovingImageType>
    HelperType;
