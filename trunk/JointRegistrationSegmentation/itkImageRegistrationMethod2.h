...
=========================================================================*/
#ifndef __itkImageRegistrationMethod2_h
#define __itkImageRegistrationMethod2_h
...
class ITK_EXPORT ImageRegistrationMethod2 : public ProcessObject 
{
public:
  /** Standard class typedefs. */
  typedef ImageRegistrationMethod2  Self;
  ...
  itkTypeMacro(ImageRegistrationMethod2, ProcessObject);
  ...
  /**  Type of the metric. */
  typedef ImageToImageMetric2< FixedImageType,
...
protected:
  ...
  virtual ~ImageRegistrationMethod2() {};
...
private:
  ImageRegistrationMethod2(const Self&); //purposely not implemented
...
#include "itkImageRegistrationMethod2.txx"
#endif
