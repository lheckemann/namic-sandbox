/*=========================================================================
  ...
  Module:    $RCSfile: itkRegularSphereMeshSourceButterflyScheme.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkRegularSphereMeshSourceButterflyScheme_h
#define __itkRegularSphereMeshSourceButterflyScheme_h
...
class RegularSphereMeshSourceButterflyScheme : public MeshSource<TOutputMesh>
{
public:
  /** Standard "Self" typedef. */
  typedef RegularSphereMeshSourceButterflyScheme         Self;
  ...
  itkTypeMacro(RegularSphereMeshSourceButterflyScheme, MeshSource);
...
protected:
  RegularSphereMeshSourceButterflyScheme();
  ~RegularSphereMeshSourceButterflyScheme() {}
...
private:
  RegularSphereMeshSourceButterflyScheme(const Self&); //purposely not implemented
