/*=========================================================================
  ...
  Module:    $RCSfile: itkMattesNoCachingMutualInformationImageToImageMetric.h,v $
  Language:  C++
  Date:      $Date: 2007/11/14 18:55:17 $
...
=========================================================================*/
#ifndef __itkMattesNoCachingMutualInformationImageToImageMetric_h
#define __itkMattesNoCachingMutualInformationImageToImageMetric_h
...
#include "itkOptMattesNoCachingMutualInformationImageToImageMetric.h"
#else
...
/** \class MattesNoCachingMutualInformationImageToImageMetric
 * \brief Computes the mutual information between two images to be 
 * registered using the method of Mattes et al.
 *
 * MattesNoCachingMutualInformationImageToImageMetric computes the mutual 
...
class ITK_EXPORT MattesNoCachingMutualInformationImageToImageMetric :
    public ImageToImageMetric< TFixedImage, TMovingImage >
{
public:

  /** Standard class typedefs. */
  typedef MattesNoCachingMutualInformationImageToImageMetric  Self;
  ...
  itkTypeMacro(MattesNoCachingMutualInformationImageToImageMetric, ImageToImageMetric);
...
protected:
  ...
  virtual ~MattesNoCachingMutualInformationImageToImageMetric() {};
...
private:
  ...
  MattesNoCachingMutualInformationImageToImageMetric(const Self&); 
  //purposely not implemented
...
#include "itkMattesNoCachingMutualInformationImageToImageMetric.txx"
#endif
