...
typedef itk::DefaultDynamicMeshTraits< float , 3, 3, double > MeshTrait;
typedef itk::Mesh<float, 3, MeshTrait > MeshType;
typedef SphericalHarmonicSpatialObject::MeshType MeshType;
class SphericalHarmonicMeshSource : public itk::MeshSource<MeshType> //default dimension for mesh is 3
{
public:
