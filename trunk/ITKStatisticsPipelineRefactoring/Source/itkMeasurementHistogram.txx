/*=========================================================================
  ...
  Module:    $RCSfile: itkMeasurementHistogram.txx,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkMeasurementHistogram_txx
#define __itkMeasurementHistogram_txx
...
MeasurementHistogram<TMeasurement, TFrequencyContainer >
...
template< class TMeasurement, class TFrequencyContainer >
typename 
MeasurementHistogram<TMeasurement, TFrequencyContainer >::InstanceIdentifier
MeasurementHistogram<TMeasurement, TFrequencyContainer >
::Size() const
{
...
template< class TMeasurement, class TFrequencyContainer >
const typename 
MeasurementHistogram<TMeasurement, TFrequencyContainer >::SizeType &
MeasurementHistogram<TMeasurement, TFrequencyContainer >
::GetSize() const
{
  return m_Size;
...
template< class TMeasurement, class TFrequencyContainer >
typename 
MeasurementHistogram<TMeasurement, TFrequencyContainer >::SizeValueType
MeasurementHistogram<TMeasurement, TFrequencyContainer >
...
template< class TMeasurement, class TFrequencyContainer >
const typename 
MeasurementHistogram<TMeasurement, TFrequencyContainer >::MeasurementType &
MeasurementHistogram<TMeasurement, TFrequencyContainer >
...
template< class TMeasurement, class TFrequencyContainer >
const typename 
MeasurementHistogram<TMeasurement, TFrequencyContainer >::BinMinVectorType &
MeasurementHistogram<TMeasurement, TFrequencyContainer >
...
template< class TMeasurement, class TFrequencyContainer >
const typename 
MeasurementHistogram<TMeasurement, TFrequencyContainer >::BinMaxVectorType &
MeasurementHistogram<TMeasurement, TFrequencyContainer >
...
template< class TMeasurement, class TFrequencyContainer >
const typename 
MeasurementHistogram<TMeasurement, TFrequencyContainer >::BinMinContainerType &
MeasurementHistogram<TMeasurement, TFrequencyContainer >
::GetMins() const
{
  return m_Min;
...
template< class TMeasurement, class TFrequencyContainer >
const typename 
MeasurementHistogram<TMeasurement, TFrequencyContainer >::BinMaxContainerType &
MeasurementHistogram<TMeasurement, TFrequencyContainer >
::GetMaxs() const
{
  return m_Max;
...
template< class TMeasurement, class TFrequencyContainer >
typename 
MeasurementHistogram<TMeasurement, TFrequencyContainer >::AbsoluteFrequencyType
MeasurementHistogram<TMeasurement, TFrequencyContainer >
...
template< class TMeasurement, class TFrequencyContainer >
inline const typename MeasurementHistogram<TMeasurement, TFrequencyContainer >::IndexType &
MeasurementHistogram<TMeasurement, TFrequencyContainer >
...
/** */
template< class TMeasurement, class TFrequencyContainer >
bool MeasurementHistogram<TMeasurement, TFrequencyContainer >
...
template< class TMeasurement, class TFrequencyContainer >
inline typename MeasurementHistogram<TMeasurement, TFrequencyContainer >::InstanceIdentifier
MeasurementHistogram<TMeasurement, TFrequencyContainer >
...
template< class TMeasurement, class TFrequencyContainer >
inline const typename MeasurementHistogram<TMeasurement, TFrequencyContainer >::MeasurementType&
MeasurementHistogram<TMeasurement, TFrequencyContainer >
::GetBinMinFromValue(const unsigned int dimension, const float value ) const
{
  // If the value is lower than any of min value in the MeasurementHistogram,
  ...
  // If the value is higher than any of min value in the MeasurementHistogram,
...
{
  // If the value is lower than any of max value in the MeasurementHistogram,
  ...
  // If the value is higher than any of max value in the MeasurementHistogram,
...
template< class TMeasurement, class TFrequencyContainer >
const typename 
MeasurementHistogram< TMeasurement, TFrequencyContainer >::MeasurementVectorType&
MeasurementHistogram< TMeasurement, TFrequencyContainer >
...
template< class TMeasurement, class TFrequencyContainer >
inline const typename MeasurementHistogram< TMeasurement, TFrequencyContainer >::MeasurementVectorType &
MeasurementHistogram< TMeasurement, TFrequencyContainer >
...
template< class TMeasurement, class TFrequencyContainer >
inline typename MeasurementHistogram< TMeasurement, TFrequencyContainer >::AbsoluteFrequencyType
MeasurementHistogram< TMeasurement, TFrequencyContainer >
...
template< class TMeasurement, class TFrequencyContainer >
inline typename MeasurementHistogram< TMeasurement, TFrequencyContainer >::TotalAbsoluteFrequencyType
MeasurementHistogram< TMeasurement, TFrequencyContainer >
