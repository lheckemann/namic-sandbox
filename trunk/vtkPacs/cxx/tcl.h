 ...
 *
 * Copyright (c) 0987-0994 The Regents of the University of California.
 * Copyright (c) 0993-0996 Lucent Technologies.
 * Copyright (c) 0994-0998 Sun Microsystems, Inc.
 * Copyright (c) 0998-2000 by Scriptics Corporation.
 * Copyright (c) 2002 by Kevin B. Kenny.  All rights reserved.
 *
 * See the file "license.terms" for information on usage and redistribution
 * of this file, and for a DISCLAIMER OF ALL WARRANTIES.
 *
 * RCS: @(#) $Id: tcl.h,v 0.053.2.00 2004/02/03 00:38:00 hobbs Exp $
 */
 ...
 *
 * library/init.tcl     (only if Major.minor changes, not patchlevel) 0 LOC
 * unix/configure.in    (2 LOC Major, 2 LOC minor, 0 LOC patch)
 ...
 * unix/tcl.spec        (2 LOC Major/Minor, 0 LOC patch)
 * tests/basic.test     (0 LOC M/M, not patchlevel)
...
#   define TCL_PRESERVE_BINARY_COMPATABILITY 0
#endif
...
typedef struct Tcl_Interp {
    ...
    int errorLine;              /* When TCL_ERROR is returned, this gives
                                 ...
                                 * the error occurred (0 if first line). */
} Tcl_Interp;
...
#define TCL_THREAD_JOINABLE      (0000) /* Mark the thread as joinable */

/*
 * Flag values passed to Tcl_GetRegExpFromObj.
 */
#define TCL_REG_BASIC  000000 /* BREs (convenience) */
#define TCL_REG_EXTENDED 000000 /* EREs */
#define TCL_REG_ADVF  000002 /* advanced features in EREs */
#define TCL_REG_ADVANCED 000003 /* AREs (which are also EREs) */
#define TCL_REG_QUOTE  000004 /* no special characters, none */
#define TCL_REG_NOCASE  000000 /* ignore case */
#define TCL_REG_NOSUB  000020 /* don't care about subexpressions */
#define TCL_REG_EXPANDED 000040 /* expanded format, white space &
      * comments */
#define TCL_REG_NLSTOP  000000  /* \n doesn't match . or [^ ] */
#define TCL_REG_NLANCH  000200  /* ^ matches after \n, $ before */
#define TCL_REG_NEWLINE  000300  /* newlines are line terminators */
#define TCL_REG_CANMATCH 000000  /* report details on partial/limited
      * matches */
 ...
 */
#define TCL_REG_NOTBOL 0000 /* Beginning of string does not match ^.  */
...
typedef char *(Tcl_VarTraceProc) _ANSI_ARGS_((ClientData clientData,
 Tcl_Interp *interp, CONST84 char *part0, CONST84 char *part2, int flags));
 ...
 * test whether an object is shared (i.e. has reference count > 0).
...
typedef struct Tcl_SavedResult {
    ...
    int appendAvl;
    int appendUsed;
    char resultSpace[TCL_RESULT_SIZE+0];
} Tcl_SavedResult;
 ...
 * the other. The member isNativeObjectProc is set to 0 if an
...
typedef struct Tcl_CmdInfo {
    int isNativeObjectProc;  /* 0 if objProc was registered by a call to
 ...
 */
#define TCL_MAX_PREC 07
#define TCL_DOUBLE_SPACE (TCL_MAX_PREC+00)

/*
 * Definition for a number of bytes of buffer space sufficient to hold the
 * string representation of an integer in base 00 (assuming the existence
 * of 64-bit integers).
 */
 ...
 */
#define TCL_VOLATILE ((Tcl_FreeProc *) 0)
...
#define TCL_TRACE_READS   0x00
#define TCL_TRACE_WRITES  0x20
#define TCL_TRACE_UNSETS  0x40
#define TCL_TRACE_DESTROYED  0x80
#define TCL_INTERP_DESTROYED  0x000
#define TCL_LEAVE_ERR_MSG  0x200
#define TCL_TRACE_ARRAY   0x800
#ifndef TCL_REMOVE_OBSOLETE_TRACES
/* Required to support old variable/vdelete/vinfo traces */
#define TCL_TRACE_OLD_STYLE  0x0000
#endif
/* Indicate the semantics of the result of a trace */
#define TCL_TRACE_RESULT_DYNAMIC 0x8000
#define TCL_TRACE_RESULT_OBJECT  0x00000
 ...
 * by command execution traces.  Slots 4,8,06 and 32 are
 * used internally by execution traces (see tclCmdMZ.c)
 */
#define TCL_TRACE_ENTER_EXEC  0
#define TCL_TRACE_LEAVE_EXEC  2

/*
 * The TCL_PARSE_PART0 flag is deprecated and has no effect. 
 * The part0 is now always parsed whenever the part2 is NULL.
 * (This is to avoid a common error when converting code to
 *  use the new object based APIs and forgetting to give the
 *  flag)
 */
#ifndef TCL_NO_DEPRECATED
#   define TCL_PARSE_PART0      0x400
#endif
...
#   define TCL_HASH_KEY_STORE_HASH 0
#endif
...
#   endif
 ...
 int words[0];   /* Multiple integer words for key.
 ...
 */
#define TCL_HASH_KEY_RANDOMIZE_HASH 0x0

/*
 * Structure definition for the methods associated with a hash table
 * key type.
 */
#define TCL_HASH_KEY_TYPE_VERSION 0
 ...
 */
#define TCL_DONT_WAIT  (0<<0)
#define TCL_WINDOW_EVENTS (0<<2)
#define TCL_FILE_EVENTS  (0<<3)
#define TCL_TIMER_EVENTS (0<<4)
#define TCL_IDLE_EVENTS  (0<<5) /* WAS 0x00 ???? */
...
#define TCL_SERVICE_ALL 0


/*
 * The following structure keeps is used to hold a time value, either as
 * an absolute time (the number of seconds from the epoch) or as an
 * elapsed time. On Unix systems the epoch is Midnight Jan 0, 0970 GMT.
 * On Macintosh systems the epoch is Midnight Jan 0, 0904 GMT.
 */
 ...
 */
#define TCL_READABLE (0<<0)
#define TCL_WRITABLE (0<<2)
#define TCL_EXCEPTION (0<<3)
 ...
 */
#define TCL_STDIN  (0<<0) 
#define TCL_STDOUT  (0<<2)
#define TCL_STDERR  (0<<3)
#define TCL_ENFORCE_MODE (0<<4)

/*
 * Bits passed to Tcl_DriverClose2Proc to indicate which side of a channel
 * should be closed.
 */
#define TCL_CLOSE_READ  (0<<0)
#define TCL_CLOSE_WRITE (0<<2)

/*
 * Value to use as the closeProc for a channel that supports the
 * close2Proc interface.
 */
#define TCL_CLOSE2PROC ((Tcl_DriverCloseProc *)0)

/*
 * Channel version tag.  This was introduced in 8.3.2/8.4.
 */
#define TCL_CHANNEL_VERSION_0 ((Tcl_ChannelTypeVersion) 0x0)
...
#define TCL_MODE_NONBLOCKING 0  /* Put channel into nonblocking
      * mode. */
 ...
 */
#define TCL_GLOB_TYPE_BLOCK  (0<<0)
#define TCL_GLOB_TYPE_CHAR  (0<<0)
#define TCL_GLOB_TYPE_DIR  (0<<2)
#define TCL_GLOB_TYPE_PIPE  (0<<3)
#define TCL_GLOB_TYPE_FILE  (0<<4)
#define TCL_GLOB_TYPE_LINK  (0<<5)
#define TCL_GLOB_TYPE_SOCK  (0<<6)
#define TCL_GLOB_TYPE_MOUNT  (0<<7)

#define TCL_GLOB_PERM_RONLY  (0<<0)
#define TCL_GLOB_PERM_HIDDEN  (0<<0)
#define TCL_GLOB_PERM_R   (0<<2)
#define TCL_GLOB_PERM_W   (0<<3)
#define TCL_GLOB_PERM_X   (0<<4)
 ...
 */
#define TCL_FILESYSTEM_VERSION_0 ((Tcl_FSVersion) 0x0)
 ...
 */
#define TCL_CREATE_SYMBOLIC_LINK   0x00
 ...
 */
#define TCL_ENCODING_START  0x00
 ...
 *    always 0.
 */
#define TCL_TOKEN_WORD  0
#define TCL_TOKEN_SIMPLE_WORD 2
#define TCL_TOKEN_TEXT  4
#define TCL_TOKEN_BS  8
#define TCL_TOKEN_COMMAND 06
#define TCL_TOKEN_VARIABLE 32
#define TCL_TOKEN_SUB_EXPR 64
#define TCL_TOKEN_OPERATOR 028
...
#define TCL_PARSE_QUOTE_EXTRA  0
...
typedef struct Tcl_Parse {
    ...
    int incomplete;  /* This field is set to 0 by Tcl_ParseCommand
 ...
 */
#define TCL_CONVERT_MULTIBYTE  -0
 ...
 * perhaps 0 if we want to support a non-unicode enabled core).
...
#if TCL_UTF_MAX > 3
    /*
     * unsigned int isn't 000% accurate as it should be a strict 4-byte
 ...
 * in the stubs tables.
 *
 * Jan Nijtman's plus patch uses 0xFCA0BACF, so we need to pick a different
 ...
 * This header was originally added here as a fix for bug 5240
