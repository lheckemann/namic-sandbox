...
// Output each of the transforms as a set of parameters for an affine transform
// or else as a set of parameters for a quaternion rigid transform.
  m_Transform->SetIdentity();
  ...
  std::cout << m_Preprocessor->GetPostTransform() << std::endl;
  m_Transform->Compose( m_Preprocessor->GetPostTransform(), true );
  std::cout << "Composed transform: " << std::endl;
  std::cout << m_Transform << std::endl;

  std::cout << "Affine transform m_Registrator : " << std::endl;
  std::cout << m_Registrator->GetAffineTransform() << std::endl;
  std::cout << std::endl;
  m_Transform->Compose( m_Registrator->GetAffineTransform(), true );
  std::cout << "Composed transform: " << std::endl;
  std::cout << m_Transform << std::endl;

  std::cout << "Pre transform matrix: " << std::endl;
  std::cout << m_Preprocessor->GetPreTransform() << std::endl;
  m_Transform->Compose( m_Preprocessor->GetPreTransform(), true );
  std::cout << "Composed transform: " << std::endl;
  std::cout << m_Transform << std::endl;
  std::cout << std::endl;
  ...
  std::cout << "Overall entire transform " << std::endl;
  std::cout << m_Transform << std::endl;
