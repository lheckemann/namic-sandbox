/*=========================================================================
  ...
  Module:    $RCSfile: itkAffineInvariantCurvatureFlowFunction.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkAffineInvariantCurvatureFlowFunction_h_
#define __itkAffineInvariantCurvatureFlowFunction_h_
...
/** \class AffineInvariantCurvatureFlowFunction
 *  
 * \brief
 * This class encapsulate the finite difference equation which drives a
 * AffineInvariantCurvature flow denoising algorithm.
 *
 ...
 *
 * \sa AffineInvariantCurvatureFlowImageFilter
 * \sa ZeroFluxNeumannBoundaryCondition 
 * \ingroup FiniteDifferenceFunctions
*/
template <class TImage>
class ITK_EXPORT AffineInvariantCurvatureFlowFunction :
    public FiniteDifferenceFunction<TImage>
{
public:
  /**  Standard class typedefs. */
  typedef AffineInvariantCurvatureFlowFunction Self;
  ...
  itkTypeMacro( AffineInvariantCurvatureFlowFunction,
...
private:
  AffineInvariantCurvatureFlowFunction(const Self&); //purposely not implemented
...
#include "itkAffineInvariantCurvatureFlowFunction.txx"
#endif
