...
\title{Time Series Database: Efficient Out-of-Core Medical Image Processing}
...
\begin{abstract}
\noindent
This document describes a new ITK class designed to provide efficient, out of core 
