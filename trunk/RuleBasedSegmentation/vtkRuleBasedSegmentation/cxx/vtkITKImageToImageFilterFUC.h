...
#ifndef __vtkITKImageToImageFilterFUC_h
#define __vtkITKImageToImageFilterFUC_h
...
public:
  ...
  static vtkITKImageToImageFilterFUC* New() { return 0; };
...
protected:
  ...
  vtkITKImageToImageFilterFUC ( GenericFilterType* filter )
  {
  ...
  ~vtkITKImageToImageFilterFUC()
  {
  };
  //ETX
  
private:
  vtkITKImageToImageFilterFUC(const vtkITKImageToImageFilterFUC&);  // Not implemented.
  void operator=(const vtkITKImageToImageFilterFUC&);  // Not implemented.
};
