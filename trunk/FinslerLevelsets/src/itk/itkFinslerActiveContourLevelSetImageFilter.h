/*=========================================================================
  ...
  Module:    $RCSfile: itkFinslerActiveContourLevelSetImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkFinslerActiveContourLevelSetImageFilter_h_
#define __itkFinslerActiveContourLevelSetImageFilter_h_

#include "itkSegmentationLevelSetImageFilter.h"
#include "itkFinslerActiveContourLevelSetFunction.h"

namespace itk {

/** \class FinslerActiveContourLevelSetImageFilter
 ...
 * FinslerActiveContourLevelSetFunction class contain additional information necessary
 ...
 * \sa FinslerActiveContourLevelSetFunction
...
class ITK_EXPORT FinslerActiveContourLevelSetImageFilter
  : public SegmentationLevelSetImageFilter< TInputImage, TFeatureImage, 
                                            TOutputPixelType>
{
public:
  /** Standard class typedefs */
  typedef FinslerActiveContourLevelSetImageFilter Self;
  ...
  typedef FinslerActiveContourLevelSetFunction<OutputImageType,
                                                FeatureImageType > FinslerActiveContourFunctionType;
  typedef typename FinslerActiveContourFunctionType::Pointer
  FinslerActiveContourFunctionPointer;
  
  /** Run-time type information (and related methods). */
  itkTypeMacro(FinslerActiveContourLevelSetImageFilter, SegmentationLevelSetImageFilter);
  ...
  { 
    if ( value != m_FinslerActiveContourFunction->GetDerivativeSigma() )
      {
      m_FinslerActiveContourFunction->SetDerivativeSigma( value );
      this->Modified();
      }
  }
  ...
  { return m_FinslerActiveContourFunction->GetDerivativeSigma(); }
...
protected:
  ...
  FinslerActiveContourLevelSetImageFilter(const Self &); // purposely not implemented
...
private:
  FinslerActiveContourFunctionPointer m_FinslerActiveContourFunction;
};
...
#include "itkFinslerActiveContourLevelSetImageFilter.txx"
#endif
