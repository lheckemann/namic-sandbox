...
int main(int argc, char** argv)
{
  ...
  // Read in raw image
  image_t::Pointer img = laSeg::readImage<image_t>(rawImageName.c_str());
  ...
  // write result
  laSeg::writeImage<itk::Image<unsigned char, 3> >(postProcProbabilityMap, outputSegmentationBinaryImageName.c_str());
