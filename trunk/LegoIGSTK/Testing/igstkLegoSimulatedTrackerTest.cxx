/*=========================================================================
  ...
  Module:    $RCSfile: igstkCircularSimulatedTrackerTest.cxx,v $
  Language:  C++
  Date:      $Date: 2008-05-07 19:38:42 $
...
int main( int , char * [] )
{
  ...
  // NXT in and out ports
  const int NXT_IN_1 = 0;
  const int NXT_IN_2 = 1;
  const int NXT_IN_3 = 2;
  const int NXT_IN_4 = 3;
  const int NXT_OUT_A = 0;
  const int NXT_OUT_B = 1;
  const int NXT_OUT_C = 2;
