...
public: 
  ...
  // Description:
  // Call this when creating an object at a given memory address.
  static void ConstructObject(vtkObject *ptr);

  // Description:
  // Call this when deleting an object at a given memory address.
  static void DestructObject(vtkObject *ptr);
...
protected:
  ...
  typedef std::set<vtkObject*> ObjectAllocationInfoType;
  static ObjectAllocationInfoType* ObjectAllocationInfo;
  //ETX
