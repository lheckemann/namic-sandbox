 ...
 * ...
 *
 * \sa SliceImageContainer
 * \sa Image
 *
 * \ingroup ImageObjects */
template <class TPixel, unsigned int VImageDimension=2>
class ITK_EXPORT SliceBasedImage : public ImageBase<VImageDimension>
{
public:
  /** Standard class typedefs */
  typedef SliceBasedImage               Self;
  ...
  itkTypeMacro(SliceBasedImage, ImageBase);
  ...
  typedef SliceImageContainer<unsigned long, PixelType> PixelContainer;
...
protected:
  ...
  virtual ~SliceBasedImage() {};
private:
  SliceBasedImage(const Self&); //purposely not implemented
