...
//     double minPhi(long ix, long iy, long iz, double level);
    ...
    typename cArray3D< TPixel >::Pointer mp_img;
    typename cArray3D< char >::Pointer mp_label;
    typename cArray3D< unsigned char >::Pointer mp_mask;
    typename cArray3D< double >::Pointer mp_phi;
