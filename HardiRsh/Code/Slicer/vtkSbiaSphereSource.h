...
#ifndef __vtkSbiaSphereSource_h
#define __vtkSbiaSphereSource_h

#include "vtkPolyDataAlgorithm.h"

#define VTK_MAX_SPHERE_RESOLUTION 1024

class VTK_GRAPHICS_EXPORT vtkSbiaSphereSource : public vtkPolyDataAlgorithm 
{
public:
  vtkTypeRevisionMacro(vtkSbiaSphereSource,vtkPolyDataAlgorithm);
  void PrintSelf(ostream& os, vtkIndent indent);

  // Description:
  // Construct sphere with radius=0.5 and default resolution 8 in both Phi
  // and Theta directions. Theta ranges from (0,360) and phi (0,180) degrees.
  static vtkSbiaSphereSource *New();
...
private:
  vtkSbiaSphereSource(const vtkSbiaSphereSource&);  // Not implemented.
  void operator=(const vtkSbiaSphereSource&);  // Not implemented.
};
