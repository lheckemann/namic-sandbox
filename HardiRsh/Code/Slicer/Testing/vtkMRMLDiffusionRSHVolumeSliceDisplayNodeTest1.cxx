...
int vtkMRMLDiffusionRSHVolumeSliceDisplayNodeTest1(int , char * [] )
{
  vtkSmartPointer< vtkMRMLDiffusionRSHVolumeSliceDisplayNode > node1 = vtkSmartPointer< vtkMRMLDiffusionRSHVolumeSliceDisplayNode >::New();

  EXERCISE_BASIC_OBJECT_METHODS( node1 );

  node1->UpdateReferences();

  vtkSmartPointer< vtkMRMLDiffusionRSHVolumeSliceDisplayNode > node2 = vtkSmartPointer< vtkMRMLDiffusionRSHVolumeSliceDisplayNode >::New();
