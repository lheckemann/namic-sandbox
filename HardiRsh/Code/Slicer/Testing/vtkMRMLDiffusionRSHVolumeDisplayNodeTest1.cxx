...
int vtkMRMLDiffusionRSHVolumeDisplayNodeTest1(int , char * [] )
{
  vtkSmartPointer< vtkMRMLDiffusionRSHVolumeDisplayNode > node1 = vtkSmartPointer< vtkMRMLDiffusionRSHVolumeDisplayNode >::New();

  EXERCISE_BASIC_OBJECT_METHODS( node1 );

  node1->UpdateReferences();

  vtkSmartPointer< vtkMRMLDiffusionRSHVolumeDisplayNode > node2 = vtkSmartPointer< vtkMRMLDiffusionRSHVolumeDisplayNode >::New();
