  ...
  bool applyMask )
{
  ...
  otsu->Update();
  spatialObjectMask->SetImage( otsu->GetOutput() );
...
//  odfReconFilter->SetImageMask( spatialObjectMask );
  ...
  maskWriter->SetInput( otsu->GetOutput() );
  maskWriter->Update();
...
int main( int argc, char * argv[] )
{
  ...
  try {
    ...
    {
      case 2:
        return runner<2>( inputVolume, outputODF, outputBaseline, thresholdMask, otsuOmegaThreshold,removeIslands, applyMask );
      case 4:
        return runner<4>( inputVolume, outputODF, outputBaseline, thresholdMask, otsuOmegaThreshold,removeIslands, applyMask );
      case 6:
        return runner<6>( inputVolume, outputODF, outputBaseline, thresholdMask, otsuOmegaThreshold,removeIslands, applyMask );
      case 8:
        return runner<8>( inputVolume, outputODF, outputBaseline, thresholdMask, otsuOmegaThreshold,removeIslands, applyMask );
      case 10:
        return runner<10>( inputVolume, outputODF, outputBaseline, thresholdMask, otsuOmegaThreshold,removeIslands, applyMask );
      case 12:
        return runner<12>( inputVolume, outputODF, outputBaseline, thresholdMask, otsuOmegaThreshold,removeIslands, applyMask );
      case 14:
        return runner<14>( inputVolume, outputODF, outputBaseline, thresholdMask, otsuOmegaThreshold,removeIslands, applyMask );
      case 16:
        return runner<16>( inputVolume, outputODF, outputBaseline, thresholdMask, otsuOmegaThreshold,removeIslands, applyMask );
      case 18:
        return runner<18>( inputVolume, outputODF, outputBaseline, thresholdMask, otsuOmegaThreshold,removeIslands, applyMask );
      case 20:
        return runner<20>( inputVolume, outputODF, outputBaseline, thresholdMask, otsuOmegaThreshold,removeIslands, applyMask );
      default:
