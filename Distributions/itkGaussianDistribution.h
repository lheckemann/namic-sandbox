...
public:
  ...
  /** Set the mean of the Gaussian distribution. Defaults to 0.0 */
  itkSetMacro(Mean, double);

  /** Get the mean of the Gaussian distribution. Defaults to 0.0 */
  itkGetConstMacro(Mean, double);

  /** Set the variance of the Gaussian distribution.  Defaults to 1.0 */
  itkSetMacro(Variance, double);

  /** Get the variance of the Gaussian distribution. Defaults to 1.0 */
  ...
  /** Static method to evaluate the probability density function (pdf)
   * of a Gaussian. The static method provides optimized access
  ...
  /** Static method to evaluate the cumulative distribution function
   * (cdf) of a Gaussian. The static method provides optimized access
   * without requiring an instance of the class. */
  ...
  /** Static method to evaluate the inverse cumulative distribution
   * function of a Gaussian.  The static method provides optimized
...
protected:
  GaussianDistribution(void) : m_Mean(0.0), m_Variance(1.0) {}
