/*=========================================================================
  ...
  Module:    $RCSfile: itkVectorImageRegistrationMethod.txx,v $
  Language:  C++
...
=========================================================================*/
#ifndef _itkVectorImageRegistrationMethod_txx
#define _itkVectorImageRegistrationMethod_txx
...
VectorImageRegistrationMethod<TFixedImage,TMovingImage>
...
{ 
  ...
  // VectorImageRegistrationMethod was a subclass of ProcessObject.
  // Historically, one could call StartRegistration() instead of
  // calling Update().  However, when called directly by the user, the
  // inputs to VectorImageRegistrationMethod may not be up to date.  This
 ...
 */
template < typename TFixedImage, typename TMovingImage >
const typename VectorImageRegistrationMethod<TFixedImage,TMovingImage>::TransformOutputType *
VectorImageRegistrationMethod<TFixedImage,TMovingImage>
::GetOutput() const
{
