...
//INCLUDES FOR SBIA DATA TYPES
#include "sbiaRealSphericalHarmonicRep.h"
                ...
                T itkNotUsed( dummy ) )
{
  if( ptype == typeid(T) )
  ...
  else if ( ptype == typeid(FixedArray<T,5>) )
    {
    This->SetNumberOfComponents(5);
    This->SetPixelType(ImageIOBase::FIXEDARRAY);
    This->SetComponentType(ntype);
   ...
   /**-----------------------------------------------------------
    * --------- SBIA ODF CLASSES --------------------------------
    * - We are only supporting rsh orders up to 10 
    * -   thats 66 coeffs.
    * - lbloy 06/30/08
    */
    else if ( ptype == typeid(RealSphericalHarmonicRep<T,2>) )
    {
      This->SetNumberOfComponents(6);
      This->SetPixelType(ImageIOBase::FIXEDARRAY);
      This->SetComponentType(ntype);
    ...
    else if ( ptype == typeid(RealSphericalHarmonicRep<T,4>) )
    {
      This->SetNumberOfComponents(15);
      This->SetPixelType(ImageIOBase::FIXEDARRAY);
      This->SetComponentType(ntype);
    ...
    else if ( ptype == typeid(RealSphericalHarmonicRep<T,6>) )
    {
      This->SetNumberOfComponents(28);
      This->SetPixelType(ImageIOBase::FIXEDARRAY);
      This->SetComponentType(ntype);
      return true;
    }
    else if ( ptype == typeid(RealSphericalHarmonicRep<T,8>) )
    {
      This->SetNumberOfComponents(45);
      This->SetPixelType(ImageIOBase::FIXEDARRAY);
      This->SetComponentType(ntype);
      return true;
    }
    else if ( ptype == typeid(RealSphericalHarmonicRep<T,10>) )
    {
      This->SetNumberOfComponents(66);
      This->SetPixelType(ImageIOBase::FIXEDARRAY);
      This->SetComponentType(ntype);
      return true;
    }
    ...
    else if ( ptype == typeid(OrientationDistributionFunction<T,2>) )
    {
      This->SetNumberOfComponents(6);
      This->SetPixelType(ImageIOBase::FIXEDARRAY);
      This->SetComponentType(ntype);
    ...
    else if ( ptype == typeid(OrientationDistributionFunction<T,4>) )
    {
      This->SetNumberOfComponents(15);
      This->SetPixelType(ImageIOBase::FIXEDARRAY);
      This->SetComponentType(ntype);
    ...
    else if ( ptype == typeid(OrientationDistributionFunction<T,6>) )
    {
      This->SetNumberOfComponents(28);
      This->SetPixelType(ImageIOBase::FIXEDARRAY);
      This->SetComponentType(ntype);
    ...
    else if ( ptype == typeid(OrientationDistributionFunction<T,8>) )
    {
      This->SetNumberOfComponents(45);
      This->SetPixelType(ImageIOBase::FIXEDARRAY);
      This->SetComponentType(ntype);
    ...
    else if ( ptype == typeid(OrientationDistributionFunction<T,10>) )
    {
      This->SetNumberOfComponents(66);
      This->SetPixelType(ImageIOBase::FIXEDARRAY);
      This->SetComponentType(ntype);
