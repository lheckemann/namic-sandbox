...
someone where to look in an image.
\end{abstract}
...
\section{Files}
There are two utility classes (objectmap and objectentry) and the main IO file (itkAnalyzeObjectLabelMapImageIO) and the corresponding
