...
\textbf{AnalyzeObjectExample1.exe 2dtest.nii creatingObject.obj}\\


\mcode{int main( int argc, char ** argv )\\
  \{\\
...
\textbf{AnalyzeObjectExample2.exe test.obj 0}

\mcode{typedef unsigned char PixelType;\\
const unsigned int Dimension = 3;\\
...
\mode{int main( int argc, char ** argv )\\
\{\\
...\\
