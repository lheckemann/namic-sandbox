...
int vtkITKBayesianClassifierImageFilterCommand(ClientData cd, Tcl_Interp *interp,
             int argc, char *argv[]);
...
int VTK_EXPORT Vtkrulebasedsegmentationtcl_Init(Tcl_Interp *interp)
{
  ...
  vtkTclCreateNew(interp,(char *) "vtkITKBayesianClassifierImageFilter", vtkITKBayesianClassifierImageFilterNewCommand,
                  vtkITKBayesianClassifierImageFilterCommand);
