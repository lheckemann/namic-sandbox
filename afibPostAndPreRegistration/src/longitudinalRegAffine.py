...
exeFile = "./r/registerPostToPreAffine"
...
for it in range(n):
        ...
        postToPreEndo = postToPreEndo.replace(".nrrd", "_postToPreEndo.nrrd")
        postToPreMRI = postToPreMRI.replace(".nrrd", "_postToPreMRI.nrrd")
