...
########################################
    ...
    set PetFlowId [b2 load image $pathToRegressionDir/SGI/pet_images/ge-4096/TEST/pcanonimiz__410.imf data-type= float-single]
    ...
    set PetCountId [b2 load image $pathToRegressionDir/SGI/pet_images/ge-4096/TEST/pcanonimiz__410.ima data-type= float-single]
    ...
    set PetFlow8bitId [b2 load image $pathToRegressionDir/SGI/pet_images/ge-4096/TEST/pcanonimiz__410.imf]
    ...
    set TestMaskId [b2 threshold image $TestImageId 0.5]
...
#    ReportTestStatus $LogFile  [ expr { [ b2 destroy mask $TestMaskId ] != -1 } ] $ModuleName "Destroying mask $TestMaskId"
    ...
    ############################ BRAINS2 Resample Worsley-MR ########################################
    set result [b2 measure image mask $TestMaskId $PetFlowId]
puts "$result"
    set standards {
    ...
    set result [b2 measure image mask $TestMaskId $PetCountId]
puts "$result"
    set standards {
    ...
    set result [b2 measure image mask $TestMaskId $PetFlow8bitId]
puts "$result"
    set standards {
...
puts "$result"
    ...
    ReportTestStatus $LogFile  [ expr { [ b2 destroy image $PetFlow8bitId ] != -1 } ] $ModuleName "Destroying image $PetFlow8bitId"
    ReportTestStatus $LogFile  [ expr { [ b2 destroy image $PetFlowId ] != -1 } ] $ModuleName "Destroying image $PetFlowId"
    ReportTestStatus $LogFile  [ expr { [ b2 destroy image $PetCountId ] != -1 } ] $ModuleName "Destroying image $PetCountId"
