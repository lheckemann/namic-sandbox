...
# \brief    This module tests the "b2 create hem-roi"
...
proc createHemRoi {pathToRegressionDir dateString} {
    ...
    set ModuleDescription "Test the b2 create hem-roi command"
...
########################################
    ...
    set errorTest [b2 create hem-roi]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

    set SubTestDes "arguement number test"
    set errorTest [b2 create hem-roi $ImageId junk= ]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

    set SubTestDes "optional arguement test"
    set errorTest [b2 create hem-roi $ImageId junk= test]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

    set SubTestDes "invalid image test"
    set errorTest [b2 create hem-roi 65536]
    ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes
    ...
    ReportTestStatus $LogFile  [ expr { [ b2 destroy roi $OrigRoiId ] != -1 } ] $ModuleName "Destroying roi $OrigRoiId"
    ReportTestStatus $LogFile  [ expr { [ b2 destroy mask $maskOrig ] != -1 } ] $ModuleName "Destroying mask $maskOrig"
    ReportTestStatus $LogFile  [ expr { [ b2 destroy mask $maskNew ] != -1 } ] $ModuleName "Destroying mask $maskNew"
    ...
    set TestRoiId [b2 create hem-roi $ImageId x-loc= 64]
    ReportTestStatus $LogFile  [ expr {$TestRoiId != -1 } ] $ModuleName $SubTestDes

    ############################### Load Previous ROI ###########################################
    set SubTestDes "Create Hem ROI Load ROI(2) test"
    set OrigRoiId [b2 load roi $pathToRegressionDir/SGI/MR/4x-B1/TEST/10_ACPC/user/surf_hem_64.yroi]
    ReportTestStatus $LogFile  [ expr {$OrigRoiId != -1 } ] $ModuleName $SubTestDes]
    ...
    ############################ BRAINS2 Create Hem ROI ########################################
    set SubTestDes "B2 CREATE HEM-ROI test (2)"
    set TestRoiId [b2 create hem-roi $ImageId x-loc= 2048]
    ReportTestStatus $LogFile  [ expr {$TestRoiId == -1 } ] $ModuleName $SubTestDes
