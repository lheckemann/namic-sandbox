...
# \brief    This module tests the "b2 clip image"
...
# Test Performed
# -----------------------------------------------------------------------
# Test the b2 clip image command
#
# To Do
#------------------------------------------------------------------------
# Nothing
...
proc clipImage {pathToRegressionDir dateString} {
    ...
    set ModuleDescription "Test the b2 clip image command"
