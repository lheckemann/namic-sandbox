...
# \brief  This module tests the "b2 min images"
...
# Test Performed
# -----------------------------------------------------------------------
# Test the b2 min images command
#
# To Do
#------------------------------------------------------------------------
# Nothing
...
proc minImages {pathToRegressionDir dateString} {
                ...
                set ModuleDescription "Test the b2 min images command"
...
# First Test for invalid arguements
        set SubTestDes "required arguement test (1)"
                ...
                set b2cmd [format "b2 min images {%s %s %s} junk=" $Image1Id $Image2Id $Image3Id]
                set errorTest [eval $b2cmd]
                ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

                set SubTestDes "optional arguement test"
                set b2cmd [format "b2 min images {%s %s %s} junk= test" $Image1Id $Image2Id $Image3Id]
                set errorTest [eval $b2cmd]
                ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes

                set SubTestDes "invalid image test"
                set errorTest [b2 min images {65536}]
                ReportTestStatus $LogFile  [ expr {$errorTest == -1 } ] $ModuleName $SubTestDes
...
############################ BRAINS2 MIN IMAGE - 1 Image ########################################
                ...
                set b2cmd [format "b2 min images {%s}" $Image1Id ]
...
############################ BRAINS2 MIN IMAGE - 2 Images ########################################
                ...
                set TestImageId [b2 min images [list $Image1Id $Image2Id]]
                ReportTestStatus $LogFile  [ expr {$TestImageId != -1 } ] $ModuleName $SubTestDes
...
############################ BRAINS2 MIN IMAGE - 3 Images ########################################
                ...
                set TestImageId [b2 min images [list $Image1Id $Image2Id $Image3Id]]
                ReportTestStatus $LogFile  [ expr {$TestImageId != -1 } ] $ModuleName $SubTestDes
...
############################ BRAINS2 MIN IMAGE - Data Type ########################################
                ...
                set TestImageId [b2 min images [list $Image1Id $Image2Id $Image3Id] data-type= float-single]
                ReportTestStatus $LogFile  [ expr {$TestImageId != -1 } ] $ModuleName $SubTestDes
