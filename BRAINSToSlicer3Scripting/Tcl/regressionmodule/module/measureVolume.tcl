...
set output [ b2 measure volume mask $brainMask ]
puts $output
...
set output2 [ b2 measure volume roi $cranRoi ]
puts $output2
...
set output3 [ b2 measure volume roi $cranRoi  min= 100 max= 102 ]
puts $output3
...
# Clean up Files
    ...
    ReportTestStatus $LogFile  [ expr { [ b2 destroy mask [lindex [lindex $output2 1] 1] ] != -1 } ] $ModuleName "Destroying mask [lindex [lindex $output2 1] 1]"
    ReportTestStatus $LogFile  [ expr { [ b2 destroy mask [lindex [lindex $output3 1] 1] ] != -1 } ] $ModuleName "Destroying mask [lindex [lindex $output3 1] 1]"
