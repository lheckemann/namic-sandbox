/*==========================================================================
  ...
  Program:   3D Slicer
  Module:    $HeadURL: http://svn.slicer.org/Slicer4/trunk/Modules/OpenIGTLinkIF/vtkIGTLToMRMLLinearTransform.h $
...
#include "OpenIGTLinkIFModuleLogicExport.h"
...
class VTK_SLICER_OPENIGTLINKIF_MODULE_LOGIC_EXPORT vtkIGTLToMRMLLinearTransform : public vtkIGTLToMRMLBase
{
 public:
