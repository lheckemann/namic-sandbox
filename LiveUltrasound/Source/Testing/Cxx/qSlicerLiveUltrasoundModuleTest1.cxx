...
//-----------------------------------------------------------------------------
int qSlicerLiveUltrasoundModuleTest1( int argc, char * argv[] )
{
  QApplication app(argc, argv);

  qSlicerLiveUltrasoundModule moduleTemplateModule;

  if (moduleTemplateModule.helpText().isEmpty())
    {
    std::cerr << "qSlicerLiveUltrasoundModule::helpText() is empty."
              << std::endl;
    return EXIT_FAILURE;
    }
  ...
  if (moduleTemplateModule.acknowledgementText().isEmpty())
    {
    std::cerr << "qSlicerLiveUltrasoundModule::acknowledgementText() is empty."
              << std::endl;
    return EXIT_FAILURE;
    }
  ...
  if (moduleTemplateModule.appLogic() != 0)
    {
    std::cerr << "qSlicerLiveUltrasoundModule::initialize() failed."
              << std::endl;
    return EXIT_FAILURE;
    }
  ...
  if (moduleTemplateModule.mrmlScene() != scene)
    {
    std::cerr << "qSlicerLiveUltrasoundModule::setMRMLScene() failed."
              << std::endl;
    return EXIT_FAILURE;
    }
