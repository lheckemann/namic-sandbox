...
struct point_message {
  igtl_header           header;
  igtl_point_element   metalist[TEST_POINT_NUM];
};
#pragma pack()
...
int main( int argc, char * argv [] )
{
  ...
  igtl_point_convert_byte_order(message.metalist, TEST_POINT_NUM);
  ...
  message.header.crc = igtl_point_get_crc(message.metalist, TEST_POINT_NUM);
  ...
  */
  ...
  //           (size_t)(IGTL_HEADER_SIZE+IGTL_POINT_HEADER_SIZE));
  r = 0;
