/*=========================================================================
  ...
  Module:    $RCSfile: itkMeasurementHistogram.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkMeasurementHistogram_h
#define __itkMeasurementHistogram_h
 ...
 *
 * MeasurementHistogram represents an ND histogram.  MeasurementHistogram bins can be
 ...
 *
 * \code
 * typedef MeasurementHistogram< THistogramMeasurement, typename TFrequencyContainer > HistogramType;
 * \endcode
 *
...
class ITK_EXPORT MeasurementHistogram
...
public:
  ...
  itkTypeMacro(MeasurementHistogram, Sample);
...
public:
  ...
  /** \class MeasurementHistogram::ConstIterator class that walks through the elements of
   * the histogram */
  class ConstIterator
    {
    public:

    friend class MeasurementHistogram;
  ...
  /** \class MeasurementHistogram::Iterator */
...
#include "itkMeasurementHistogram.txx"
#endif
