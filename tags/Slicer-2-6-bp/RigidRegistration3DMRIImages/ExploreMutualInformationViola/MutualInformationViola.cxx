...
int main( int argc, char * argv[] )
{
  if( argc < 4 )
    ...
    std::cerr << argv[0] << "  fixedImage  movingImage MetricSpatialSamples(500)" << std::endl;
    return 1;
    }
...
// Software Guide : BeginCodeSnippet
  ...
  fixedNormalizer->SetInput(  fixedReader->GetOutput() );
...
// Software Guide : EndCodeSnippet
  ...
  ImageType::ConstPointer fixedImage  = fixedSmoother->GetOutput();
  ImageType::ConstPointer movingImage = movingSmoother->GetOutput();
...
// Software Guide : BeginCodeSnippet
 ...
 metric->SetNumberOfSpatialSamples( atoi(argv[3]) );
// Software Guide : EndCodeSnippet
 
 fixedNormalizer->Update();

   metric->SetFixedImageRegion( fixedNormalizer->GetOutput()->GetBufferedRegion()  );
