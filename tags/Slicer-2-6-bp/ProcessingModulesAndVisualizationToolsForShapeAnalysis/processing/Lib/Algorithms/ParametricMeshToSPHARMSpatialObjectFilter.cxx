...
void ParametricMeshToSPHARMSpatialObjectFilter::FlipAlign (CoefListType * coef, 
                                                                                                                                                                                  int  flipIndex)
{
...
int ParametricMeshToSPHARMSpatialObjectFilter::BestFlipAlign (CoefListType * coef, 
                                                                                                                                                                                     const CoefListType * flipTemplate)
{
...
ParametricMeshToSPHARMSpatialObjectFilter::RotateParametricMesh()
{
  ...
  //Testing
  //   m_flatCoeffs[0 + 0] = 381.498;
  //   m_flatCoeffs[0 + 1] = 405.733;
  //   m_flatCoeffs[0 + 2] = 363.22;
  //   m_flatCoeffs[3 + 0] = 3.39284;
  //   m_flatCoeffs[3 + 1] = 11.309;
  //   m_flatCoeffs[3 + 2] = -14.7132;
  //   m_flatCoeffs[6 + 0] = -19.4168;
  //   m_flatCoeffs[6 + 1] = 12.1414;
  //   m_flatCoeffs[6 + 2] = -0.413869;
  //   m_flatCoeffs[9 + 0] = 11.8806;
  //   m_flatCoeffs[9 + 1] = 16.6185;
  //   m_flatCoeffs[9 + 2] = 3.65362;
