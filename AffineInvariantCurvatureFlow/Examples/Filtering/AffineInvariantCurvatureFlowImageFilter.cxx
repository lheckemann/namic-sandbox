/*=========================================================================
  ...
  Module:    $RCSfile: AffineInvariantCurvatureFlowImageFilter.cxx,v $
  Language:  C++
...
//    OUTPUTS: {AffineInvariantCurvatureFlowImageFilterOutput.png}
//    10 0.25
//  Software Guide : EndCommandLineArgs

//  Software Guide : BeginLatex
//
//  The \doxygen{AffineInvariantCurvatureFlowImageFilter} performs edge-preserving smoothing
...
//  AffineInvariantCurvature of the contour:
//
//  \begin{equation}
//  I_t = \kappa |\nabla I|
//  \end{equation}
...
//  and disappears.
//
//  \index{itk::AffineInvariantCurvatureFlowImageFilter}
//
...
//
//  \index{itk::AffineInvariantCurvatureFlowImageFilter!header}
//
//  Software Guide : EndLatex 
...
int main( int argc, char * argv[] )
{
  ...
  //  Software Guide : BeginLatex
  //
  //  The AffineInvariantCurvatureFlow filter type is now instantiated using both the
  //  input image and the output image types.
  //
  //  \index{itk::AffineInvariantCurvatureFlowImageFilter!instantiation}
  //
  //  Software Guide : EndLatex 

  // Software Guide : BeginCodeSnippet
  typedef itk::AffineInvariantCurvatureFlowImageFilter<
  ...
  //
  //  \index{itk::AffineInvariantCurvatureFlowImageFilter!New()}
  //  \index{itk::AffineInvariantCurvatureFlowImageFilter!Pointer}
  //
  //  Software Guide : EndLatex 
  ...
  //  Software Guide : BeginLatex
  //
  //  The AffineInvariantCurvatureFlow filter requires two parameters, the number of
  ...
  //
  //  \index{itk::AffineInvariantCurvatureFlowImageFilter!Update()}
  //  \index{itk::AffineInvariantCurvatureFlowImageFilter!SetTimeStep()}
  //  \index{itk::AffineInvariantCurvatureFlowImageFilter!SetNumberOfIterations()}
  //  \index{SetTimeStep()!itk::AffineInvariantCurvatureFlowImageFilter}
  //  \index{SetNumberOfIterations()!itk::AffineInvariantCurvatureFlowImageFilter}
  //
  //  Software Guide : EndLatex 
  ...
  //  have been used after the AffineInvariantCurvature flow filter.
  //
  //  Software Guide : EndLatex 
  ...
  // \includegraphics[width=0.44\textwidth]{AffineInvariantCurvatureFlowImageFilterOutput.eps}
  // \itkcaption[AffineInvariantCurvatureFlowImageFilter output]{Effect of the
  // AffineInvariantCurvatureFlowImageFilter on a slice from a MRI proton density image  of
  // the brain.}
  // \label{fig:AffineInvariantCurvatureFlowImageFilterInputOutput}
  // \end{figure}
  //
  //  Figure \ref{fig:AffineInvariantCurvatureFlowImageFilterInputOutput} illustrates the
  ...
  //  \item \doxygen{AffineInvariantCurvatureAnisotropicDiffusionImageFilter}
