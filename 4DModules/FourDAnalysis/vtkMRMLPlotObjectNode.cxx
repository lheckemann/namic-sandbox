...
vtkMRMLPlotObjectNode* vtkMRMLPlotObjectNode::New()
{
  ...
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkMRMLPlotObjectNode"); if(ret)
    {
      return (vtkMRMLPlotObjectNode*)ret;
    }
  // If the factory was unable to create the object, then create it here.
  return new vtkMRMLPlotObjectNode;
}


//----------------------------------------------------------------------------
vtkMRMLNode* vtkMRMLPlotObjectNode::CreateNodeInstance()
{
  // First try to create the object from the vtkObjectFactory
  vtkObject* ret = vtkObjectFactory::CreateInstance("vtkMRMLPlotObjectNode");
  if(ret)
    {
      return (vtkMRMLPlotObjectNode*)ret;
    }
...
//----------------------------------------------------------------------------
vtkMRMLPlotObjectNode::vtkMRMLPlotObjectNode()
{
  this->Visible  = 1;
  this->Color[0] = 0.0;
  this->Color[1] = 0.0;
...
//----------------------------------------------------------------------------
void vtkMRMLPlotObjectNode::WriteXML(ostream& of, int nIndent)
{
...
//----------------------------------------------------------------------------
void vtkMRMLPlotObjectNode::ReadXMLAttributes(const char** atts)
{
...
void vtkMRMLPlotObjectNode::Copy(vtkMRMLNode *anode)
{

  Superclass::Copy(anode);
  vtkMRMLPlotObjectNode *node = (vtkMRMLPlotObjectNode *) anode;
...
//----------------------------------------------------------------------------
void vtkMRMLPlotObjectNode::ProcessMRMLEvents( vtkObject *caller, unsigned long event, void *callData )
{
...
//----------------------------------------------------------------------------
void vtkMRMLPlotObjectNode::PrintSelf(ostream& os, vtkIndent indent)
{
