/*=========================================================================
  ...
  Module:    $RCSfile: TPGACImageFilter.cxx,v $
  Language:  C++
...
//    OUTPUTS: {TPGACImageFilterOutput5.png}
//    81 114 5 1.0  -0.5  3.0   2
//  Software Guide : EndCommandLineArgs
//  Software Guide : BeginCommandLineArgs
//    INPUTS: {BrainProtonDensitySlice.png}
//    OUTPUTS: {TPGACImageFilterOutput6.png}
//    99 114 5 1.0  -0.5  3.0  2
//  Software Guide : EndCommandLineArgs
//  Software Guide : BeginCommandLineArgs
//    INPUTS: {BrainProtonDensitySlice.png}
//    OUTPUTS: {TPGACImageFilterOutput8.png}
//    40 90 5 0.5  -0.3  2.0 10
//  Software Guide : EndCommandLineArgs
//  Software Guide : BeginCommandLineArgs
//    INPUTS: {BrainProtonDensitySlice.png}
//    OUTPUTS: {TPGACImageFilterOutput7.png}
//    OUTPUTS: [TPGACImageFilterOutput1.png]
//    OUTPUTS: [TPGACImageFilterOutput2.png]
//    OUTPUTS: [TPGACImageFilterOutput3.png]
//    56 92 5 1.0  -0.3  2.0 10
//  Software Guide : EndCommandLineArgs

// Software Guide : BeginLatex
//
// The use of the \doxygen{TPGACLevelSetImageFilter} is
...
//
// TPGACLevelSetImageFilter expects two inputs.  The first is
...
//
// \begin{figure} \center
// \includegraphics[width=\textwidth]{TPGACsCollaborationDiagram1.eps}
// \itkcaption[TPGACLevelSetImageFilter collaboration
// diagram]{Collaboration diagram for the TPGACLevelSetImageFilter
// applied to a segmentation task.}
// \label{fig:TPGACsCollaborationDiagram}
// \end{figure}
//
// Figure~\ref{fig:TPGACsCollaborationDiagram} shows the major
// components involved in the application of the
// TPGACLevelSetImageFilter to a segmentation task.
...
// TPGACLevelSetImageFilter is passed to a
...
int main( int argc, char *argv[] )
{
  if( argc < 11 )
    ...
    std::cerr << " seedX seedY seed Z InitialDistance";
  ...
  //  TPGACLevelSetImageFilter and create an object of this
  //  type using the \code{New()} method.
  //
  //  Software Guide : EndLatex 

  // Software Guide : BeginCodeSnippet
  typedef  itk::TPGACLevelSetImageFilter< InternalImageType, 
                InternalImageType >    TPGACFilterType;
  TPGACFilterType::Pointer tpgac = 
                                     TPGACFilterType::New();
  // Software Guide : EndCodeSnippet
  ...
  //  Software Guide : BeginLatex
  //  
  //  For the TPGACLevelSetImageFilter, scaling parameters
  ...
  //  Software Guide : BeginCodeSnippet
  tpgac->SetPropagationScaling( propagationScaling );
  ...
  //  Figure~\ref{fig:TPGACsCollaborationDiagram} using the
  //  following lines:
  //
  //  Software Guide : EndLatex 
  ...
  //  Table~\ref{tab:TPGACImageFilterOutput2} presents the
  ...
  //  \end{tabular}
  //  \end{center}
  //  \itkcaption[TPGAC segmentation example parameters]{Parameters used
  //  for segmenting some brain structures shown in
  //  Figure~\ref{fig:TPGACImageFilterOutput2} using the filter
  //  TPGACLevelSetImageFilter. 
  //  \label{tab:TPGACImageFilterOutput2}}
  //  \end{table}
  //
  //  Figure~\ref{fig:TPGACImageFilterOutput} presents the
  //  intermediate outputs of the pipeline illustrated in
  //  Figure~\ref{fig:TPGACsCollaborationDiagram}. They are
  ...
  // \includegraphics[height=0.40\textheight]{TPGACImageFilterOutput1.eps}
  // \includegraphics[height=0.40\textheight]{TPGACImageFilterOutput2.eps}
  // \includegraphics[height=0.40\textheight]{TPGACImageFilterOutput3.eps}
  // \itkcaption[TPGACLevelSetImageFilter intermediate
  // output]{Images generated by the segmentation process based on the
  // TPGACLevelSetImageFilter. From left to right and top to
  ...
  // \label{fig:TPGACImageFilterOutput} \end{figure}
  // 
  //  Segmentations of the main brain structures are presented in
  //  Figure~\ref{fig:TPGACImageFilterOutput2}. The results
  ...
  //
  // \begin{figure} \center
  // \includegraphics[width=0.24\textwidth]{TPGACImageFilterOutput5.eps}
  // \includegraphics[width=0.24\textwidth]{TPGACImageFilterOutput6.eps}
  // \includegraphics[width=0.24\textwidth]{TPGACImageFilterOutput7.eps}
  // \includegraphics[width=0.24\textwidth]{TPGACImageFilterOutput8.eps}
  // \itkcaption[TPGACImageFilter segmentations]{Images generated by the
  // segmentation process based on the TPGACImageFilter. From left to
  ...
  // the gray matter.}
  // \label{fig:TPGACImageFilterOutput2}
  // \end{figure}
  //
  //  Software Guide : EndLatex 
