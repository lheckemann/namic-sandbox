...
if {[info commands vtkPacs] != "" ||
    [::vtk::load_component vtkPacsTCL] == ""} {
    global PACKAGE_DIR_VTKPacs
    package provide vtkPacs 1.0

    # source the Module's tcl file that contains it's init procedure
    source [file join $PACKAGE_DIR_VTKPacs/../../../tcl/PACS.tcl]
    ...
    #global Module
    #lappend Module(customModules) PACS
}
