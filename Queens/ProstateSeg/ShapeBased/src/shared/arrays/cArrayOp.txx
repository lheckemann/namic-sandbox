...
namespace douher
{
  ...
  */
  ...
  void
  writeImageSeries2( const std::vector< typename itk::Image< TData, 2 >::Pointer >& imgs, \
                     const std::vector< std::string >& imageNameList )
  {
    writeImageSeries<TData, 2>(imgs, imageNameList);
  }
  ...
  template< typename TData > 
  std::vector< typename itk::Image< TData, 2 >::Pointer >
  readImageSeries2( const std::vector< std::string >& imageNameList )
  {
    return readImageSeries<TData, 2>(imageNameList);
  }
