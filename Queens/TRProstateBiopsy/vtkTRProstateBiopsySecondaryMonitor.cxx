...
//----------------------------------------------------------------------------
vtkStandardNewMacro(vtkTRProstateBiopsySecondaryMonitor);
vtkCxxRevisionMacro(vtkTRProstateBiopsySecondaryMonitor, "$Revision: 1.0 $");
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
void vtkTRProstateBiopsySecondaryMonitor::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void vtkTRProstateBiopsySecondaryMonitor::UpdateSecondaryMonitorPoisition()
{
  // Window rect
  RECT rect;    
...
//----------------------------------------------------------------------------
void vtkTRProstateBiopsySecondaryMonitor::CreateWidget()
{
...
void vtkTRProstateBiopsySecondaryMonitor::SetCurrentTarget(vtkTRProstateBiopsyTargetDescriptor* target)
{
