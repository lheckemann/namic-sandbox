  ...
  plot "AllThreadingMemoryResults.txt" using 5:9 with linespoints title 'Threading', "AllDefaultMemoryResults.txt" using 5:9 with linespoints  title 'NoThreading'
