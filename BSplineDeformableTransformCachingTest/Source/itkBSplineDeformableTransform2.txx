/*=========================================================================
  ...
  Module:    $RCSfile: itkBSplineDeformableTransform2.txx,v $
  Language:  C++
  Date:      $Date: 2007/12/04 20:42:17 $
...
=========================================================================*/
#ifndef __itkBSplineDeformableTransform2_txx
#define __itkBSplineDeformableTransform2_txx
...
::BSplineDeformableTransform2():Superclass(SpaceDimension,0)
{
...
template<class TScalarType, unsigned int NDimensions, unsigned int VSplineOrder>
const 
typename BSplineDeformableTransform2<TScalarType, NDimensions,VSplineOrder>
::ParametersType &
BSplineDeformableTransform2<TScalarType, NDimensions,VSplineOrder>
