/*=========================================================================
  ...
  Module:    $RCSfile: itkBSplineDeformableTransform2.h,v $
  Language:  C++
  Date:      $Date: 2007/11/20 19:59:15 $
...
#ifndef __itkBSplineDeformableTransform2_h
#define __itkBSplineDeformableTransform2_h
...
/** \class BSplineDeformableTransform2
 ...
 * \verbatim
 * typedef BSplineDeformableTransform2<double,2,3> TransformType;
...
class ITK_EXPORT BSplineDeformableTransform2 : 
          public Transform< TScalarType, NDimensions, NDimensions >
{
public:
  /** Standard class typedefs. */
  typedef BSplineDeformableTransform2                         Self;
  ...
  itkTypeMacro( BSplineDeformableTransform2, Transform );
   ...
   *  This restriction is due to the fact that the BSplineDeformableTransform2
...
protected:
  ...
  BSplineDeformableTransform2();
  virtual ~BSplineDeformableTransform2();
...
private:
  BSplineDeformableTransform2(const Self&); //purposely not implemented
...
#define ITK_TEMPLATE_BSplineDeformableTransform2(_, EXPORT, x, y) namespace itk { \
  _(3(class EXPORT BSplineDeformableTransform2< ITK_TEMPLATE_3 x >)) \
  namespace Templates { typedef BSplineDeformableTransform2< ITK_TEMPLATE_3 x > \
                                                   BSplineDeformableTransform2##y; } \
  }

#if ITK_TEMPLATE_EXPLICIT
# include "Templates/itkBSplineDeformableTransform2+-.h"
#endif

#if ITK_TEMPLATE_TXX
# include "itkBSplineDeformableTransform2.txx"
#endif

#endif /* __itkBSplineDeformableTransform2_h */
