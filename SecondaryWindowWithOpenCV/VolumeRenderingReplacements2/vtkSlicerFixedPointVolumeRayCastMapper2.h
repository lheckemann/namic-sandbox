/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerFixedPointVolumeRayCastMapper2.h,v $
...
=========================================================================*/
// .NAME vtkSlicerFixedPointVolumeRayCastMapper2 - A fixed point mapper for volumes
// .SECTION Description
...
// vtkSlicerFixedPointVolumeRayCastMapper2 can be used:
...
#ifndef __vtkSlicerFixedPointVolumeRayCastMapper2_h
#define __vtkSlicerFixedPointVolumeRayCastMapper2_h
...
class vtkSlicerFixedPointVolumeRayCastMIPHelper2;
class vtkSlicerFixedPointVolumeRayCastCompositeHelper2;
class vtkSlicerFixedPointVolumeRayCastCompositeGOHelper2;
class vtkSlicerFixedPointVolumeRayCastCompositeGOShadeHelper2;
class vtkSlicerFixedPointVolumeRayCastCompositeShadeHelper2;
...
class VTK_VOLUMERENDERINGREPLACEMENTS_EXPORT vtkSlicerFixedPointVolumeRayCastMapper2 : public vtkVolumeMapper
{
public:
  //SLICERADD
  ...
  static vtkSlicerFixedPointVolumeRayCastMapper2 *New();
  vtkTypeRevisionMacro(vtkSlicerFixedPointVolumeRayCastMapper2,vtkVolumeMapper);
...
//ETX
  ...
  vtkGetObjectMacro( MIPHelper, vtkSlicerFixedPointVolumeRayCastMIPHelper2 );
  vtkGetObjectMacro( CompositeHelper, vtkSlicerFixedPointVolumeRayCastCompositeHelper2 );
  vtkGetObjectMacro( CompositeGOHelper, vtkSlicerFixedPointVolumeRayCastCompositeGOHelper2 );
  vtkGetObjectMacro( CompositeGOShadeHelper, vtkSlicerFixedPointVolumeRayCastCompositeGOShadeHelper2 );
  vtkGetObjectMacro( CompositeShadeHelper, vtkSlicerFixedPointVolumeRayCastCompositeShadeHelper2 );
  ...
  void SetRayCastImage( vtkSlicerFixedPointRayCastImage2 * );
  vtkGetObjectMacro( RayCastImage, vtkSlicerFixedPointRayCastImage2  );
...
protected:
  ...
  vtkSlicerRayCastImageDisplayHelper2 *ImageDisplayHelper;
  ...
  vtkSlicerFixedPointRayCastImage2 *RayCastImage;
  ...
  vtkSlicerFixedPointVolumeRayCastMIPHelper2              *MIPHelper;
  vtkSlicerFixedPointVolumeRayCastCompositeHelper2        *CompositeHelper;
  vtkSlicerFixedPointVolumeRayCastCompositeGOHelper2      *CompositeGOHelper;
  vtkSlicerFixedPointVolumeRayCastCompositeShadeHelper2   *CompositeShadeHelper;
  vtkSlicerFixedPointVolumeRayCastCompositeGOShadeHelper2 *CompositeGOShadeHelper;
...
private:
  vtkSlicerFixedPointVolumeRayCastMapper2(const vtkSlicerFixedPointVolumeRayCastMapper2&);  // Not implemented.
  void operator=(const vtkSlicerFixedPointVolumeRayCastMapper2&);  // Not implemented.
};


inline unsigned int vtkSlicerFixedPointVolumeRayCastMapper2::ToSlicerFixedPointPosition( float val )
{
  return static_cast<unsigned int>(val * VTKKW_FP_SCALE + 0.5);
}

inline void vtkSlicerFixedPointVolumeRayCastMapper2::ToSlicerFixedPointPosition( float in[3], unsigned int out[3] )
{
...
inline unsigned int vtkSlicerFixedPointVolumeRayCastMapper2::ToSlicerFixedPointDirection( float dir )
{
  return ((dir<0.0)?
...
inline void vtkSlicerFixedPointVolumeRayCastMapper2::ToSlicerFixedPointDirection( float in[3], unsigned int out[3] )
{
  out[0] = ((in[0]<0.0)?
...
inline void vtkSlicerFixedPointVolumeRayCastMapper2::FixedPointIncrement( unsigned int position[3], unsigned int increment[3] )
{
...
inline void vtkSlicerFixedPointVolumeRayCastMapper2::GetFloatTripleFromPointer( float v[3], float *ptr )
{
  v[0] = *(ptr);
  v[1] = *(ptr+1);
  v[2] = *(ptr+2);
...
inline void vtkSlicerFixedPointVolumeRayCastMapper2::GetUIntTripleFromPointer( unsigned int v[3], unsigned int *ptr )
{
  v[0] = *(ptr);
  v[1] = *(ptr+1);
  v[2] = *(ptr+2);
...
inline void vtkSlicerFixedPointVolumeRayCastMapper2::ShiftVectorDown( unsigned int in[3],
                                                       unsigned int out[3] )
{
...
inline int vtkSlicerFixedPointVolumeRayCastMapper2::CheckMinMaxVolumeFlag( unsigned int mmpos[3], int c )
{
  unsigned int offset = 
...
inline int vtkSlicerFixedPointVolumeRayCastMapper2::CheckMIPMinMaxVolumeFlag( unsigned int mmpos[3], int c, 
...
inline void vtkSlicerFixedPointVolumeRayCastMapper2::LookupColorUC( unsigned short *colorTable,
                                                     unsigned short *scalarOpacityTable,
                                                     unsigned short index,
                                                     unsigned char  color[4] )
{
...
inline void vtkSlicerFixedPointVolumeRayCastMapper2::LookupDependentColorUC( unsigned short *colorTable,
                                                              unsigned short *scalarOpacityTable,
                                                              unsigned short index[4],
                                                              int            components,
                                                              unsigned char  color[4] )
...
inline void vtkSlicerFixedPointVolumeRayCastMapper2::LookupAndCombineIndependentColorsUC( unsigned short *colorTable[4],
                                                                           unsigned short *scalarOpacityTable[4],
                                                                           unsigned short  index[4],
                                                                           float           weights[4],
                                                                           int             components,
...
inline int vtkSlicerFixedPointVolumeRayCastMapper2::CheckIfCropped( unsigned int pos[3] )
{
  int idx;
