/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerOpenGLVolumeTextureMapper3D2.h,v $
...
=========================================================================*/
// .NAME vtkSlicerOpenGLVolumeTextureMapper3D2 - concrete implementation of 3D volume texture mapping

// .SECTION Description
// vtkSlicerOpenGLVolumeTextureMapper3D2 renders a volume using 3D texture mapping.
// See vtkSlicerVolumeTextureMapper3D2 for full description.

// .SECTION see also
// vtkSlicerVolumeTextureMapper3D2 vtkVolumeMapper

#ifndef __vtkSlicerOpenGLVolumeTextureMapper3D2_h
#define __vtkSlicerOpenGLVolumeTextureMapper3D2_h
...
class VTK_VOLUMERENDERINGREPLACEMENTS_EXPORT vtkSlicerOpenGLVolumeTextureMapper3D2 : public vtkSlicerVolumeTextureMapper3D2
{
public:
  vtkTypeRevisionMacro(vtkSlicerOpenGLVolumeTextureMapper3D2,vtkSlicerVolumeTextureMapper3D2);
  void PrintSelf(ostream& os, vtkIndent indent);

  static vtkSlicerOpenGLVolumeTextureMapper3D2 *New();
...
protected:
  vtkSlicerOpenGLVolumeTextureMapper3D2();
  ~vtkSlicerOpenGLVolumeTextureMapper3D2();
...
private:
  vtkSlicerOpenGLVolumeTextureMapper3D2(const vtkSlicerOpenGLVolumeTextureMapper3D2&);  // Not implemented.
  void operator=(const vtkSlicerOpenGLVolumeTextureMapper3D2&);  // Not implemented.
};
