/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerGPUVolumeTextureMapper3D2.cxx,v $
...
=========================================================================*/
#include "vtkSlicerGPUVolumeTextureMapper3D2.h"
...
vtkCxxRevisionMacro(vtkSlicerGPUVolumeTextureMapper3D2, "$Revision: 1.6 $");

//----------------------------------------------------------------------------
// Needed when we don't use the vtkStandardNewMacro.
vtkInstantiatorNewMacro(vtkSlicerGPUVolumeTextureMapper3D2);
//----------------------------------------------------------------------------
...
template <class T>
void vtkSlicerGPUVolumeTextureMapper3D2ComputeScalars( T *dataPtr,
                                               vtkSlicerGPUVolumeTextureMapper3D2 *me,
...
VTK_THREAD_RETURN_TYPE vtkSlicerGPUVolumeTextureMapper3D2ComputeGradients( void *arg)
{
  GradientsArgsType *pArgs = (GradientsArgsType *)(((vtkMultiThreader::ThreadInfo *)arg)->UserData);
  
  float *dataPtr = pArgs->dataPtr;
  vtkSlicerGPUVolumeTextureMapper3D2 *me = pArgs->me;
...
vtkSlicerGPUVolumeTextureMapper3D2::vtkSlicerGPUVolumeTextureMapper3D2()
{
...
vtkSlicerGPUVolumeTextureMapper3D2 *vtkSlicerGPUVolumeTextureMapper3D2::New()
{
  // First try to create the object from the vtkObjectFactory
  vtkObject* ret = 
    vtkSlicerVolumeRenderingFactory2::CreateInstance("vtkSlicerGPUVolumeTextureMapper3D2");
  return (vtkSlicerGPUVolumeTextureMapper3D2*)ret;
}

int vtkSlicerGPUVolumeTextureMapper3D2::UpdateVolumes(vtkVolume *vtkNotUsed(vol))
{  
  int needToUpdate = 0;
...
*/    
  ...
  switch ( scalarType )
    {
    vtkTemplateMacro(
      vtkSlicerGPUVolumeTextureMapper3D2ComputeScalars(
        (VTK_TT *)(dataPtr), this,
        offset, scale,
        this->Volume1));
    }
  ...
  this->Threader->SetSingleMethod( vtkSlicerGPUVolumeTextureMapper3D2ComputeGradients, (void *)(this->GradientsArgs) );
...
int vtkSlicerGPUVolumeTextureMapper3D2::UpdateColorLookup( vtkVolume *vol )
{
  int needToUpdate = 0;
...
// Print the vtkSlicerGPUVolumeTextureMapper3D2
void vtkSlicerGPUVolumeTextureMapper3D2::PrintSelf(ostream& os, vtkIndent indent)
{
