/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerOpenGLVolumeTextureMapper3D2.cxx,v $
...
#include "vtkSlicerOpenGLVolumeTextureMapper3D2.h"
...
vtkCxxRevisionMacro(vtkSlicerOpenGLVolumeTextureMapper3D2, "$Revision: 1.7.2.2 $");
vtkStandardNewMacro(vtkSlicerOpenGLVolumeTextureMapper3D2);
//#endif



vtkSlicerOpenGLVolumeTextureMapper3D2::vtkSlicerOpenGLVolumeTextureMapper3D2()
{
  this->Initialized                  =  0;
  this->Volume1Index                 =  0;
  this->Volume2Index                 =  0;
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::ReleaseGraphicsResources(vtkWindow 
                                                                *renWin)
{
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::Render(vtkRenderer *ren, vtkVolume *vol)
{  
/*  if ( this->RenderMethod == vtkSlicerVolumeTextureMapper3D2::NO_METHOD )
    {
...
*/    
  ...
  switch ( this->RenderMethod )
    {
    case vtkSlicerVolumeTextureMapper3D2::NVIDIA_METHOD:
      this->RenderNV(ren,vol);
      break;
    case vtkSlicerVolumeTextureMapper3D2::FRAGMENT_PROGRAM_METHOD:
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::AdaptivePerformanceControl()
{
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::RenderFP( vtkRenderer *ren, vtkVolume *vol )
{
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::RenderNV( vtkRenderer *ren, vtkVolume *vol )
{
  glAlphaFunc (GL_GREATER, static_cast<GLclampf>(0));
  glEnable (GL_ALPHA_TEST);
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::DeleteTextureIndex( GLuint *index )
{
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::CreateTextureIndex( GLuint *index )
{
  GLuint tempIndex=0;    
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::RenderPolygons( vtkRenderer *ren,
                                                       vtkVolume *vol,
                                                       int stages[4] )
{
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::Setup3DTextureParameters( vtkVolumeProperty *property )
{
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::SetupOneIndependentTextures( vtkRenderer *vtkNotUsed(ren),
                    vtkVolume *vol )
{
  vtkgl::ActiveTexture( vtkgl::TEXTURE0 );
  glDisable( GL_TEXTURE_2D );
  glEnable( vtkgl::TEXTURE_3D );
  if ( this->RenderMethod == vtkSlicerVolumeTextureMapper3D2::NVIDIA_METHOD )
    {
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::SetupRegisterCombinersNoShadeNV( vtkRenderer *vtkNotUsed(ren),
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::SetupRegisterCombinersShadeNV( vtkRenderer *ren,
                      vtkVolume *vol,
                      int components )
{
  if ( components == 1 )
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::RenderOneIndependentNoShadeNV(
  vtkRenderer *ren,
  vtkVolume *vol )
{
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::RenderOneIndependentShadeNV(
  vtkRenderer *ren,
  vtkVolume *vol )
{
  this->SetupOneIndependentTextures( ren, vol );
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::SetupTwoDependentTextures(
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::RenderTwoDependentNoShadeNV(
  vtkRenderer *ren,
  vtkVolume *vol )
{
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::RenderTwoDependentShadeNV(
  vtkRenderer *ren,
  vtkVolume *vol )
{
  this->SetupTwoDependentTextures( ren, vol );
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::SetupFourDependentTextures(
  vtkRenderer *vtkNotUsed(ren),
  vtkVolume *vol )
{
  vtkgl::ActiveTexture( vtkgl::TEXTURE0 );
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::RenderFourDependentNoShadeNV(
  vtkRenderer *ren,
  vtkVolume *vol )
{
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::RenderFourDependentShadeNV(
  vtkRenderer *ren,
  vtkVolume *vol )
{
  this->SetupFourDependentTextures( ren, vol );
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::RenderOneIndependentNoShadeFP(
  vtkRenderer *ren,
  vtkVolume *vol )
{
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::RenderOneIndependentShadeFP(
  vtkRenderer *ren,
  vtkVolume *vol )
{
  glEnable( vtkgl::FRAGMENT_PROGRAM_ARB );
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::RenderTwoDependentNoShadeFP(
  vtkRenderer *ren,
  vtkVolume *vol )
{
  glEnable( vtkgl::FRAGMENT_PROGRAM_ARB );
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::RenderTwoDependentShadeFP(
  vtkRenderer *ren,
  vtkVolume *vol )
{
  glEnable( vtkgl::FRAGMENT_PROGRAM_ARB );
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::RenderFourDependentNoShadeFP(
  vtkRenderer *ren,
  vtkVolume *vol )
{
  glEnable( vtkgl::FRAGMENT_PROGRAM_ARB );
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::RenderFourDependentShadeFP(
  vtkRenderer *ren,
  vtkVolume *vol )
{
  glEnable( vtkgl::FRAGMENT_PROGRAM_ARB );
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::GetLightInformation(
  vtkRenderer *ren,
  vtkVolume *vol,
  GLfloat lightDirection[2][4],
  GLfloat lightDiffuseColor[2][4],
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::SetupProgramLocalsForShadingFP(
  vtkRenderer *ren,
  vtkVolume *vol )
{
  GLfloat lightDirection[2][4];
...
int  vtkSlicerOpenGLVolumeTextureMapper3D2::IsRenderSupported(
...
void vtkSlicerOpenGLVolumeTextureMapper3D2::Initialize()
{
  this->Initialized = 1;
  ...
  if ( !canDoFP && !canDoNV )
    {
    this->RenderMethod = vtkSlicerVolumeTextureMapper3D2::NO_METHOD;
    }
  // can only do FragmentProgram
  else if ( canDoFP && !canDoNV )
    {
    this->RenderMethod = vtkSlicerVolumeTextureMapper3D2::FRAGMENT_PROGRAM_METHOD;  
    }
  // can only do NVidia method
  else if ( !canDoFP && canDoNV )
    {
    this->RenderMethod = vtkSlicerVolumeTextureMapper3D2::NVIDIA_METHOD;
    }
...
int vtkSlicerOpenGLVolumeTextureMapper3D2::IsTextureSizeSupported( int size[3] )
{
...
// Print the vtkSlicerOpenGLVolumeTextureMapper3D2
void vtkSlicerOpenGLVolumeTextureMapper3D2::PrintSelf(ostream& os, vtkIndent indent)
{
