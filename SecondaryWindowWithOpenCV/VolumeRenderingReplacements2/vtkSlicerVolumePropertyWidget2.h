...
=========================================================================*/
// .NAME vtkSlicerVolumePropertyWidget2 - a transfer function widget
// .SECTION Description
...
#ifndef __vtkSlicerVolumePropertyWidget2_h
#define __vtkSlicerVolumePropertyWidget2_h
...
class VTK_VOLUMERENDERINGREPLACEMENTS_EXPORT vtkSlicerVolumePropertyWidget2 : public vtkSlicerWidget
{
public:
  static vtkSlicerVolumePropertyWidget2* New();
  void PrintSelf(ostream& os, vtkIndent indent);
  vtkTypeMacro(vtkSlicerVolumePropertyWidget2,vtkSlicerWidget);
//  vtkTypeRevisionMacro(vtkSlicerVolumePropertyWidget2,vtkKWCompositeWidget);
...
protected:
  vtkSlicerVolumePropertyWidget2();
  ~vtkSlicerVolumePropertyWidget2();
...
private:
  vtkSlicerVolumePropertyWidget2(const vtkSlicerVolumePropertyWidget2&); // Not implemented
  void operator=(const vtkSlicerVolumePropertyWidget2&); // Not implemented
};
#endif
