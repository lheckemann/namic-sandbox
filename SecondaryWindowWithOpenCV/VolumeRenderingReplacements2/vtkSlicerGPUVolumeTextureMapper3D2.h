/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerGPUVolumeTextureMapper3D2.h,v $
...
=========================================================================*/
// .NAME vtkSlicerGPUVolumeTextureMapper3D2 - GPU volume render with 3D texture mapping (GLSL)

// .SECTION Description
// vtkSlicerGPUVolumeTextureMapper3D2 renders a volume using 3D texture mapping in fragment shader. 
// This class is actually an abstract superclass - with all the actual
// work done by vtkSlicerGPURayCastVolumeTextureMapper3D2. 
// 
...
#ifndef __vtkSlicerGPUVolumeTextureMapper3D2_h
#define __vtkSlicerGPUVolumeTextureMapper3D2_h
...
class vtkSlicerGPUVolumeTextureMapper3D2;
typedef struct{
    float *dataPtr;
...
class VTK_VOLUMERENDERINGREPLACEMENTS_EXPORT vtkSlicerGPUVolumeTextureMapper3D2 : public vtkVolumeMapper
{
public:
  vtkTypeRevisionMacro(vtkSlicerGPUVolumeTextureMapper3D2,vtkVolumeMapper);
  void PrintSelf(ostream& os, vtkIndent indent);

  static vtkSlicerGPUVolumeTextureMapper3D2 *New();
...
protected:
  vtkSlicerGPUVolumeTextureMapper3D2();
  ~vtkSlicerGPUVolumeTextureMapper3D2();
  ...
  friend VTK_THREAD_RETURN_TYPE vtkSlicerGPUVolumeTextureMapper3D2ComputeGradients( void *arg );
  
private:
  vtkSlicerGPUVolumeTextureMapper3D2(const vtkSlicerGPUVolumeTextureMapper3D2&);  // Not implemented.
  void operator=(const vtkSlicerGPUVolumeTextureMapper3D2&);  // Not implemented.
};
