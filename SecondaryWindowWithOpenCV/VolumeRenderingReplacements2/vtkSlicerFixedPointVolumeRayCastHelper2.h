/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerFixedPointVolumeRayCastHelper2.h,v $
...
=========================================================================*/
// .NAME vtkSlicerFixedPointVolumeRayCastHelper2 - An abstract helper that generates images for the volume ray cast mapper
// .SECTION Description
// This is the abstract superclass of all helper classes for the 
// vtkSlicerFixedPointVolumeRayCastMapper2. This class should not be used directly.
//
// .SECTION see also
// vtkSlicerFixedPointVolumeRayCastMapper2

#ifndef __vtkSlicerFixedPointVolumeRayCastHelper2_h
#define __vtkSlicerFixedPointVolumeRayCastHelper2_h
...
class VTK_VOLUMERENDERINGREPLACEMENTS_EXPORT vtkSlicerFixedPointVolumeRayCastHelper2 : public vtkObject
{
public:
  static vtkSlicerFixedPointVolumeRayCastHelper2 *New();
  vtkTypeRevisionMacro(vtkSlicerFixedPointVolumeRayCastHelper2,vtkObject);
...
protected:
  vtkSlicerFixedPointVolumeRayCastHelper2();
  ~vtkSlicerFixedPointVolumeRayCastHelper2();
  


private:
  vtkSlicerFixedPointVolumeRayCastHelper2(const vtkSlicerFixedPointVolumeRayCastHelper2&);  // Not implemented.
  void operator=(const vtkSlicerFixedPointVolumeRayCastHelper2&);  // Not implemented.
};
