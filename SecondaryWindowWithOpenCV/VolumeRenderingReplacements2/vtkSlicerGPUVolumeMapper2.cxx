/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerGPUVolumeMapper2.cxx,v $
...
vtkCxxRevisionMacro(vtkSlicerGPUVolumeMapper2, "$Revision: 1.6 $");

//----------------------------------------------------------------------------
// Needed when we don't use the vtkStandardNewMacro.
vtkInstantiatorNewMacro(vtkSlicerGPUVolumeMapper2);
//----------------------------------------------------------------------------
...
template <class T>
void vtkSlicerGPUVolumeMapper2ComputeScalars( T *dataPtr,
                                                T *dataPtr1,
                                                T *dataPtr2,
                                               vtkSlicerGPUVolumeMapper2 *me,
...
vtkSlicerGPUVolumeMapper2::vtkSlicerGPUVolumeMapper2()
{
...
vtkSlicerGPUVolumeMapper2 *vtkSlicerGPUVolumeMapper2::New()
{
  // First try to create the object from the vtkObjectFactory
  vtkObject* ret = 
    vtkSlicerVolumeRenderingFactory2::CreateInstance("vtkSlicerGPUVolumeMapper2");
  return (vtkSlicerGPUVolumeMapper2*)ret;
}

int vtkSlicerGPUVolumeMapper2::UpdateVolumes(vtkVolume *vtkNotUsed(vol))
{
  int needToUpdate = 0;
  ...
  switch ( scalarType )
    {
    vtkTemplateMacro(
      vtkSlicerGPUVolumeMapper2ComputeScalars(
  ...
  this->Threader->SetSingleMethod( vtkSlicerGPUVolumeMapper2ComputeGradients, (void *)(this->GradientsArgs) );
...
void vtkSlicerGPUVolumeMapper2::CopyToFloatBuffer(vtkImageData* input, float* floatDataPtr, int dataPtrSize)
{
  int scalarType = input->GetScalarType();
...
int vtkSlicerGPUVolumeMapper2::UpdateColorLookup( vtkVolume *vol )
{
  int needToUpdate = 0;
...
// Print the vtkSlicerGPUVolumeMapper2
void vtkSlicerGPUVolumeMapper2::PrintSelf(ostream& os, vtkIndent indent)
{
...
void vtkSlicerGPUVolumeMapper2::SetNthInput( int index, vtkDataSet *genericInput)
{
...
void vtkSlicerGPUVolumeMapper2::SetNthInput( int index, vtkImageData *input )
{ 
...
vtkImageData *vtkSlicerGPUVolumeMapper2::GetNthInput(int index)
{
  if (this->GetNumberOfInputPorts() < index + 1)
    return 0;
