/*=========================================================================
  ...
  Module:    $RCSfile: vtkSlicerFixedPointRayCastImage2.cxx,v $
...
vtkCxxRevisionMacro(vtkSlicerFixedPointRayCastImage2, "$Revision: 1.3 $");
vtkStandardNewMacro(vtkSlicerFixedPointRayCastImage2);

// Construct a new vtkSlicerFixedPointRayCastImage2 with default values
vtkSlicerFixedPointRayCastImage2::vtkSlicerFixedPointRayCastImage2()
{
...
// Destruct a vtkSlicerFixedPointRayCastImage2 - clean up any memory used
vtkSlicerFixedPointRayCastImage2::~vtkSlicerFixedPointRayCastImage2()
{
  delete [] this->Image;
  delete [] this->ZBuffer;
...
// Allocate memory
void vtkSlicerFixedPointRayCastImage2::AllocateImage()
{
  delete [] this->Image;
  this->Image = NULL;
...
// Clear image to 0
void vtkSlicerFixedPointRayCastImage2::ClearImage()
{
...
void vtkSlicerFixedPointRayCastImage2::AllocateZBuffer()
{
...
float vtkSlicerFixedPointRayCastImage2::GetZBufferValue(int x, int y)
{
  if ( !this->UseZBuffer )
    {
    return 1.0;
...
void vtkSlicerFixedPointRayCastImage2::PrintSelf(ostream& os, vtkIndent indent)
{
