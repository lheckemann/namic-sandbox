/*=========================================================================
  ...
  Module:    $RCSfile: itkVotingBinaryImageFunction.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkVotingBinaryImageFunction_h
#define __itkVotingBinaryImageFunction_h
...
/** \class VotingBinaryImageFunction
...
private:
  VotingBinaryImageFunction( const Self& ); //purposely not implemented
...
#define ITK_TEMPLATE_VotingBinaryImageFunction(_, EXPORT, x, y) namespace itk { \
  _(2(class EXPORT VotingBinaryImageFunction< ITK_TEMPLATE_2 x >)) \
  namespace Templates { typedef VotingBinaryImageFunction< ITK_TEMPLATE_2 x > \
                               VotingBinaryImageFunction##y; } \
  }

#if ITK_TEMPLATE_EXPLICIT
# include "Templates/itkVotingBinaryImageFunction+-.h"
#endif

#if ITK_TEMPLATE_TXX
# include "itkVotingBinaryImageFunction.txx"
#endif
