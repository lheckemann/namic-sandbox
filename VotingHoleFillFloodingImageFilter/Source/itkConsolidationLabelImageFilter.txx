 ...
 */
template <class TInputImage, class TOutputImage>
const typename ConsolidationLabelImageFilter<TInputImage, TOutputImage>::OutputImageType *
ConsolidationLabelImageFilter<TInputImage, TOutputImage>
...
template <class TInputImage, class TOutputImage>
const typename  ConsolidationLabelImageFilter<TInputImage, TOutputImage>::NeighborOffsetArrayType & 
ConsolidationLabelImageFilter<TInputImage, TOutputImage>
