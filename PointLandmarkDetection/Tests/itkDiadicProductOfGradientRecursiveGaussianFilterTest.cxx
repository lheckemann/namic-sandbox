/*=========================================================================
  ...
  Module:    $RCSfile: itkDiadicProductOfGradientRecursiveGaussianFilterTest.cxx,v $
  Language:  C++
...
int main( int argc, char *argv[] )
{
  ...
  myDiadicProductOfGradientImageType::Pointer outputImage = filter->GetOutput();

  // Declare Iterator type for the output image
  typedef itk::ImageRegionIteratorWithIndex<
                                 myDiadicProductOfGradientImageType>  myOutputIteratorType;
