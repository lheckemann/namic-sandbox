// .NAME mrml::Image - topologically and geometrically regular array of data
// .SECTION Description
// mrml::Image is a data object that is a concrete implementation of
// vtkDataSet. mrml::Image represents a geometric structure that is 
// a topological and geometrical regular array of points. Examples include
// volumes (voxel data) and pixmaps. 

#ifndef __mrmlImage_h
#define __mrmlImage_h

class VTK_FILTERING_EXPORT mrml::Image : public vtkDataSet
{
public:
  static mrml::Image *New();

  vtkTypeRevisionMacro(mrml::Image,vtkDataSet);
  ...
  virtual void CopyAndCastFrom(mrml::Image *inData, int extent[6]);
  virtual void CopyAndCastFrom(mrml::Image *inData, int x0, int x1,
  ...
  // Must only be called with mrml::Image (or subclass) as input
...
private:
  mrml::Image(const mrml::Image&);  // Not implemented.
  void operator=(const mrml::Image&);  // Not implemented.
};
