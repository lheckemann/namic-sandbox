...
/** \class Object
 * \brief Base class for most mrml classes.
 *
 * Object is the second-highest level base class for most mrml objects.
 * It extends the base object functionality of LightObject by
 * implementing callbacks (via object/observer), debug flags/methods,
 * and modification time tracking. Most MRML classes should be a subclas
...
public:
  ...
  /** Allow people to add/remove/invoke observers (callbacks) to any MRML
   ...
   * and an mrml::Command to execute. It returns an unsigned long tag
...
private:
  ...
  * @see mrml::MetaDataDictionary
  * @see mrml::MetaDataObjectBase
