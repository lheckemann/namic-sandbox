/*=========================================================================
  ...
  Module:    $RCSfile: mrmlObjectFactoryBase.cxx,v $
  Language:  C++
...
public:
  ...
  {
    mrml::ObjectFactoryBase::UnRegisterAllFactories();
  }  
};
...
/**
 * Create an instance of a named mrml object using the loaded
 * factories
 */
LightObject::Pointer 
ObjectFactoryBase
::CreateInstance(const char* mrmlclassname)
{
  ...
  for ( std::list<ObjectFactoryBase*>::iterator 
    ...
    {
    LightObject::Pointer newobject = (*i)->CreateObject(mrmlclassname);
    if(newobject)
      {
      return newobject;
      }
...
LightObject::Pointer 
ObjectFactoryBase
::CreateObject(const char* mrmlclassname)
{
  m_OverrideMap->find(mrmlclassname);
  OverRideMap::iterator pos = m_OverrideMap->find(mrmlclassname);
