/*=========================================================================
  ...
  Module:    $RCSfile: mrmlObject.cxx,v $
  Language:  C++
...
{
  Pointer smartPtr;
  Object *rawPtr = ::mrml::ObjectFactory<Object>::Create();
  if(rawPtr == NULL)
    {
    rawPtr = new Object;
    }
...
{
  mrmlDebugMacro(<< "Reference Count set to " << ref);
