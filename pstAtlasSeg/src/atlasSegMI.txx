...
/**
   This function outputs the binary segmentation, which does not hold
   all the inforamtion because we have the probability map at hand. So
   this is replaced by the function atlasSegMI_outputPr
*/
