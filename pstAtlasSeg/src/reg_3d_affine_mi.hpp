                 ...
                 double& finalCost = 0)
{
  ...
  // upperBound = transform->GetParameters();
  // upperBound[0] += 0.3; upperBound[1] += 0.2; upperBound[2] += 0.2;
  // upperBound[3] += 0.2; upperBound[4] += 0.3; upperBound[5] += 0.2;
  // upperBound[6] += 0.2; upperBound[7] += 0.2; upperBound[8] += 0.3;
  ...
  // lowerBound = transform->GetParameters();
  // lowerBound[0] -= 0.3; lowerBound[1] -= 0.2; lowerBound[2] -= 0.2;
  // lowerBound[3] -= 0.2; lowerBound[4] -= 0.3; lowerBound[5] -= 0.2;
  // lowerBound[6] -= 0.2; lowerBound[7] -= 0.2; lowerBound[8] -= 0.3;
...
//               << std::endl;
  ...
  //tst
  //std::cout<<finalTransform->GetFixedParameters()<<std::endl;
  std::cout<<finalTransform->GetParameters()<<std::endl;
  //tst//
