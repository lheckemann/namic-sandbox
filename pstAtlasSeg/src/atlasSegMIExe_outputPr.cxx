...
int main(int argc, char** argv)
{
  ...
  itk::Image<float, 3>::Pointer resultLabel = atlasSegMI_outputPr<image_t>(img, trainingImageList, labelImageList);



  // write result
  douher::writeImage3<float>(resultLabel, outputLabelName.c_str());
