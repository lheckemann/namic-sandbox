...
provided to preserve the anonymity of the original subjects. The same set of subjects 
are used in the Buckner40 surface atlas provided by FreeSurfer (although there 
are only 39 labeled brains here instead of 40).~\cite{Desikan2006}.
