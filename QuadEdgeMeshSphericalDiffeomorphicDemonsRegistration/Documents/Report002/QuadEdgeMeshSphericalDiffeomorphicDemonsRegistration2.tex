...
\author{Luis Ibanez$^{1}$, Wen Li$^{2}$, Vincent Magnotta$^{2}$}
\authoraddress{$^{1}$Kitware Inc., Clifton Park, NY\\$^{2}$University of Iowa, Iowa City}
...
\begin{center}
\lstinputlisting[linerange={21-24}]{../../Examples/MultiResolutionRegistration2.cxx}
\end{center}
